...
* xref:new-non-open-source-plugin[New Non Open Source plugin]
...
[[new-non-open-source-plugin]]
== New Non Open Source plugin

The following new non-open-source plugin was released alongside {productname} 7.0.

include::partial$misc/admon-non-open-source-plugin-statement.adoc[]

[[non-open-source-plugin-<plugin-name>]]
=== <Plugin-name>

The new non-open-source plugin, **<pluginname>** plugin // description.

For information on the **<pluginname>** plugin see xref:<plugin-name>.adoc[plugin-name].

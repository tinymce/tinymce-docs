...
This project serves as the documentation for TinyMCE 3.x, as you see on tinymce.com/docs-3x. If you have any modifications you wish to contribute, fork this project, make the changes and submit a pull request. You will need to sign a contributors license agreement, and a link will be sent via email.
...
Navigate to http://127.0.0.1:4001/

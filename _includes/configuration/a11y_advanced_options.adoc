...
IMPORTANT: When `a11y_advanced_options` is set to `true`, link:{{site.baseurl}}/plugins/a11ychecker/#a11ychecker_allow_decorative_images[`a11ychecker_allow_decorative_images`] will default to `true`.

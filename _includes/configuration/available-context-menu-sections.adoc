...
| spellchecker
| link:{{site.baseurl}}/plugins/spellchecker/[Spell Checker]
...
For a list of available menu items that can be added to the context menu, see: link:{{site.baseurl}}/advanced/editor-control-identifiers/#menucontrols[Editor control identifiers - Menu controls].

...
For more information about spell checking in TinyMCE, see link:{{ site.baseurl }}/general-configuration-guide/spell-checking/[this page] in the General-configuration-guide/ guide.

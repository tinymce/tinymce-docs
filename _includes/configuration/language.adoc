...
. Set the link:{{ site.baseurl }}/configure/localization/#language[`language`] option in your TinyMCE configuration to the language code in the list below the example.

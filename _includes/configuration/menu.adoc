...
This option allows you to specify which menus should appear on {productname}'s menu bar and the link:{baseurl}/advanced/editor-control-identifiers/#menucontrols[items] that should appear within the menus themselves.

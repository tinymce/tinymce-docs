...
>**Note:** To access this feature, you need to set the value of [paste_enable_default_filters]({{site.baseurl}}/plugins-ref/opensource/paste/#paste_enable_default_filters) to `"false"` in your configuration.

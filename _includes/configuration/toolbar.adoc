...
This option allows you to specify the link:{baseurl}/advanced/editor-control-identifiers/#toolbarcontrols[buttons] and the order that they will appear on {productname}'s toolbar.

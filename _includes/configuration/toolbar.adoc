...
This option allows you to specify the link:{{ site.baseurl }}/advanced/editor-control-identifiers/#toolbarcontrols[buttons] and the order that they will appear on {{site.productname}}'s toolbar.

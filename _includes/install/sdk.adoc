...
If you'd rather download and install the script manually, get the package from link:{{site.gettiny}}[{{site.productname}} Downloads].
...
____
If you decided to use the Self-hosted package, move on to the next step link:../work-with-plugins/[working with plugins], where you'll start customizing {{site.productname}}. If you'd like to learn about other install options please keep reading.
____

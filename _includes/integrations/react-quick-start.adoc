...
....
* [{cloudname}]({baseurl}/cloud-deployment-guide/editor-and-features/).
* {productname} Self-hosted. See [Installing {productname}]({baseurl}/general-configuration-guide/advanced-install/) for details on self-hosting {productname}.
....

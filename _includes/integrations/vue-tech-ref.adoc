...
```
For information {productname} development channels, see: link:{baseurl}/cloud-deployment-guide/editor-plugin-version/#devtestingandstablereleases[Specifying the {productname} editor version deployed from Cloud - dev, testing, and stable releases].
...
For a list of available {productname} events, see: link:{baseurl}/advanced/events/#editorevents[Editor events].
...
*Possible values:*  See link:{baseurl}/advanced/editor-control-identifiers/[Editor control identifiers - Toolbar controls].

...
The link:{baseurl}/plugins/table/[table plugin] has been updated to provide _touch selection handles_ on touch devices. The touch selection handles appear when users double-tap a table cell, and allow users to select a range of table cells on touch devices.
...
For the list of icons included in {productname}, see: link:{baseurl}/advanced/editor-icon-identifiers/[Editor icon identifiers].

...
The following Colorpicker related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/configure/content-appearance/#color_picker[Colorpicker] docs for more information.
...
TinyMCE 5.0 has an ARIA WCAG 2.1 standards compliant user interface to make the user interface controls and dynamic content more accessible. The user interface logic has been changed entirely in TinyMCE 5.0. Refer to the link:{baseurl}/migration-from-4x[Migration Guide], for more information on the UI changes.
...
The following Context Form related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/ui-components/contextform/[Context Form] docs for more information.
...
The following Context Menu related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/ui-components/contextmenu/[Context Menu] docs for more information.
...
The following Context Toolbar related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/ui-components/contexttoolbar/[Context Toolbar] docs for more information.
...
The following Dialog related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/ui-components/dialog/[Dialog] docs for more information.
...
The following Toolbar Buttons related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/ui-components/toolbarbuttons/[Toolbar Buttons] docs for more information.
...
The following URL related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/configure/url-handling/[URL] docs for more information.
...
The following issues were reported against the Comments premium plugin during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/comments/[Comments] docs for more information.
...
The following issues were reported against the dialogs in the premium plugin during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see our link:{baseurl}/enterprise/[Premium Features] docs for more information.
...
The following issues were reported against the Mentions premium plugin during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/mentions/[Mentions] docs for more information.
...
The following Accessibility Checker related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/a11ychecker/[Accessibility Checker] docs for more information.
...
The following Advlist related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/aadvlist/[Advlist] docs for more information.
...
The following Anchors related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/anchor/[Anchors] docs for more information.
...
The following CharMap related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/charmap/[CharMap] docs for more information.
...
The following Directionality related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/directionality/[Directionality] docs for more information.
...
The following Emoticons related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/emoticons/[Emoticons] docs for more information.
...
The following Image Tools related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/imagetools/[Image Tools] docs for more information.
...
The following Link related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/link/[Link] docs for more information.
...
The following Media related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/media/[Media] docs for more information.
...
The following Lists related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/lists/[Lists] docs for more information.
...
The following Search and Replace related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/searchreplace/[Search and Replace] docs for more information.
...
The following Table related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/table/[Table] docs for more information.
...
The following Table of Contents related issues were reported during the developer's preview and are now fixed in the TinyMCE 5.0 BETA version. Please see the link:{baseurl}/plugins/toc/[Table of Contents] docs for more information.

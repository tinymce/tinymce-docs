...
Refer to the link:{baseurl}/plugins/comments/[Comments 2.0] documentation, for more information.
...
The Format Painter may be used through keyboard shortcuts or a toolbar button. Refer to the link:{baseurl}/plugins/formatpainter/[Format Painter] documentation, for more information.
...
Refer to the link:{baseurl}/plugins/pageembed/[Page Embed] documentation, for more information.
...
Refer to the link:{baseurl}/plugins/permanentpen/[Permanent Pen] documentation, for more information.
...
`Border` input field in the table properties dialog is now called `Border width` for clarity. Refer to the link:{baseurl}/plugins/table/[Tables] documentation, for more information. Tables are enriched with the following new additions:

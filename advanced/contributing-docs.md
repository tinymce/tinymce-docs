...
Code language syntax and associated elements are highlit within an open and closing backtick. For example, this `object` is actually enclosed with backticks like this: \`object\`.

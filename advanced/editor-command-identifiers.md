...
| ContentLang          | Sets the language of the current selection. The value passed should be an object like those in [Content appearance options - `content_langs`]({{site.baseurl}}/configure/editor-appearance/#content_langs).                                                                                 |

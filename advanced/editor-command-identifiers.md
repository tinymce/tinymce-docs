...
| Lang                 | Sets the language of the current selection. The value passed in should be an object described in [Content appearance options - `content_langs`]({{site.baseurl}}/configure/editor-appearance/#content_langs).                                                                              |

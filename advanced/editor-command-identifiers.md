...
| mceFocus             | Focuses and activates the editor. The optional value passed in specifies if the editor should only be activated and not focused.                                                                                                                                                            |
...
tinymce.activeEditor.execCommand('mceFocus', false, false);
```

...
| quicktable | [quickbars]({{ site.baseurl }}/plugins/quickbars/) | Inserts an table 2x2. |
| quicklink | [quickbars]({{ site.baseurl }}/plugins/quickbars/) | Inserts an link in a quicker way. |

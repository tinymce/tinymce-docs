...
| Fired when the editor progress state changes using the {productname} API link:{baseurl}/api/tinymce/tinymce.editor/#setprogressstate[`tinymce.activeEditor.setProgressState()`].
...
The following events are provided by the link:{baseurl}/plugins/autosave/[Autosave plugin].
...
The following event is provided by the link:{baseurl}/plugins/charmap/[Character Map plugin].
...
The following event is provided by the link:{baseurl}/plugins/comments/[Comments plugin].
...
The following event is provided by the link:{baseurl}/plugins/formatpainter/[Format Painter plugin].
...
The following event is provided by the link:{baseurl}/plugins/fullscreen/[Fullscreen plugin].
...
The following event is provided by the link:{baseurl}/plugins/importcss/[Import CSS plugin].
...
The following event is provided by the link:{baseurl}/plugins/link/[Link plugin].
...
The following event is provided by the link:{baseurl}/plugins/lists/[Lists plugin].
...
The following event is provided by the link:{baseurl}/plugins/mediaembed/[Media Embed plugin].
...
The following events are provided by the link:{baseurl}/plugins/paste/[Paste plugin].
...
The following events are provided by the link:{baseurl}/plugins/permanentpen/[Permanent Pen plugin].
...
The following events are provided by the link:{baseurl}/plugins/powerpaste/[PowerPaste plugin].
...
The following events are provided by the link:{baseurl}/plugins/spellchecker/[Spell Checker plugin].
...
include::_includes/events/tinymcespellchecker.adoc[]

[#table-events]
=== Table events

The following event is provided by the link:{baseurl}/plugins/table/[Table plugin].
...
The following event is provided by the link:{baseurl}/plugins/visualblocks/[Visual Blocks plugin].
...
The following event is provided by the link:{baseurl}/plugins/visualchars/[Visual Characters plugin].
...
The following event is provided by the link:{baseurl}/plugins/wordcount/[Word Count plugin].

...
| BeforeOpenNotification | `{ notification: NotificationSpec }`                                                                                    | Fired before a notification is displayed.                                                                                                                                  |
| OpenNotification       | `{ notification: NotificationSpec }`                                                                                    | Fired after a notification is displayed.                                                                                                                                   |

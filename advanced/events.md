...
| OpenNotification       | `{ notification: NotificationSpec }`                                                                                    | Fired after a notification is displayed. For information on the Notifications Specification (`NotificationSpec`), see: [Create custom notifications]({{site.baseurl}}/advanced/creating-custom-notifications/). {{site.requires_5_6v}}                        |

...
| ResizeEditor           | N/A                                                                                                                     | Fired when the editor is resized, either by the resize handles or the auto-resize plugin. As of {{site.productname}} 5.10.6, this event is also fired when the `fullscreen` plugin toogles fullscreen mode.                                                                                 |

...
| BeforeOpenNotification | `{ notification: NotificationSpec }`                                                                                    | Fired before a notification is displayed, see [`NotificationSpec`]({{site.baseurl}}/advanced/creating-custom-notifications/). {{site.requires_5_6v}}                       |
| OpenNotification       | `{ notification: NotificationSpec }`                                                                                    | Fired after a notification is displayed, see [`NotificationSpec`]({{site.baseurl}}/advanced/creating-custom-notifications/). {{site.requires_5_6v}}                        |

...
All {{site.accountpage}}s include a free, pre-configured {{site.cloudname}} image proxy service. This setup uses the [Image tools]({{  site.baseurl }}/plugins/imagetools/) plugin.

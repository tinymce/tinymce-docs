...
This channel deploys the latest release of TinyMCE that has passed our quality assurance process. The current version of TinyMCE available through the `stable`(version 4) channel [can be found here](https://cloud.tinymce.com/4/version.txt).
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&powerpaste=2.1.8"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&tinymcespellchecker=0.9.6"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&a11ychecker=1.0.2"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&advcode=1.0.2"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&mediaembed=0.0.1"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&linkchecker=1.0.0"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&powerpaste=sdk"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&tinymcespellchecker=sdk"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&a11ychecker=sdk"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&advcode=sdk"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&mediaembed=sdk"></script>
```
...
```js
<script src="https://cloud.tinymce.com/4/plugins.min.js?apiKey=your_API_key&linkchecker=sdk"></script>
```

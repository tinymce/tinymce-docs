...
> **Note**: You are not required to know the style guide, **but** changes may be requested on changes to {{site.companyname}} documentation where these guidelines are not met.

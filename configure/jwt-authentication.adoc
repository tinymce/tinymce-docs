...
* *name* - _(required)_ Full name of the user that will be used for presentation inside Tiny link:{{site.baseurl}}/plugins/drive/[Drive]. When the user uploads a file, this name is presented as the creator of that file.

...
This example shows you how to use Tiny Drive for your file and image management. For more information on the Tiny Drive plugin, see the link:{{site.baseurl}}/plugins/drive/[docs].

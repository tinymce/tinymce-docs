...
// Still to resolve how we reference the "controls"
...
This option enables you to specify the default doctype for the HTML document created by the fullpage plugin.
...
This option enables you to specify the default encoding for the document created by the fullpage plugin.
...
This option allows you to set the default title for the page when using the full page plugin.
...
This option allows you to set the default font size for the page when using the full page plugin.
...
This option allows you to set the default font family for the page when using the full page plugin.
...
This option allows you to set the default text colour for the page when using the full page plugin.
...
This option allows you to specify whether XML processing instruction information should be included in the page when using the full page plugin.
...
This option allows you to specify whether TinyMCE should hide the non body content from source view when using the full page plugin.
...
This option enables you to specify the HTML to use as a page separator.
...
These settings affect the execution of the Code plugin. The width and height of the code view dialog box may be set here.

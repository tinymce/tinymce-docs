...
image::{rootDir}/images/SDKforsilver.png[**{productname} skin SDK for Silver theme**]
...
image::{rootDir}/images/SDKforsilverCustomExample.png[**{productname} skin SDK for Silver theme**]

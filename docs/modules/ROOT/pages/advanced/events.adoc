...
| SwitchMode
| `{ mode: string }`
| Fired when the editor mode is changed. The available modes are "design" and "readonly". Additional modes can be registered using {productname} API link:{modulesDir}/api/tinymce/tinymce.editormode/#register['tinymce.activeEditor.mode.register()'].
...
| Fired when the editor progress state changes using the {productname} API link:{modulesDir}/api/tinymce/tinymce.editor/#setprogressstate[`tinymce.activeEditor.setProgressState()`].
...
| Fired when an attribute is updated using the editor link:{modulesDir}/api/tinymce.dom/tinymce.dom.domutils/[DOMUtils API].
...
The following events are provided by the link:{modulesDir}/plugins/autosave/[Autosave plugin].
...
The following event is provided by the link:{modulesDir}/plugins/charmap/[Character Map plugin].
...
The following event is provided by the link:{modulesDir}/plugins/comments/[Comments plugin].
...
The following event is provided by the link:{modulesDir}/plugins/formatpainter/[Format Painter plugin].
...
The following event is provided by the link:{modulesDir}/plugins/fullscreen/[Fullscreen plugin].
...
The following event is provided by the link:{modulesDir}/plugins/importcss/[Import CSS plugin].
...
The following event is provided by the link:{modulesDir}/plugins/link/[Link plugin].
...
The following event is provided by the link:{modulesDir}/plugins/lists/[Lists plugin].
...
The following event is provided by the link:{modulesDir}/plugins/mediaembed/[Media Embed plugin].
...
The following events are provided by the link:{modulesDir}/plugins/paste/[Paste plugin].
...
The following events are provided by the link:{modulesDir}/plugins/permanentpen/[Permanent Pen plugin].
...
The following events are provided by the link:{modulesDir}/plugins/powerpaste/[PowerPaste plugin].
...
The following events are provided by the link:{modulesDir}/plugins/spellchecker/[Spell Checker plugin].
...
The following event is provided by the link:{modulesDir}/plugins/table/[Table plugin].
...
The following event is provided by the link:{modulesDir}/plugins/visualblocks/[Visual Blocks plugin].
...
The following event is provided by the link:{modulesDir}/plugins/visualchars/[Visual Characters plugin].
...
The following event is provided by the link:{modulesDir}/plugins/wordcount/[Word Count plugin].

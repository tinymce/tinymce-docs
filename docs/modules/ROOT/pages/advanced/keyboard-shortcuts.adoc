...
* link:{modulesDir}/api/tinymce/tinymce.editor/#addshortcut[The `tinymce.Editor.addShortcut` API].
* link:{modulesDir}/api/tinymce/tinymce.shortcuts/[The `tinymce.Shortcuts.add` API].

...
This example contains the plugins needed for the most common use cases as well as the link:{modulesDir}/plugins/imagetools/[Image Tools] Plugin. Click on the image to make the inline toolbar for image editing appear.

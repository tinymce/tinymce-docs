...
For a full list of plugins and their options, see: link:{modulesDir}/plugins/[Add plugins to TinyMCE].
...
* For additional toolbar options, including disabling the toolbar and adding multiple toolbars, see: link:{modulesDir}/configure/editor-appearance/#toolbar[User interface options - toolbar].
...
* For information on the `+menu+` setting, see: link:{modulesDir}/configure/editor-appearance/#menu[User interface options - menu].
* For information on the `+menubar+` setting, see: link:{modulesDir}/configure/editor-appearance/#menubar[User interface options - menubar].
* For a list of all available menu items, see: link:{modulesDir}/advanced/editor-control-identifiers/#menucontrols[Editor control identifiers - Menu controls].
...
* For a full list of configuration options, see: the link:{modulesDir}/configure/[Configuration options reference].
* For a full list of Plugins and their options, see: link:{modulesDir}/plugins/[Add plugins to TinyMCE].
* For information on the UI elements, see: link:{modulesDir}/ui-components/[User interface components].

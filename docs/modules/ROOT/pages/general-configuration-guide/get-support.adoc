...
Paid premium support is available as part of link:{pricingpage}[{enterpriseversion} and {cloudname} subscriptions]. {productname} Enterprise customers can link:{modulesDir}/enterprise/support/[submit a case support request].

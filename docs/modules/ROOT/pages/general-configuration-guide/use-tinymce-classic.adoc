...
* For information on using editor customization options, see: link:{modulesDir}/general-configuration-guide/customize-ui/[Customizing the editor UI].
* For information on localizing {productname}, see: link:{modulesDir}/general-configuration-guide/localize-your-language/[Localize TinyMCE].
* For information on all {productname} configuration settings, see: link:{modulesDir}/configure/[Configuration options reference].

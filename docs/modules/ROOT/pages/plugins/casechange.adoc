...
*Case Change* is a premium plugin from {companyname}. Please see the link:{modulesDir}/enterprise/casechange/[Premium features] section for all the buying options.
...
Use the following script to configure the *Case Change* link:{modulesDir}/ui-components/typesoftoolbarbuttons/#splitbutton[split toolbar button]:
...
Use the following script to configure the *Case Change* link:{modulesDir}/ui-components/menuitems/[menu item]:
...
image::{modulesDir}/images/casechange.png[**Case Change**]

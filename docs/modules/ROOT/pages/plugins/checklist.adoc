...
. Click the image:{imagesDir}icons/checklist.svg[**Checklist icon**](*Checklist icon*) on the toolbar or the checklist menu item. A checkbox will be added in the desired location.

...
tinymce.init({
  selector: "textarea",  // change this value according to your HTML
  plugins: "fullpage",
  fullpage_default_title: "{productname} - Configuration:fullpage_default_title"
});
----
...
This option allows you to specify whether {productname} should hide the non `body` content from source view.

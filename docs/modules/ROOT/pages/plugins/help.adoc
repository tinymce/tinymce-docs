...
| addTab
| tabSpec: link:{modulesDir}/ui-components/dialogcomponents/#tabpanel[TabPanel]
...
For information on how to expose metadata from you custom plugin to add it to the Installed plugins list in the Help plugin, see the  link:{modulesDir}/advanced/creating-a-plugin/#exposingmetadata[Creating a Plugin page].

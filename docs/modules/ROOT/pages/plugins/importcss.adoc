...
The `importcss` plugin adds the ability to automatically import CSS classes from the CSS file specified in the link:{modulesDir}/configure/content-appearance/#content_css[`content_css`] configuration setting.

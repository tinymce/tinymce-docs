...
[NOTE]
====
Looking for more advanced Microsoft Word importing and pasting? Try the link:{modulesDir}/plugins/powerpaste/[PowerPaste] plugin.
====
...
NOTE: To access this feature, you need to set the value of link:{modulesDir}/plugins/paste/#paste_enable_default_filters[paste_enable_default_filters] to `"false"` in your configuration.

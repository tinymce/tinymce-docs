...
strikethrough: false
`
For more information on {productname} formats, refer to the link:{modulesDir}/configure/content-formatting/#formats[formats] section.
...
Add the Permanent pen properties option to the menu bar with the link:{modulesDir}/configure/editor-appearance/#menu[menu] configuration.
...
image::{modulesDir}/images/right-click.png[Right-click]
...
Check out the link:{modulesDir}/demo/permanentpen/[Permanent Pen demo] to try out this new feature.

...
*Spell Checker Pro* adds spell checking as-you-type capabilities to {productname}. For information on the supported languages, refer to link:{modulesDir}/plugins/tinymcespellchecker/#spellchecker_language[this] section.
...
To enable the {productname} Enterprise Spellchecking plugin with link:{modulesDir}/cloud-deployment-guide/editor-and-features[{cloudname}]:
...
For information on installing the server-side component for spell checking, please see the link:{modulesDir}/enterprise/server/[server-side component installation guide].
...
This option specifies the URL of the server-side `ephox-spelling` service. For instructions on how to set up a Spell Checker Pro server-side component, see: the link:{modulesDir}/enterprise/server/[server-side component installation guide].

NOTE: `spellchecker_rpc_url` is *not* required when enabling this plugin via link:{modulesDir}/cloud-deployment-guide/editor-and-features/[{cloudname}]
...
For more information about customizing the toolbar, see: link:{modulesDir}/configure/editor-appearance/#toolbar[User interface options -- Toolbar].
...
|===
| Control | link:{modulesDir}/configure/editor-appearance/#examplethetinymcedefaultmenuitems[Default Menu Location] | Description
...
For more information about customizing the toolbar, see: link:{modulesDir}/configure/editor-appearance/#menu[User interface options -- Menu].

...
image::{rootDir}/images/improved-context-toolbar.png[Improved context toolbar position]
...
image::{rootDir}/images/color-map-updated.png[Color map]
...
image::{rootDir}/images/inline-search-replace-dialog.png[New search and replace dialog]

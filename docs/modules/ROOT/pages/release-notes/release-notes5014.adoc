...
image::{modulesDir}/images/accessibility_checker.png[Redesigned Accessibility Checker Dialog]
...
For information on Enhanced Media Embed refer to the link:{modulesDir}/plugins/mediaembed/[documentation].

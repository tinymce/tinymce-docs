...
| image:{imagesDir}old_togglemenuitemchecked.png[Custom toggle menu item with checkmark on the left-hand side of the item label (pre-5.3 behavior)]
| image:{imagesDir}53_togglemenuitemchecked.png[Custom toggle menu item with checkmark on the right-hand side of the item label (5.3+ behavior)]
|===
...
image::{rootDir}/images/find-replace-in-selection.png[Find and Replace dialog with new "Find in selection" option highlighted]

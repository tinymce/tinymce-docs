...
image::{rootDir}/images/tinydrive-dropbox-dump1.png[]
...
image::{rootDir}/images/tinydrive-dropbox-dump2.png[]
...
. Click on the image:{imagesDir}upload.png[Upload/Create] button to select Dropbox from the list of storages.

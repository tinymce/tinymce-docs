...
include::{includeDir}/configuration/contextmenu.adoc[leveloffset=+1]

include::{includeDir}/configuration/contextmenu_never_use_native.adoc[leveloffset=+1]

include::{includeDir}/configuration/available-context-menu-sections.adoc[]

...
image::{rootDir}/images/sourcecode.png[Source Code]
...
image::{rootDir}/images/specialchars.png[Special Characters]
...
image::{rootDir}/images/interactive.png[Insert/Edit images]
...
image::{rootDir}/images/help.png[Help Button]

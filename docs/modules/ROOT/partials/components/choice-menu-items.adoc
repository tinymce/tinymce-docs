...
Choice menu items are a special type of menu item used for split toolbar button menu items. For information on split buttons, see: link:{rootDir}ui-components/typesoftoolbarbuttons.html#splitbutton[Split toolbar buttons].
...
For an example of how choice menu items are used in split toolbar buttons, see: link:{rootDir}ui-components/typesoftoolbarbuttons.html#splitbuttonexampleandexplanation[Split button example and explanation].

...
For more information about spell checking in {productname}, see link:{modulesDir}/general-configuration-guide/spell-checking/[this page] in the General-configuration-guide/ guide.

...
This option allows you to specify which menus should appear on {productname}'s menu bar and the link:{rootDir}advanced/editor-control-identifiers.html#menucontrols[items] that should appear within the menus themselves.

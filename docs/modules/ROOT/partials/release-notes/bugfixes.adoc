...
| AP-248
| Firefox: Cannot use <space> to toggle off locks in sizeinput
...
| AP-151
| Update TransformFind types to return Option<b> instead of Option<Element>
...
| AP-153
| Pressing <escape> and <enter> in a URL input should not be swallowed by the URL input
|===

...
_The following example demonstrates how you can use `file_picker_callback` API, but doesn't pick any real files. Check link:{modulesDir}/demo/file-picker[Basic Local File Picker] demo for a more functional example._

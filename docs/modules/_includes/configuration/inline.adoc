...
For more information on the differences between the editing modes, please see this page link:{modulesDir}/general-configuration-guide/use-tinymce-inline/[here].

...
Use the link:{modulesDir}/configure/editor-appearance/#toolbar[toolbar] or the link:{modulesDir}/configure/editor-appearance/#menu[menu] configuration options.
...
| a11ycheck
| link:{modulesDir}/plugins/a11ychecker/[a11ychecker]
| Opens the accessibility checker dialog.

| anchor
| link:{modulesDir}/plugins/anchor/[anchor]
| Creates/Edits anchor elements.

| casechange
| link:{modulesDir}/plugins/casechange/[casechange]
| Changes the case of text in a block selection to uppercase, lowercase, or title case.

| charmap
| link:{modulesDir}/plugins/charmap/[charmap]
...
| ltr
| link:{modulesDir}/plugins/directionality/[directionality]
...
| emoticons
| link:{modulesDir}/plugins/emoticons/[emoticons]
| Opens the emoticons dialog.

| formatpainter
| link:{modulesDir}/plugins/formatpainter/[formatpainter]
| Enables and disables format painting.

| fullpage
| link:{modulesDir}/plugins/fullpage/[fullpage]
| Documents properties for the full page.

| fullscreen
| link:{modulesDir}/plugins/fullscreen/[fullscreen]
| Toggles fullscreen mode

| help
| link:{modulesDir}/plugins/help/[help]
| Opens the help dialog

| hr
| link:{modulesDir}/plugins/hr/[hr]
...
| editimage
| link:{modulesDir}/plugins/imagetools/[imagetools]
...
| insertdatetime
| link:{modulesDir}/plugins/insertdatetime/[insertdatetime]
...
| media
| link:{modulesDir}/plugins/media/[media]
| Creates/Edits embedded media elements.

| nonbreaking
| link:{modulesDir}/plugins/nonbreaking/[nonbreaking]
| Inserts a nonbreaking space into the editor.

| pagebreak
| link:{modulesDir}/plugins/pagebreak/[pagebreak]
| Inserts a pagebreak into the editor.

| pageembed
| link:{modulesDir}/plugins/pageembed/[pageembed]
| Opens the insert or edit iframe dialog.

| pastetext
| link:{modulesDir}/plugins/paste/[paste]
| Toggles plain text pasting mode on/off.

| permanentpen
| link:{modulesDir}/plugins/permanentpen/[permanentpen]
...
| print
| link:{modulesDir}/plugins/print/[print]
| Prints the current editor contents.

| quickimage
| link:{modulesDir}/plugins/quickbars/[quickbars]
...
| restoredraft
| link:{modulesDir}/plugins/autosave/[restoredraft]
| Restores to the latest auto saved draft.

| cancel
| link:{modulesDir}/plugins/save/[save]
...
| searchreplace
| link:{modulesDir}/plugins/searchreplace/[searchreplace]
| Searches and/or Replaces contents within the editor.

| spellchecker
| link:{modulesDir}/plugins/spellchecker/[spellchecker]
...
| language
| link:{modulesDir}/plugins/tinymcespellchecker/[tinymcespellchecker]
...
| toc
| link:{modulesDir}/plugins/toc/[toc]
...
| insertfile
| link:{modulesDir}/plugins/drive/[tinydrive]
| Opens the {cloudfilemanager} file selector.

| visualblocks
| link:{modulesDir}/plugins/visualblocks/[visualblocks]
| Toggles the visibility of block elements.

| visualchars
| link:{modulesDir}/plugins/visualchars/[visualchars]
| Toggles the visibility of non breaking character elements.

| wordcount
| link:{modulesDir}/plugins/wordcount/[wordcount]
...
|===
| Control | Core/Plugin | link:{modulesDir}/configure/editor-appearance/#examplethetinymcedefaultmenuitems[Default Menu Location] | Description
...
| advtablesort
| link:{modulesDir}/plugins/advtable/[advtable]
| Table
...
| restoredraft
| link:{modulesDir}/plugins/autosave/[autosave]
| File
| Restores to the latest auto saved draft.

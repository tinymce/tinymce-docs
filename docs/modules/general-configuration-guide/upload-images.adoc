...
include::{includeDir}/configuration/images-uploads-url.adoc[leveloffset=+1]

include::{includeDir}/configuration/images-upload-handler.adoc[leveloffset=+1]

include::{includeDir}/configuration/images-upload-base-path.adoc[leveloffset=+1]

include::{includeDir}/configuration/images-upload-credentials.adoc[leveloffset=+1]

include::{includeDir}/configuration/images-upload-reuse-filename.adoc[leveloffset=+1]

include::{includeDir}/configuration/images-dataimg-filter.adoc[leveloffset=+1]

...
The {productname} jQuery integration can be used with bootstrap. For information on using the jQuery integration, see: link:{modulesDir}/integrations/jquery/[jQuery integration]

This procedure creates a basic Bootstrap integration containing a {productname} editor based on our link:{modulesDir}/demo/basic-example/[Basic example].

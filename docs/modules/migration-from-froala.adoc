...
* link:{modulesDir}/migration-from-froala/#migratingabasicfroalaconfigurationtotinymce[Migrating a Basic Froala Configuration to {productname}]
* link:{modulesDir}/migration-from-froala/#updatingthelistofplugins[Updating the list of Plugins]
* link:{modulesDir}/migration-from-froala/#migratingacustomtoolbarlayout[Migrating a Custom Toolbar Layout]
* link:{modulesDir}/migration-from-froala/#configuringinlinemode[Configuring Inline Mode]
* link:{modulesDir}/migration-from-froala/#migratingcustombuttons[Migrating Custom Buttons]
* link:{modulesDir}/migration-from-froala/#migratingcustomdrop-downtoolbarbuttons[Migrating Custom Drop-down Toolbar Buttons]
...
For information on {productname} deployment types, see: link:{modulesDir}/general-configuration-guide/advanced-install/[Installing {productname}].
...
For information on configuring the `selector` setting, see: link:{modulesDir}/general-configuration-guide/basic-setup/[Basic Setup].
...
* Getting started with {productname}, see: link:{modulesDir}/quick-start[{productname} Quick Start].
* Installing {productname}, see: link:{modulesDir}/general-configuration-guide/advanced-install/[Installing {productname}].

[#updating-the-list-of-plugins]
== Updating the list of Plugins

Some _Froala core functionality_ is implemented by link:{modulesDir}/plugins/[plugins for {productname}]; and some _Froala plugin-provided functionality_ is {productname} core functionality.
...
To include a plugin for a {productname} editor, add a `plugins` option and provide a link:{modulesDir}/configure/integration-and-setup/#plugins[space-delimited list of the plugins to include], as shown below. You should delete any Froala sourcing scripts and Froala links from the page.
...
* For information on enabling plugins for {productname}, see: link:{modulesDir}/configure/integration-and-setup/#plugins[Integration and setup options: plugins].
* For a list of {productname} plugins, see: link:{modulesDir}/plugins/[Add plugins to {productname}].
...
The list of plugins may need updating, as indicated in link:{modulesDir}/migration-from-froala/#updatingthelistofplugins[Updating the list of Plugins]. For example, the {productname} toolbar items; `numlist` and `bullist`, require the `lists` plugin.

For a list of toolbar items with the required plugins, see: link:{modulesDir}/advanced/editor-control-identifiers/#toolbarcontrols[Editor control identifiers: Toolbar controls].
...
* For information on customizing the {productname} Toolbar, see: link:{modulesDir}/configure/editor-appearance/#toolbar[User interface options: Toolbar].
* For a list of toolbar items, see: link:{modulesDir}/advanced/editor-control-identifiers/#toolbarcontrols[Editor control identifiers: Toolbar controls].
...
* link:{modulesDir}/plugins/quickbars/[The Quick Toolbar plugin].
* link:{modulesDir}/ui-components/contexttoolbar/[Context Toolbars].
* link:{modulesDir}/ui-components/contextmenu/[Context Menus].
* link:{modulesDir}/configure/editor-appearance/#menubar[Disabling the {productname} menubar].
...
* The inline editing mode, see: link:{modulesDir}/general-configuration-guide/use-tinymce-inline/[Setup inline editing mode].
* Configuring a Quick Toolbar, see: link:{modulesDir}/plugins/quickbars/[Quick Toolbar plugin].
...
* Disabling the {productname} menubar, see: link:{modulesDir}/configure/editor-appearance/#menubar[User interface options: Menubar].
* The {productname} distraction-free editing mode, see: link:{modulesDir}/general-configuration-guide/use-tinymce-distraction-free/[{productname} distraction-free editing mode].
...
For information on getting started with the `addButton` option, see: link:{modulesDir}/ui-components/toolbarbuttons/#howtocreatecustomtoolbarbuttons[Toolbar buttons].
...
* For an overview on creating custom toolbar buttons, see: link:{modulesDir}/ui-components/toolbarbuttons/#howtocreatecustomtoolbarbuttons[Toolbar buttons].
* For information on the available types of toolbar buttons and examples of custom toolbar buttons, see: link:{modulesDir}/ui-components/typesoftoolbarbuttons/[Types of toolbar buttons].
...
For information on getting started with the `addMenuButton` option, see: link:{modulesDir}/ui-components/toolbarbuttons/#howtocreatecustomtoolbarbuttons[Toolbar buttons] and link:{modulesDir}/ui-components/typesoftoolbarbuttons/#menubutton[Types of toolbar buttons: Menu button].
...
For information on creating drop-down buttons, see: link:{modulesDir}/ui-components/typesoftoolbarbuttons/#menubutton[Types of toolbar buttons: Menu button].

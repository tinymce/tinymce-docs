...
```
For more information on configuring CSS, refer to the link:{modulesDir}/configure/content-appearance/#content_css[content_css] section.

Check out the link:{modulesDir}/demo/pageembed/[Page Embed demo] to try out this new feature.

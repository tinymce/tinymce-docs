...
include::6.0-release-notes-parsing-and-serialization.adoc[tag=parsing-and-serialization]
...
include::6.0-release-notes-strings-and-internationalization.adoc[tag=strings-and-internationalization]

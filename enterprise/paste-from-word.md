...
{{site.productname}} PowerPaste is a Premium Plugin from {{site.productname}}. We have flexible purchase options: as a [stand-alone plugin](https://about.tiny.cloud/products/powerpaste/), to [OEM and custom enterprise pricing](https://www.tinymce.com/pricing/).

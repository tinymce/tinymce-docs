...
include::_includes/configuration/dockerized-hyperlinking-service.adoc[]

include::_includes/configuration/dockerized-image-proxy.adoc[]

include::_includes/configuration/dockerized-spelling-service.adoc[]

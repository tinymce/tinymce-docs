...
. The `application.conf` file is correct, and the services are working, but the server-side component URLs that the editor uses are not quite right. Refer to the link:{{ site.baseurl }}/plugins/tinymcespellchecker/[Spell Checker Pro], link:{{ site.baseurl }}/plugins/imagetools/[Image Tools], link:{{ site.baseurl }}/plugins/mediaembed/[Enhanced Media Embed] and link:{{ site.baseurl }}/plugins/linkchecker[Link Checker] plugin pages for help.

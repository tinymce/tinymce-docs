...
image::/images/spell-checking-browser-tools.png[Using browser tools to investigate services issues]
...
image::/images/spell-checking-server_status.png[Spell Checking Server Status]
...
image::/images/spell-checking-jetty-settings.png[Spell Checking Server Settings on Jetty]
...
+
image::/images/spell-checking-curl-windows-1.png[Curl on Windows step 1]

. Copy the path of the folder to where the 'curl.exe' is in:
+
image::/images/spell-checking-curl-windows-2.png[Curl on Windows step 2]
...
+
image::/images/spell-checking-curl-windows-3.png[Curl on Windows step 3]

. Once in the folder enter 'curl --version' (without quotes) and ensure you get a valid version
+
image::/images/spell-checking-curl-windows-4.png[Curl on Windows step 4]

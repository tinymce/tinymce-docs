...
include::_includes/install/cloud.adoc[]
...
include::_includes/install/npm.adoc[]

[#bower]
== Bower

include::_includes/install/bower.adoc[]

[#composer]
== Composer

include::_includes/install/composer.adoc[]

[#nuget]
== NuGet

include::_includes/install/nuget.adoc[]

[#self-hosted-install]
== Self-Hosted Install

include::_includes/install/sdk.adoc[]

[#custom-build-install]
== Custom Build Install

include::_includes/install/custom.adoc[]

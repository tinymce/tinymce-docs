...
For a full list of plugins and their options, see: link:{baseurl}/plugins/[Add plugins to TinyMCE].
...
include::_includes/configuration/defaultmenuitems.adoc[]
...
* For a list of all available menu items, see: link:{baseurl}/advanced/editor-control-identifiers/#menucontrols[Editor control identifiers - Menu controls].
...
* For a full list of configuration options, see: the link:{baseurl}/configure/[Configuration options reference].
* For a full list of Plugins and their options, see: link:{baseurl}/plugins/[Add plugins to TinyMCE].
* For information on the UI elements, see: link:{baseurl}/ui-components/[User interface components].

tinymce.init({
  ...
  advtemplate_templates: [
    ...
    },
    {
      ...
      content: '<p>Hi {{prefix}}mce-clipboard{{suffix}}, Thank you for visiting this page. We truly appreciate and value your feedback and any feature requests you may have While you are here, take a moment to explore mce-cursor {{prefix}}mce-clipboard{{suffix}}, its another powerful tool designed for Templates</p>'
    }
  ],
});
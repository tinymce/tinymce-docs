const revisions = [
  {
    revisionId: '5',
    createdAt: '2023-12-29T10:11:21.578Z',
    content: `
    {{logofordemoshtml}}
...
tinymce.init({
  ...
  // Set the initial content of the editor to the latest revision
  init_instance_callback: function (editor) {
    get_revisions().then((revisions) => {
      if (revisions.length > 0) {
        editor.setContent(revisions[0].content);
      }
    });
  }
});
...
include::6.0-release-notes.adoc[tags=core-changes;things-we-renamed;default-value-changes;previously-deprecated-items-now-removed;previously-undocumented-items-removed-without-prior-deprecation;known-issue]

...
As well, the `editimage_proxy` option is now `editimage_proxy_service_url`.

The new plugin option, and the re-named option,  new capabilities provide access to Tiny-specific services.

...
// 1. The default height of editor has been increased from 200px to 400px
//    to improve the usability of the editor #TINY-6860
// 
//    Need to preserve the 200px height? _[here’s how?]_
//    
//    Also add this to release notes as
//    
//    1. Improved UI element
//    
//       Both the above change and the related change: The default
//       minimum height of editor has been changed to 100px to prevent
//       the UI disappearing while resizing #TINY-6860
// 
// === Editor text entry height
// 
// In {productname} 5.x, editors without a specified `height` setting
// defaulted to 200px. In {productname} 6.0, editors without a
// specified `height` setting default to 400px.
// 
// See <<ui-elements-and-components-editor-text-entry-height>> for details

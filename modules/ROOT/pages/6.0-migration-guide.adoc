...
include::6.0-release-notes.adoc#core-architectural-change

include::6.0-release-notes.adoc#things-we-renamed

include::6.0-release-notes.adoc#default-value-changes

include::6.0-release-notes.adoc#previously-deprecated-items-now-removed

include::6.0-release-notes.adoc#previously-undocumented-items-removed-without-prior-deprecation

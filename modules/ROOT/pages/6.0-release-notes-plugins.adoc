...
This section describes all {productname} 6.0 Plugin improvements, changes and removals.
...
If a community-maintained version of the `paste` plugin becomes available, we will link to it from the xref:6.0-migration-guide.adoc#plugins-paste[_Migration Guide_].

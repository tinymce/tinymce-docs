...
As noted in the xref:6.0-release-notes-core-changes.adoc#removed-or-deprecated-plugins-imagetools[Release Notes], the `imagetools` plugin is no longer included as part of the Free editor.

...
* Because the functionality was unmaintained, `paste` no longer supports input from Microsoft Word.
  ...
  If a community-maintained version of the `paste` plugin becomes available, we will link to it from the xref:migration-from-5x.adoc#plugins-paste[_{productname} 6.0 Migration Guide_].
...
[[new-and-improved-ui-and-ux-elements-and-components-buttontype]]
...
[[new-and-improved-ui-and-ux-elements-and-components-editor-text-entry-height]]

...
## EPIC-3 Show avatars next to username in comments

<https://ephocks.atlassian.net/browse/EPIC-3>

<https://ephocks.atlassian.net/browse/DOC-1658>


## EPIC-4 Show comments upfront upon editor init

<https://ephocks.atlassian.net/browse/EPIC-4>

<https://ephocks.atlassian.net/browse/DOC-1663>


## EPIC-5 Allow comments on all (official) types of content

<https://ephocks.atlassian.net/browse/EPIC-5>

<https://ephocks.atlassian.net/browse/DOC-1659>


## EPIC-6 Customize the label name for the save comment button

<https://ephocks.atlassian.net/browse/EPIC-6>

<https://ephocks.atlassian.net/browse/DOC-1657>
...
**Comments** 3.1.0 [adds the following new features | provides the following bug fixes: introduces the following enhancements]:
...
A common envisioned use is to initialise a {productname} editor with a {productname} comments sidebar automatically present.
...
NOTE: The sidebar presents with no animation or other effect. It is just there, along with any other part of the initialised {productname} editor. Also, as documented above, the sidebar does not take focus, which remains with the main editor.

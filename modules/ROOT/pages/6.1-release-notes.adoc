...
The `autocompleter` menu element presents a menu of formatting options. If the current viewport is too small to present the entire menu, access to the ‘overflow’ is ensured by presenting a scrollbar in the menu.

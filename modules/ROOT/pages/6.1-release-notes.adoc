...
{productname} 6.1 was released for {enterpriseversion} and {cloudname} on Wednesday, July 13^th^, 2022. It includes {productname} 6.1. These release notes provide an overview of the changes for {productname} 6.1:
...
# updated premium plugins and skins being released along with TinyMCE 6.1
...
## Premium Skins (due to oxide changes in core)
////

...
With this update, all these elements have been setup so as to be translatable into all confifigurable languages. As well, translations in to all currently supported languages have been added. When {productname} is switched to another language, these elements now appear in that language.

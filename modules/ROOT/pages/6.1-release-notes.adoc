...
* `invert`
+
`invert` swaps the behavior or *Return* and *Shift+Return* (and *Enter* and *Shift+Enter*). That is, pressing *Return* results in *Shift-Return* behavior, and vice versa.

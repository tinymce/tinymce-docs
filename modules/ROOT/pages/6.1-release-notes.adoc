...
NOTE: When the column was pasted in, the table would appear to change as expected. But attempting to change material in some cells would fail, because the underlying table DOM was invalid.

...
NOTE: This known issue has been xref:6.1.2-release-notes.adoc#show-comments-toolbar-button-highlights[addressed] in {productname} 6.1.2, released on Wednesday, August 3^rd^, 2022.

...
NOTE: This known issue has been xref:6.1.1-release-notes.adoc#pre-content-now-correctly-merges[addressed] in {productname} 6.1.1, released on Wednesday, August 3^rd^, 2022.
...
NOTE: This known issue has been xref:6.1.1-release-notes.adoc#show-comments-toolbar-button-highlights[addressed] in {productname} 6.1.1, released on Wednesday, August 3^rd^, 2022.

...
When dragging other elements (such as an image), as the dragged element aproaches the edge of the document, {productname} starts scrolling, allowing these other elements to be dropped anywhere in the document.

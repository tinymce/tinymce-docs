...
When the More button in the {productname} toolbar is open (ie, is set to display all of a multi-line toolbar), opening and closing the  xref:advcode.adoc[Advanced Code Editor] in inline mode causes the More button to disappear.

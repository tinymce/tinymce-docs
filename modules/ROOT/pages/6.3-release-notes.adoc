...
In some circumstances, text being substituted into an HTML string was being escaped, resulting in an isolated message being displayed within the {productname} editor viewport. 

As of this release, {productname} 6.3 sanitizes this text to reduce the risk of XSS attacks.

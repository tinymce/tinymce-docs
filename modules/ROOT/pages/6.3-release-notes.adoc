...
Previously only a predefined list of merge tags could be used. When the new `mceMergeTag` command is added, any text selection content can be converted into a merge tag.

...
In some circumstances, text being substituted into an HTML string was being escaped, resulting in an isolated alert being displayed within the {productname} editor viewport. 

As of {productname} 6.3 `dompurify` sanitizes this text to reduce the risk of XSS attacks.

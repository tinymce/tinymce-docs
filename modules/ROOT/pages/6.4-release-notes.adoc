...
The {productname} 6.4 release includes the release of a new premium plugin: **Advanced Templates**.
...
For information on the **Advanced Template** plugin, see: xref:advanced-template.adoc[Advanced Templates].
...
**PowerPaste** 6.1.4 includes the following fixes, additions, and improvements.
...
**Enhanced Media Embed** 3.1.1 includes the following fixes, additions, and improvements.
...
**Spell Checker Pro** 3.2.1 includes the following fixes, additions, and improvements.

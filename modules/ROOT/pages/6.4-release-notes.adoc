...
The {productname} 6.4 release includes an accompanying release of the **Accessibility Checker** premium plugin.
...
The {productname} 6.4 release includes an accompanying release of the **Advanced Table** premium plugin.
...
The {productname} 6.4 release includes an accompanying release of the **Page Embed** premium plugin.
...
The {productname} 6.4 release includes an accompanying release of the **Permanent Pen** premium plugin.
...
In {productname} 6.4, this issue has been resolved.
...
With the release of {productname} 6.4, the new `ui_mode` option provides improvements to editors within scrollable contexts, including hiding the toolbar when the editor is out of view when the `ui_mode` option is set to 'split'.
...
In  {productname} 6.4, the default number of columns, 5, are now used when any of these options is set to 0 or less, preventing this issue from occurring.

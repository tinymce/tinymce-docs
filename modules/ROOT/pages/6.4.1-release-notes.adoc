...
NOTE: Although there was a Community release of {productname} 6.4, it was not released as an {enterpriseversion} or {cloudname} release. The first commercially supported release of {productname} post version 6.3.2 is {productname} 6.4.1.
...
This new tree component is an important addition to the new Premium Plugin: *Advanced Templates*, which is now available as a premium plugin with editors running {productname} 6.4.1 or later.
...
In {productname} 6.4.1, two new key overrides have been added to:
...
As a result, improvements were made to the **Accessibility Checker** dropdown with {productname} 6.4.1, to ensure that users can now switch between issues with confidence that the dropdown will populate as expected.

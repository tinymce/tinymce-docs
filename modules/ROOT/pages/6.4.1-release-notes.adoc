...
In previous versions of {productname}, the color swatch feature added a checkmark icon to every color, but would only display the checkmark when one is enabled.

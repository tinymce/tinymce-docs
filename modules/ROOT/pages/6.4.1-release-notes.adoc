...
This update adds a new **Copy code** button to the **Advanced Code Editor** for editors. This new **Copy code** button allows users to copy the entire contents of the dialog.

==== New buttons to increase and decrease the font size in the dialog.

This update adds two new buttons for increasing and decreasing the font size of code displayed in the dialog.

==== New button to toggle dark mode.

This update adds a new **Dark/light mode** button to toggle between either dark or light display modes for the dialog.

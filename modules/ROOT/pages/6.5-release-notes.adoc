...
For information on the **Advanced Templates** plugin see: xref:advtemplate_templates.adoc[Advanced Templates].
...
**Advanced Templatess** 1.2.0 includes one improvement and five fixes:

...
**Accessibility Checker** 3.2.0 includes the following fixes.
...
To resolve this issue, {productname} 6.5, includes `skip_focus: true` as a parameter for the `mceFullScreen` command. Consequently, the Full Screen button no longer attempts to focus back on the editor.
**Advanced Code Editor** 3.3.0 includes the following three changes.
...
As of {productname} 6.5 the icon prop is now optional and toggle buttons in dialog footers work with and without a displayed icon.
...
The {productname} 6.5 release includes an accompanying release of the **Case Change** premium plugin.

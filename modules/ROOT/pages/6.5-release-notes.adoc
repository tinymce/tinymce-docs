...
For {productname} 6.5 the logic for inserting lists was updated. With this update everything within the selection — except for the non-editable element — is turned into a list.

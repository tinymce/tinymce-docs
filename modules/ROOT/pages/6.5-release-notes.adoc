...
In previos versions of {productname}, after pressing backspace occasionally would deleted a image after the cursor instead of the expected deletion before it.

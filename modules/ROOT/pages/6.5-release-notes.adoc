...
In previous versions of {productname}, the "Copy code" button had a grey background.

This issue was caused by the previous setting of `borderless: true` which should have been set to `false`. As a consequence, the button wasn't correctly styled. 

...
As a consequence, the media plugin failed to correctly insert the video into the content due to {productname} ignoring the "h" parameter when parsing the source URL.

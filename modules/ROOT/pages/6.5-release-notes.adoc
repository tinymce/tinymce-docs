...
In previous versions of the Advanced Code Editor, the _font size_ and _dark/light mode_ states within the Advanced Code Editor were not preserved after closing the dialog.

When the Advanced Code Editor was closed, these states reverted to their default values.

In {productname} 6.5, _font size_ and _dark/light mode_ states are preserved when the Advanced Code Editor is closed.

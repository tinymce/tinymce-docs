...
To address this, a new option `table_merge_content_on_paste` has been introduced in {productname} 6.5, that gives users the ability to disable this merging behavior.

As a result, table content can now be pasted without merging, ensuring that the entire table is inserted into the desired table cell during the paste operation.

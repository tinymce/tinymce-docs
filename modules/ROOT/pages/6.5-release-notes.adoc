...
To address this, a new option `table_merge_content_on_paste` has been introduced in {productname} 6.5, that when set to `false` disables this merging behavior.

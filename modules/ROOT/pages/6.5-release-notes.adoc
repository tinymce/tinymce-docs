...
As a result in {productname} 6.5, the casechange toolbar button and menu items are will now be disabled when the selection is in `contenteditable="false"` section.

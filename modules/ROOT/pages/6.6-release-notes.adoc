...
When this property is set to `true`, an inline dialog will stay open when focus is switched away from the dialog and towards the {productname} editor, or elsewhere.

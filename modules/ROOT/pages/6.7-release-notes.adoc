...
A relatively slow network connection for this purpose is an ≅ 400 kb/sec connection with an ≅ 2000{nbsp}ms latency; equivalent to a Slow 3G wireless connection. The potential UX change caused by this change will, therefore, be experienced by very few users.

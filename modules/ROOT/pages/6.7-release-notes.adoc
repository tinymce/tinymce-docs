...
.Known issue
====
With **PowerPaste** 6.2.1, Microsoft Word comments are still set as footnotes when pasted into a {productname} instance if the host browser is Safari.
...
**PowerPaste 6.2.2, released in conjunction with {productname} 6.7.2, addresses this.

Upgrading to {productname} 6.7.2 and the accompanying xref:6.7.2-release-notes.adoc#powerpaste-622[PowerPaste 6.2.2] release fixes this problem.
====

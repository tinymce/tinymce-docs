...
// #TINY-10174
In earlier versions of {productname}, the collections dialog component encountered an issue where items added to the collections failed to fetch the specified icon set in the "icon" property.

{productname} 6.8 addresses this issue, now, the collections dialog component correctly retrieves the icon specified in the "icon" property. As a fallback measure, if the specified icon cannot be retrieved, {productname} will use the string set within the property.

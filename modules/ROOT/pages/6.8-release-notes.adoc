...
// TINY-10229
Previously, when copying content, including comments, and subsequently pasting it into a {productname} document, the comments where also unintentionally included in the pasted data.

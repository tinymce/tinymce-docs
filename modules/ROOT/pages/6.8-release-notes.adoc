...
In {productname} 6.8.1 the syntax has been corrected and each cell in the table grid now announces the current selected columns and rows in the correct language, _not only_ in English.

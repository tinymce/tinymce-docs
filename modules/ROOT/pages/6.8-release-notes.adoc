...
As a consequence, the child details content was unwrapped and appended to the content of the previous list item. However, this action left the summary element without the required parent details element, and rendered it invalid.

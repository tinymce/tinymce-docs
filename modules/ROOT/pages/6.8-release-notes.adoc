...
* an image MIME type (starts with `image/`) will be converted to the `<img>` element; and
* a video MIME type (starts with `video/`) will be converted to the `<video>` element; and

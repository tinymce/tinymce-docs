...
{productname} 6.8.1 introduces a new option `default_font_stack`, that allows integrators to define the default font stack for the "System Font" stack in the fontfamily toolbar and menu items.
...
For information on the **user formatting options**, see: xref:user-formatting-options.adoc#default_font_stack[user formatting options].
...
{productname} 6.8.1 addresses this issue.

...
[[non-open-source-plugin-markdown]]
=== Markdown

The new non-open-source plugin, **Markdown**, detects pure markdown from a paste event within a {productname} editor instance and converts it to HTML.

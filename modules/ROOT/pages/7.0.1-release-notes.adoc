...
For example, if a heading element contained the following content:

*`My <em>Heading</em>`*

Upon inserting or refreshing the ToC, the heading element within the ToC would be rendered as HTML, resulting in the following entry:

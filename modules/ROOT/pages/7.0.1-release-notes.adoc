...
==== Reduce the chance of diff stylings being overridden by inline stylings.
// #TINY-10785

Previously in {productname}, the inline CSS styles of content took precedence over the diff annotation styles. As a consequence, the changes highlighted were not distinguishable to the users.

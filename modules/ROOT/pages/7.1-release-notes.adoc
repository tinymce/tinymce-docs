...
{productname} {release-version} introduces a new xref:revisionhistory.adoc#diff[diff] API from the **Revision History** plugin. This API allows the the user to compare two HTML strings. It does this by marking changes with annotations, so you can easily identify what's been added, removed, or changed.
...
CVE: https://nvd.nist.gov/vuln/detail/CVE-2026-47760[CVE-2026-47760]

...
{productname} {release-version} addresses this issue by removing the `preventDefault`, which allows the focus to change as expected with user actions, such as mouse clicks or tab navigation.

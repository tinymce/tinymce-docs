...
In {productname} {release-version}, the **Revision History** premium plugin now includes a check icon on the selected revision to make it easier to identify. Additionally, the visual and layout of the selected revision have been updated for better visibility and clarity.

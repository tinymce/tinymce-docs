...
{productname} {release-version} was released for {enterpriseversion} and {cloudname} on testingstaging, <month> <DD>^<st|nd|rd|th>^, <YYYY>. These release notes provide an overview of the changes for {productname} {release-version}, including:

...
**TinyMCE AI** is the new premium AI platform for {productname}: faster drafting, stronger editing workflows, and AI that stays inside a familiar rich-text surface — without wiring a separate AI product to the stack.

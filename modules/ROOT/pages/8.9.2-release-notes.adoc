...
Previously, the xref:revisionhistory.adoc#diff[`+diff+`] API compared the two HTML strings exactly as supplied. Two fragments that rendered identically, such as the same table indented differently, were reported as a replacement instead of as unchanged content.

...
NOTE: In {productname} 6.3 and later, this rule also presents an _Image alternative text should be less than 100 characters_ warning dialog if the alternative (`+alt+`) text is longer than 100 characters. This dialog also presents the alternative text in an editable field, for immediate repair.

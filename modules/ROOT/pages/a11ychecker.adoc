...
include::partial$configuration/a11y_advanced_options.adoc[leveloffset=+1] :includedSection: false

include::partial$configuration/a11ychecker_allow_decorative_images.adoc[]

include::partial$configuration/a11ychecker_filter_issue.adoc[]

include::partial$configuration/a11ychecker_html_version.adoc[]

include::partial$configuration/a11ychecker_ignored_rules.adoc[]

include::partial$configuration/a11ychecker_issue_url_callback.adoc[]

include::partial$configuration/a11ychecker_level.adoc[]
...
id : The issue identifier used by \{\{site.productname}}, such as D1, T4A. For a description and other details about the issue, see <<accessibilityrules, Accessibility Rules>>.

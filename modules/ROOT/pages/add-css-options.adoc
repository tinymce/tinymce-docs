...
The Import CSS plugin assists with importing complex CSS into the editor text area. For information on using the Import CSS plugin, see: link:{baseurl}/plugins-ref/opensource/importcss/[The Import CSS plugin].

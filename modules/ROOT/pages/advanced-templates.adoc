...
There are two approaches to using the Template Premium plugin: fixed template lists and user-modifiable template lists.
...
==== Configuring the Template plugin to use a static list of predefined templates.
...
==== Configuring the Template plugin to interact with a remote backend service via REST API.

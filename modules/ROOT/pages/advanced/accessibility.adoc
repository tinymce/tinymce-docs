...
For additional navigation keyboard shortcuts and shortcuts for applying some commonly-used formats, see: link:{{site.baseurl}}/advanced/keyboard-shortcuts/[Keyboard shortcuts].
...
{{site.productname}} has accessibility options that can be set when initializing the editor, see: link:{{site.baseurl}}/configure/accessibility/[Accessibility options].

...
For additional navigation keyboard shortcuts and shortcuts for applying some commonly-used formats, see: link:{baseurl}/advanced/keyboard-shortcuts/[Keyboard shortcuts].
...
{productname} has accessibility options that can be set when initializing the editor, see: link:{baseurl}/configure/accessibility/[Accessibility options].

...
By the way, notice how the code for our example gets bigger and bigger. It has almost reached the boundaries of simplicity already. This is the moment when you should ask yourself whether it's better to link:{rootDir}advanced/creating-a-plugin.html[bundle this feature as a plugin] instead.

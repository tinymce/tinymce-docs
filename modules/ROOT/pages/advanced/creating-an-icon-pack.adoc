...
The icon pack name will be used with the xref:configure/editor-appearance.adoc#icons[icons] option to apply the icons in {productname}.
...
For a list of the icon identifiers, see: xref:advanced/editor-icon-identifiers.adoc[Available icons].

{productname} does not resize the SVGs provided, relying on the size defined in the SVG. This allows icons of different sizes to be used in the editor. The Toolbar button sizes are independent of the icon sizes. To change button sizes, a xref:advanced/creating-a-skin.adoc[custom skin] is required.

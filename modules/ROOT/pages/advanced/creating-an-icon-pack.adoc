...
____
Don't forget to explore our ready-to-use Premium Icon Packs such as 'Material' icons, and a smaller version of our default icons at link:{plugindirectory}skins-and-icon-packs[{prem_skins_icons}].
____

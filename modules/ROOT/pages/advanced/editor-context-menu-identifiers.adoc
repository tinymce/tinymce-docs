...
For information on customizing the context menu and adding custom context menu sections, see: link:{baseurl}/ui-components/contextmenu/#availablecontextmenusections[Context menu].

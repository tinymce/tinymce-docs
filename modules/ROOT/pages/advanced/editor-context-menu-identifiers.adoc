...
For information on customizing the context menu and adding custom context menu sections, see: xref:ui-components/contextmenu.adoc#availablecontextmenusections[Context menu].

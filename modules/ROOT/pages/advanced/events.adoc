...
| <<pastepreprocess,PastePreProcess>> | link:{rootDir}plugins/paste.html[paste] | Fires when contents are pasted into the editor. |
| <<pastepostprocess,PastePostProcess>> | link:{rootDir}plugins/paste.html[paste] | Fires when contents are pasted into the editor. |

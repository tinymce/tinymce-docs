...
| Ctrl+Shift+F
| Command+Shift+F
| xref:plugins/opensource/fullscreen.adoc[fullscreen]
...
| Ctrl+F
| Command+F
| xref:plugins/opensource/searchreplace.adoc[searchreplace]
|===
...
* xref:api/tinymce/tinymce.editor.adoc#addShortcut[The `tinymce.Editor.addShortcut` API].
* xref:api/tinymce/tinymce.shortcuts.adoc[The `tinymce.Shortcuts.add` API].

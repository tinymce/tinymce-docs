...
The `+advtable+` plugin is a premium plugin that extends the core link:{baseurl}/plugins-ref/opensource/table/[`+table+` plugin] by adding the following advanced functionality:

...
== Excluding header and footer rows from row numbering
...
This can be done using the xref:advtable_value_series[`+advtable_value_series+` option] to specify a custom generator, as in the following simple example.

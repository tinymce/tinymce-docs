...
The `+advtable+` plugin is a premium plugin that extends the core link:table.html[`+table+` plugin] by adding the following advanced functionality:
...
For events applicable to the Advanced Tables plugin, see: link:table.html#events[Table plugin - Events].

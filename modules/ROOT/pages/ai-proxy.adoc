...
The technical walkthrough documentation can be found in the https://github.com/tinymce/openai-proxy-reference-implementation/[project docs,window=_blank].

...
// Delete anything not required below.

== Options

The following configuration options affect the behavior of the {pluginname} plugin.

include::partial$configuration/ai_config_1.adoc[][leveloffset=+1]

include::partial$configuration/ai_config_2.adoc[][leveloffset=+1]

include::partial$configuration/ai_config_3.adoc[][leveloffset=+1]

include::partial$configuration/ai_config_4.adoc[][leveloffset=+1]

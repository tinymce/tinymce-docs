...
Selecting an active {pluginname} toolbar button, or selecting an active {pluginname} menu item when there is no selection, or when the {productname} editor is empty, will result in a random — and almost certainly unhelpful — response from the AI API.
----

...
The response should preserve any HTML formatting…
----

This added string both improves the UX and increases the response accuracy.

However, these added strings do increase overall token use.
====

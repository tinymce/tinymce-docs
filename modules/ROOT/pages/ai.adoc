...
[NOTE]
.The `ai_shortucts_ option
====
The above example includes both AI Assistant toolbar items and an explicitly configured xref:#aishortcuts[`ai_shortcuts`] option.

This latter option is set to its default value, `true`.

This is equivalent to not setting this option explicitly.
====

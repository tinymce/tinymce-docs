...
* `+dom+` link:{baseurl}/api/tinymce.dom/tinymce.dom.domutils.html[`+(tinymce.dom.DOMUtils)+`] - DOMUtils object reference.
* `+win+` `+(Window)+` - Window to bind the selection object to.
* `+serializer+` link:{baseurl}/api/tinymce.dom/tinymce.dom.serializer.html[`+(tinymce.dom.Serializer)+`] - DOM serialization class to use for getContent.
* `+editor+` link:{baseurl}/api/tinymce/tinymce.editor.html[`+(tinymce.Editor)+`] - Editor instance of the selection.

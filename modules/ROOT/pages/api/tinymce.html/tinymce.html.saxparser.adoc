...
|link:#saxparser[SaxParser()] |Constructs a new SaxParser instance. |link:{baseurl}/api/tinymce.html/tinymce.html.saxparser.html[tinymce.html.SaxParser]
|===
...
|===
|name |summary |defined by
|link:#parse[parse()] |Parses the specified HTML string and executes the callbacks for each item it finds. |link:{baseurl}/api/tinymce.html/tinymce.html.saxparser.html[tinymce.html.SaxParser]
|===
...
* [.param-name]#schema# link:{baseurl}/api/tinymce.html/tinymce.html.schema.html[[.param-type]#(tinymce.html.Schema)#] - HTML Schema class to use when parsing.

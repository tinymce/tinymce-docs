...
|link:#recalc[recalc()] |Recalculates the positions of the controls in the specified container. |link:{rootDir}api/tinymce.ui/tinymce.ui.absolutelayout.html[tinymce.ui.AbsoluteLayout]

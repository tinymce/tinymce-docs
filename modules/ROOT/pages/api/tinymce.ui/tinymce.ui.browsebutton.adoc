...
|maxLength |[.param-type]#Number# |Max length for the dropzone. |link:/docs-4x/api/tinymce.ui/tinymce.ui.browsebutton[tinymce.ui.BrowseButton]
...
|multiple |[.param-type]#Boolean# |True if the dropzone is a multiple control. |link:/docs-4x/api/tinymce.ui/tinymce.ui.browsebutton[tinymce.ui.BrowseButton]
...
|size |[.param-type]#Number# |Size of the dropzone in characters. |link:/docs-4x/api/tinymce.ui/tinymce.ui.browsebutton[tinymce.ui.BrowseButton]
...
|link:#browsebutton[BrowseButton()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.browsebutton[tinymce.ui.BrowseButton]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:/docs-4x/api/tinymce.ui/tinymce.ui.browsebutton[tinymce.ui.BrowseButton]
...
=== link:#browsebutton[BrowseButton]

public constructor function BrowseButton(settings:Object)

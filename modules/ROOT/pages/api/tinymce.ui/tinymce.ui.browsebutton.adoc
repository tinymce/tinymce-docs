...
|maxLength |`+Number+` |Max length for the dropzone. |link:{rootDir}api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]
...
|multiple |`+Boolean+` |True if the dropzone is a multiple control. |link:{rootDir}api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]
...
|size |`+Number+` |Size of the dropzone in characters. |link:{rootDir}api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]
...
|link:#browsebutton[BrowseButton()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{rootDir}api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]

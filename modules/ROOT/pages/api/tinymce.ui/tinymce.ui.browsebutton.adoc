...
|maxLength |[.param-type]#Number# |Max length for the dropzone. |link:{baseurl}/api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]
...
|multiple |[.param-type]#Boolean# |True if the dropzone is a multiple control. |link:{baseurl}/api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]
...
|size |[.param-type]#Number# |Size of the dropzone in characters. |link:{baseurl}/api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]
...
|link:#browsebutton[BrowseButton()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{baseurl}/api/tinymce.ui/tinymce.ui.browsebutton.html[tinymce.ui.BrowseButton]

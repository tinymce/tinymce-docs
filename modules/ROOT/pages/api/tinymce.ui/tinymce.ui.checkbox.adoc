...
|checked |[.param-type]#Boolean# |True if the checkbox should be checked by default. |link:{baseurl}/api/tinymce.ui/tinymce.ui.checkbox.html[tinymce.ui.Checkbox]
...
|link:#checkbox[Checkbox()] |Constructs a new Checkbox instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.checkbox.html[tinymce.ui.Checkbox]
...
|link:#checked[checked()] |Getter/setter function for the checked state. |link:{baseurl}/api/tinymce.ui/tinymce.ui.checkbox.html[tinymce.ui.Checkbox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.checkbox.html[tinymce.ui.Checkbox]
...
|link:#value[value()] |Getter/setter function for the value state. |link:{baseurl}/api/tinymce.ui/tinymce.ui.checkbox.html[tinymce.ui.Checkbox]
...
* [.param-name]#state# [.param-type]#(Boolean)# - State to be set.

==== Return value

* [.return-type]#Boolean# - True/false or checkbox if it's a set operation.
* link:{baseurl}/api/tinymce.ui/tinymce.ui.checkbox.html[[.return-type]#tinymce.ui.Checkbox#] - True/false or checkbox if it's a set operation.

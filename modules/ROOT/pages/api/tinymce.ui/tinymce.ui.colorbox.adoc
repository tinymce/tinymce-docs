...
|link:#colorbox[ColorBox()] |Constructs a new control instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.colorbox.html[tinymce.ui.ColorBox]

...
|link:#colorbox[ColorBox()] |Constructs a new control instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.colorbox[tinymce.ui.ColorBox]

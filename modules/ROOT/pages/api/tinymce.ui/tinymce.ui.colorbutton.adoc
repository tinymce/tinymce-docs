...
|link:#colorbutton[ColorButton()] |Constructs a new ColorButton instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.colorbutton.html[tinymce.ui.ColorButton]
...
|link:#color[color()] |Getter/setter for the current color. |link:{rootDir}api/tinymce.ui/tinymce.ui.colorbutton.html[tinymce.ui.ColorButton]
...
|link:#hidepanel[hidePanel()] |Hides the panel for the button. |link:{rootDir}api/tinymce.ui/tinymce.ui.panelbutton.html[tinymce.ui.PanelButton]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{rootDir}api/tinymce.ui/tinymce.ui.colorbutton.html[tinymce.ui.ColorButton]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.colorbutton.html[tinymce.ui.ColorButton]
...
|link:#resetcolor[resetColor()] |Resets the current color. |link:{rootDir}api/tinymce.ui/tinymce.ui.colorbutton.html[tinymce.ui.ColorButton]
...
|link:#showpanel[showPanel()] |Shows the panel for the button. |link:{rootDir}api/tinymce.ui/tinymce.ui.panelbutton.html[tinymce.ui.PanelButton]
...
* `+String+` - Current color or current instance.
* link:{rootDir}api/tinymce.ui/tinymce.ui.colorbutton.html[`+tinymce.ui.ColorButton+`] - Current color or current instance.
...
* link:{rootDir}api/tinymce.ui/tinymce.ui.colorbutton.html[`+tinymce.ui.ColorButton+`] - Current instance.

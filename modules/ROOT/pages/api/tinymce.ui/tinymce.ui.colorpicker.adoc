...
|color |[.param-type]#String# |Initial color value. |link:/docs-4x/api/tinymce.ui/tinymce.ui.colorpicker[tinymce.ui.ColorPicker]
...
|link:#colorpicker[ColorPicker()] |Constructs a new colorpicker instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.colorpicker[tinymce.ui.ColorPicker]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.colorpicker[tinymce.ui.ColorPicker]
...
=== link:#colorpicker[ColorPicker]

public constructor function ColorPicker(settings:Object)

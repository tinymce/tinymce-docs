...
|color |`+String+` |Initial color value. |link:{rootDir}api/tinymce.ui/tinymce.ui.colorpicker.html[tinymce.ui.ColorPicker]
...
|link:#colorpicker[ColorPicker()] |Constructs a new colorpicker instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.colorpicker.html[tinymce.ui.ColorPicker]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.colorpicker.html[tinymce.ui.ColorPicker]

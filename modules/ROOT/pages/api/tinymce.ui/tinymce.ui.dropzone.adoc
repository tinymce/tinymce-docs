...
|maxLength |`+Number+` |Max length for the dropzone. |link:{baseurl}/api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|multiple |`+Boolean+` |True if the dropzone is a multiple control. |link:{baseurl}/api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|size |`+Number+` |Size of the dropzone in characters. |link:{baseurl}/api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]

...
|maxLength |[.param-type]#Number# |Max length for the dropzone. |link:/docs-4x/api/tinymce.ui/tinymce.ui.dropzone[tinymce.ui.DropZone]
...
|multiple |[.param-type]#Boolean# |True if the dropzone is a multiple control. |link:/docs-4x/api/tinymce.ui/tinymce.ui.dropzone[tinymce.ui.DropZone]
...
|size |[.param-type]#Number# |Size of the dropzone in characters. |link:/docs-4x/api/tinymce.ui/tinymce.ui.dropzone[tinymce.ui.DropZone]
...
|link:#dropzone[DropZone()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.dropzone[tinymce.ui.DropZone]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:/docs-4x/api/tinymce.ui/tinymce.ui.dropzone[tinymce.ui.DropZone]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.dropzone[tinymce.ui.DropZone]

...
|maxLength |`+Number+` |Max length for the dropzone. |link:{rootDir}api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|multiple |`+Boolean+` |True if the dropzone is a multiple control. |link:{rootDir}api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|size |`+Number+` |Size of the dropzone in characters. |link:{rootDir}api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|link:#dropzone[DropZone()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{rootDir}api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]

...
|maxLength |[.param-type]#Number# |Max length for the dropzone. |link:{baseurl}/api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|multiple |[.param-type]#Boolean# |True if the dropzone is a multiple control. |link:{baseurl}/api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|size |[.param-type]#Number# |Size of the dropzone in characters. |link:{baseurl}/api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|link:#dropzone[DropZone()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{baseurl}/api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.dropzone.html[tinymce.ui.DropZone]

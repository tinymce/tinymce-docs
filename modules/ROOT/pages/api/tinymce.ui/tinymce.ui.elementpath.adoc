...
|delimiter |[.param-type]#String# |Delimiter to display between row in path. |link:{baseurl}/api/tinymce.ui/tinymce.ui.path.html[tinymce.ui.Path]
...
|link:#postrender[postRender()] |Post render method. Called after the control has been rendered to the target. |link:{baseurl}/api/tinymce.ui/tinymce.ui.elementpath.html[tinymce.ui.ElementPath]
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.elementpath.html[[.return-type]#tinymce.ui.ElementPath#] - Current combobox instance.

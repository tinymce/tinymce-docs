...
|delimiter |`+String+` |Delimiter to display between row in path. |link:{rootDir}api/tinymce.ui/tinymce.ui.path.html[tinymce.ui.Path]
...
|link:#path[Path()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.path.html[tinymce.ui.Path]
...
|link:#focus[focus()] |Focuses the current control. |link:{rootDir}api/tinymce.ui/tinymce.ui.path.html[tinymce.ui.Path]
...
|link:#postrender[postRender()] |Post render method. Called after the control has been rendered to the target. |link:{rootDir}api/tinymce.ui/tinymce.ui.elementpath.html[tinymce.ui.ElementPath]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.path.html[tinymce.ui.Path]
...
|link:#row[row()] |Sets/gets the data to be used for the path. |link:{rootDir}api/tinymce.ui/tinymce.ui.path.html[tinymce.ui.Path]
...
postRender():tinymce.ui.ElementPath

Post render method. Called after the control has been rendered to the target.

==== Return value

* link:{rootDir}api/tinymce.ui/tinymce.ui.elementpath.html[`+tinymce.ui.ElementPath+`] - Current combobox instance.

...
|link:#postrender[postRender()] |Post render method. Called after the control has been rendered to the target. |link:/docs-4x/api/tinymce.ui/tinymce.ui.elementpath[tinymce.ui.ElementPath]
...
* link:/docs-4x/api/tinymce.ui/tinymce.ui.elementpath[[.return-type]#tinymce.ui.ElementPath#] - Current combobox instance.

...
|link:#postrender[postRender()] |Post render method. Called after the control has been rendered to the target. |link:/docs-4x/api/tinymce.ui/tinymce.ui.form[tinymce.ui.Form]
|link:#prerender[preRender()] |This method gets invoked before the control is rendered. |link:/docs-4x/api/tinymce.ui/tinymce.ui.form[tinymce.ui.Form]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.fieldset[tinymce.ui.FieldSet]
...
|link:#submit[submit()] |Fires a submit event with the serialized form. |link:/docs-4x/api/tinymce.ui/tinymce.ui.form[tinymce.ui.Form]

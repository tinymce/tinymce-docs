...
|link:#postrender[postRender()] |Post render method. Called after the control has been rendered to the target. |link:{baseurl}/api/tinymce.ui/tinymce.ui.form.html[tinymce.ui.Form]
|link:#prerender[preRender()] |This method gets invoked before the control is rendered. |link:{baseurl}/api/tinymce.ui/tinymce.ui.form.html[tinymce.ui.Form]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.fieldset.html[tinymce.ui.FieldSet]
...
|link:#submit[submit()] |Fires a submit event with the serialized form. |link:{baseurl}/api/tinymce.ui/tinymce.ui.form.html[tinymce.ui.Form]

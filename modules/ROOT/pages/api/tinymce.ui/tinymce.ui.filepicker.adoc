...
|placeholder |`+String+` |Placeholder text to display. |link:{rootDir}api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
|link:#combobox[ComboBox()] |Constructs a new control instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
|link:#filepicker[FilePicker()] |Constructs a new control instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.filepicker.html[tinymce.ui.FilePicker]
...
|link:#focus[focus()] |Focuses the input area of the control. |link:{rootDir}api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
|link:#postrender[postRender()] |Post render method. Called after the control has been rendered to the target. |link:{rootDir}api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:{rootDir}api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
* link:{rootDir}api/tinymce.ui/tinymce.ui.combobox.html[`+tinymce.ui.ComboBox+`] - Current combobox instance.

...
|placeholder |`+String+` |Placeholder text to display. |link:{baseurl}/api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.combobox.html[`+tinymce.ui.ComboBox+`] - Current combobox instance.

...
|placeholder |[.param-type]#String# |Placeholder text to display. |link:/docs-4x/api/tinymce.ui/tinymce.ui.combobox[tinymce.ui.ComboBox]
...
|link:#combobox[ComboBox()] |Constructs a new control instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.combobox[tinymce.ui.ComboBox]
...
|link:#filepicker[FilePicker()] |Constructs a new control instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.filepicker[tinymce.ui.FilePicker]
...
|link:#focus[focus()] |Focuses the input area of the control. |link:/docs-4x/api/tinymce.ui/tinymce.ui.combobox[tinymce.ui.ComboBox]
...
|link:#postrender[postRender()] |Post render method. Called after the control has been rendered to the target. |link:/docs-4x/api/tinymce.ui/tinymce.ui.combobox[tinymce.ui.ComboBox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.combobox[tinymce.ui.ComboBox]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:/docs-4x/api/tinymce.ui/tinymce.ui.combobox[tinymce.ui.ComboBox]
...
* link:/docs-4x/api/tinymce.ui/tinymce.ui.combobox[[.return-type]#tinymce.ui.ComboBox#] - Current combobox instance.

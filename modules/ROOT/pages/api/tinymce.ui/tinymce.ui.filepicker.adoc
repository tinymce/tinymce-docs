...
|placeholder |[.param-type]#String# |Placeholder text to display. |link:{baseurl}/api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
|link:#combobox[ComboBox()] |Constructs a new control instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
|link:#filepicker[FilePicker()] |Constructs a new control instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.filepicker.html[tinymce.ui.FilePicker]
...
|link:#focus[focus()] |Focuses the input area of the control. |link:{baseurl}/api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
|link:#postrender[postRender()] |Post render method. Called after the control has been rendered to the target. |link:{baseurl}/api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:{baseurl}/api/tinymce.ui/tinymce.ui.combobox.html[tinymce.ui.ComboBox]
...
public constructor function ComboBox(settings:Object)
...
public constructor function FilePicker(settings:Object)
...
postRender():tinymce.ui.ComboBox

Post render method. Called after the control has been rendered to the target.

==== Return value

* link:{baseurl}/api/tinymce.ui/tinymce.ui.combobox.html[[.return-type]#tinymce.ui.ComboBox#] - Current combobox instance.

...
|label |`+String+` |Label to display for the form item. |link:{rootDir}api/tinymce.ui/tinymce.ui.formitem.html[tinymce.ui.FormItem]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.formitem.html[tinymce.ui.FormItem]

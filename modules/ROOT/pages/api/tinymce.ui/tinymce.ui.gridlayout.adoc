...
|alignH |[.param-type]#String# |start|end|center|stretch or array of values for each column. |link:{baseurl}/api/tinymce.ui/tinymce.ui.gridlayout.html[tinymce.ui.GridLayout]
|alignV |[.param-type]#String# |start|end|center|stretch or array of values for each column. |link:{baseurl}/api/tinymce.ui/tinymce.ui.gridlayout.html[tinymce.ui.GridLayout]
|columns |[.param-type]#Number# |Number of columns to use. |link:{baseurl}/api/tinymce.ui/tinymce.ui.gridlayout.html[tinymce.ui.GridLayout]
|pack |[.param-type]#String# |start|end |link:{baseurl}/api/tinymce.ui/tinymce.ui.gridlayout.html[tinymce.ui.GridLayout]
|spacing |[.param-type]#Number# |Spacing between controls. |link:{baseurl}/api/tinymce.ui/tinymce.ui.gridlayout.html[tinymce.ui.GridLayout]
|spacingH |[.param-type]#Number# |Horizontal spacing between controls. |link:{baseurl}/api/tinymce.ui/tinymce.ui.gridlayout.html[tinymce.ui.GridLayout]
|spacingV |[.param-type]#Number# |Vertical spacing between controls. |link:{baseurl}/api/tinymce.ui/tinymce.ui.gridlayout.html[tinymce.ui.GridLayout]
|===

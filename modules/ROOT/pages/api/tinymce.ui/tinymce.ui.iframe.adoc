...
|url |[.param-type]#String# |Url to open in the iframe. |link:/docs-4x/api/tinymce.ui/tinymce.ui.iframe[tinymce.ui.Iframe]
|===
...
|link:#html[html()] |Inner HTML for the iframe. |link:/docs-4x/api/tinymce.ui/tinymce.ui.iframe[tinymce.ui.Iframe]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.iframe[tinymce.ui.Iframe]
...
|link:#src[src()] |Setter for the iframe source. |link:/docs-4x/api/tinymce.ui/tinymce.ui.iframe[tinymce.ui.Iframe]
...
* link:/docs-4x/api/tinymce.ui/tinymce.ui.iframe[[.return-type]#tinymce.ui.Iframe#] - Current iframe control.

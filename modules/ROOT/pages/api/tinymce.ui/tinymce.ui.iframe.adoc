...
|url |`+String+` |Url to open in the iframe. |link:{baseurl}/api/tinymce.ui/tinymce.ui.iframe.html[tinymce.ui.Iframe]
|===
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.iframe.html[`+tinymce.ui.Iframe+`] - Current iframe control.

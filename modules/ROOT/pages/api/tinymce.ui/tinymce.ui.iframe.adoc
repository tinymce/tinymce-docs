...
|url |[.param-type]#String# |Url to open in the iframe. |link:{baseurl}/api/tinymce.ui/tinymce.ui.iframe.html[tinymce.ui.Iframe]
|===
...
|link:#html[html()] |Inner HTML for the iframe. |link:{baseurl}/api/tinymce.ui/tinymce.ui.iframe.html[tinymce.ui.Iframe]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.iframe.html[tinymce.ui.Iframe]
...
|link:#src[src()] |Setter for the iframe source. |link:{baseurl}/api/tinymce.ui/tinymce.ui.iframe.html[tinymce.ui.Iframe]
...
* [.param-name]#html# [.param-type]#(String)# - HTML string to set as HTML inside the iframe.
* [.param-name]#callback# [.param-type]#(function)# - Optional callback to execute when the iframe body is filled with contents.

==== Return value

* link:{baseurl}/api/tinymce.ui/tinymce.ui.iframe.html[[.return-type]#tinymce.ui.Iframe#] - Current iframe control.
...
* [.param-name]#src# [.param-type]#(String)# - Source URL for iframe.

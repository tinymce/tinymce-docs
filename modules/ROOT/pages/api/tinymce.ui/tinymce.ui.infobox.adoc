...
|multiline |[.param-type]#Boolean# |Multiline label. |link:{baseurl}/api/tinymce.ui/tinymce.ui.infobox.html[tinymce.ui.InfoBox]
...
|link:#infobox[InfoBox()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.infobox.html[tinymce.ui.InfoBox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.infobox.html[tinymce.ui.InfoBox]

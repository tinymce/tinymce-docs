...
|multiline |[.param-type]#Boolean# |Multiline label. |link:/docs-4x/api/tinymce.ui/tinymce.ui.infobox[tinymce.ui.InfoBox]
...
|link:#infobox[InfoBox()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.infobox[tinymce.ui.InfoBox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.infobox[tinymce.ui.InfoBox]
...
=== link:#infobox[InfoBox]

public constructor function InfoBox(settings:Object)

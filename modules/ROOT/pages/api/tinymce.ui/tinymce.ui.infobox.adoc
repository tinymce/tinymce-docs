...
|multiline |`+Boolean+` |Multiline label. |link:{rootDir}api/tinymce.ui/tinymce.ui.infobox.html[tinymce.ui.InfoBox]
...
|link:#infobox[InfoBox()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.infobox.html[tinymce.ui.InfoBox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.infobox.html[tinymce.ui.InfoBox]

...
|multiline |[.param-type]#Boolean# |Multiline label. |link:{baseurl}/api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]
...
|link:#label[Label()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]
...
|link:#initlayoutrect[initLayoutRect()] |Initializes the current controls layout rect. This will be executed by the layout managers to determine the default minWidth/minHeight etc. |link:{baseurl}/api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:{baseurl}/api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]
...
public constructor function Label(settings:Object)

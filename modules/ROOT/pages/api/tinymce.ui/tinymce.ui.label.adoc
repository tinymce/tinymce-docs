...
|multiline |`+Boolean+` |Multiline label. |link:{rootDir}api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]
...
|link:#label[Label()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]
...
|link:#initlayoutrect[initLayoutRect()] |Initializes the current controls layout rect. This will be executed by the layout managers to determine the default minWidth/minHeight etc. |link:{rootDir}api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:{rootDir}api/tinymce.ui/tinymce.ui.label.html[tinymce.ui.Label]

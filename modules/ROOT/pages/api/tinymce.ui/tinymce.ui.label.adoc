...
|multiline |[.param-type]#Boolean# |Multiline label. |link:/docs-4x/api/tinymce.ui/tinymce.ui.label[tinymce.ui.Label]
...
|link:#label[Label()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.label[tinymce.ui.Label]
...
|link:#initlayoutrect[initLayoutRect()] |Initializes the current controls layout rect. This will be executed by the layout managers to determine the default minWidth/minHeight etc. |link:/docs-4x/api/tinymce.ui/tinymce.ui.label[tinymce.ui.Label]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.label[tinymce.ui.Label]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:/docs-4x/api/tinymce.ui/tinymce.ui.label[tinymce.ui.Label]

...
|icon |`+String+` |Icon to use for button. |link:{rootDir}api/tinymce.ui/tinymce.ui.button.html[tinymce.ui.Button]
|image |`+String+` |Image to use for icon. |link:{rootDir}api/tinymce.ui/tinymce.ui.button.html[tinymce.ui.Button]
...
|size |`+String+` |Size of the button small|medium|large. |link:{rootDir}api/tinymce.ui/tinymce.ui.button.html[tinymce.ui.Button]
...
|values |`+Array+` |Array with values to add to list box. |link:{rootDir}api/tinymce.ui/tinymce.ui.listbox.html[tinymce.ui.ListBox]
|===
...
|link:#button[Button()] |Constructs a new button instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.button.html[tinymce.ui.Button]
...
|link:#listbox[ListBox()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.listbox.html[tinymce.ui.ListBox]
|link:#menubutton[MenuButton()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#hidemenu[hideMenu()] |Hides the menu for the button. |link:{rootDir}api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
|link:#icon[icon()] |Sets/gets the current button icon. |link:{rootDir}api/tinymce.ui/tinymce.ui.button.html[tinymce.ui.Button]
...
|link:#postrender[postRender()] |Gets invoked after the control has been rendered. |link:{rootDir}api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#remove[remove()] |Removes the control and it's menus. |link:{rootDir}api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
|link:#repaint[repaint()] |Repaints the button for example after it's been resizes by a layout engine. |link:{rootDir}api/tinymce.ui/tinymce.ui.button.html[tinymce.ui.Button]
...
|link:#showmenu[showMenu()] |Shows the menu for the button. |link:{rootDir}api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#value[value()] |Getter/setter function for the control value. |link:{rootDir}api/tinymce.ui/tinymce.ui.listbox.html[tinymce.ui.ListBox]
...
* `+String+` - Current icon or current MenuButton instance.
* link:{rootDir}api/tinymce.ui/tinymce.ui.menubutton.html[`+tinymce.ui.MenuButton+`] - Current icon or current MenuButton instance.
...
* `+Boolean+` - Value or self if it's a set operation.
* link:{rootDir}api/tinymce.ui/tinymce.ui.listbox.html[`+tinymce.ui.ListBox+`] - Value or self if it's a set operation.

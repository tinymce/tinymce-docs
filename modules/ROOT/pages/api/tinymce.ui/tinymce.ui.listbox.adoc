...
|values |[.param-type]#Array# |Array with values to add to list box. |link:{baseurl}/api/tinymce.ui/tinymce.ui.listbox.html[tinymce.ui.ListBox]
|===
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.listbox.html[[.return-type]#tinymce.ui.ListBox#] - Value or self if it's a set operation.

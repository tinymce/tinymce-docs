...
|icon |`+String+` |Icon to use for button. |link:{baseurl}/api/tinymce.ui/tinymce.ui.button.html[tinymce.ui.Button]
|image |`+String+` |Image to use for icon. |link:{baseurl}/api/tinymce.ui/tinymce.ui.button.html[tinymce.ui.Button]
...
|size |`+String+` |Size of the button small|medium|large. |link:{baseurl}/api/tinymce.ui/tinymce.ui.button.html[tinymce.ui.Button]
...
|values |`+Array+` |Array with values to add to list box. |link:{baseurl}/api/tinymce.ui/tinymce.ui.listbox.html[tinymce.ui.ListBox]
|===
...
|link:#listbox[ListBox()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.listbox.html[tinymce.ui.ListBox]
|link:#menubutton[MenuButton()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#hidemenu[hideMenu()] |Hides the menu for the button. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#postrender[postRender()] |Gets invoked after the control has been rendered. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#remove[remove()] |Removes the control and it's menus. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#showmenu[showMenu()] |Shows the menu for the button. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menubutton.html[tinymce.ui.MenuButton]
...
|link:#value[value()] |Getter/setter function for the control value. |link:{baseurl}/api/tinymce.ui/tinymce.ui.listbox.html[tinymce.ui.ListBox]
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.menubutton.html[`+tinymce.ui.MenuButton+`] - Current icon or current MenuButton instance.
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.listbox.html[`+tinymce.ui.ListBox+`] - Value or self if it's a set operation.

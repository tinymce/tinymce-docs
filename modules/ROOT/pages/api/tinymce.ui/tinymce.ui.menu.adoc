...
|link:#menu[Menu()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menu.html[tinymce.ui.Menu]
|===
...
|link:#cancel[cancel()] |Hides/closes the menu. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menu.html[tinymce.ui.Menu]
...
|link:#hideall[hideAll()] |Hide menu and all sub menus. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menu.html[tinymce.ui.Menu]
...
|link:#load[load()] |Loads new items from the factory items function. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menu.html[tinymce.ui.Menu]
...
|link:#prerender[preRender()] |Invoked before the menu is rendered. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menu.html[tinymce.ui.Menu]
...
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menu.html[tinymce.ui.Menu]

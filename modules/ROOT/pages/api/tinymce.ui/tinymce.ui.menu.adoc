...
|link:#menu[Menu()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menu[tinymce.ui.Menu]
|===
...
|link:#cancel[cancel()] |Hides/closes the menu. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menu[tinymce.ui.Menu]
...
|link:#hideall[hideAll()] |Hide menu and all sub menus. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menu[tinymce.ui.Menu]
...
|link:#load[load()] |Loads new items from the factory items function. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menu[tinymce.ui.Menu]
...
|link:#prerender[preRender()] |Invoked before the menu is rendered. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menu[tinymce.ui.Menu]
...
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menu[tinymce.ui.Menu]

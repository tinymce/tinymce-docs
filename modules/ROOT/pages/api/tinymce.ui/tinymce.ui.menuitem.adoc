...
|menu |`+Array+` |Submenu array with items. |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
...
|selectable |`+Boolean+` |Selectable menu. |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
|shortcut |`+String+` |Shortcut to display for menu item. Example: Ctrl+X |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
...
|link:#menuitem[MenuItem()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
|===
...
|link:#hasmenus[hasMenus()] |Returns true/false if the menuitem has sub menu. |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
|link:#hide[hide()] |Sets the visible state to false. |link:{rootDir}api/tinymce.ui/tinymce.ui.control.html[tinymce.ui.Control]
|link:#hidemenu[hideMenu()] |Hides the menu for the menu item. |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
...
|link:#postrender[postRender()] |Gets invoked after the control has been rendered. |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
...
|link:#remove[remove()] |Removes the control and it's menus. |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
...
|link:#showmenu[showMenu()] |Shows the menu for the menu item. |link:{rootDir}api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]

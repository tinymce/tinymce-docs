...
|menu |[.param-type]#Array# |Submenu array with items. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
...
|selectable |[.param-type]#Boolean# |Selectable menu. |link:{baseurl}/api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]
|shortcut |[.param-type]#String# |Shortcut to display for menu item. Example: Ctrl+X |link:{baseurl}/api/tinymce.ui/tinymce.ui.menuitem.html[tinymce.ui.MenuItem]

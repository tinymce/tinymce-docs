...
|menu |[.param-type]#Array# |Submenu array with items. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
...
|selectable |[.param-type]#Boolean# |Selectable menu. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
|shortcut |[.param-type]#String# |Shortcut to display for menu item. Example: Ctrl+X |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
...
|link:#menuitem[MenuItem()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
|===
...
|link:#hasmenus[hasMenus()] |Returns true/false if the menuitem has sub menu. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
|link:#hide[hide()] |Sets the visible state to false. |link:/docs-4x/api/tinymce.ui/tinymce.ui.control[tinymce.ui.Control]
|link:#hidemenu[hideMenu()] |Hides the menu for the menu item. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
...
|link:#postrender[postRender()] |Gets invoked after the control has been rendered. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
...
|link:#remove[remove()] |Removes the control and it's menus. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
...
|link:#showmenu[showMenu()] |Shows the menu for the menu item. |link:/docs-4x/api/tinymce.ui/tinymce.ui.menuitem[tinymce.ui.MenuItem]
...
* [.return-type]#Boolean# - True/false state if it has submenu.

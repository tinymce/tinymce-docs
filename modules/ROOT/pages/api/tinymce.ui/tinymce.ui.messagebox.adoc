...
|link:#messagebox[MessageBox()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.messagebox[tinymce.ui.MessageBox]
|===
...
|link:#alert[alert()] |Creates a new alert dialog. |link:/docs-4x/api/tinymce.ui/tinymce.ui.messagebox[tinymce.ui.MessageBox]
...
|link:#confirm[confirm()] |Creates a new confirm dialog. |link:/docs-4x/api/tinymce.ui/tinymce.ui.messagebox[tinymce.ui.MessageBox]
...
|link:#msgbox[msgBox()] |Constructs a new message box and renders it to the body element. |link:/docs-4x/api/tinymce.ui/tinymce.ui.messagebox[tinymce.ui.MessageBox]
...
* [.param-name]#settings# [.param-type]#(Object)# - Settings for the alert dialog.
* [.param-name]#callback# [.param-type]#(function)# - Callback to execute when the user makes a choice.
...
* [.param-name]#settings# [.param-type]#(Object)# - Settings for the confirm dialog.
* [.param-name]#callback# [.param-type]#(function)# - Callback to execute when the user makes a choice.

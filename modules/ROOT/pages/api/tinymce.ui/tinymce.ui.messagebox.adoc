...
|link:#messagebox[MessageBox()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.messagebox.html[tinymce.ui.MessageBox]
|===
...
|link:#alert[alert()] |Creates a new alert dialog. |link:{rootDir}api/tinymce.ui/tinymce.ui.messagebox.html[tinymce.ui.MessageBox]
...
|link:#confirm[confirm()] |Creates a new confirm dialog. |link:{rootDir}api/tinymce.ui/tinymce.ui.messagebox.html[tinymce.ui.MessageBox]
...
|link:#msgbox[msgBox()] |Constructs a new message box and renders it to the body element. |link:{rootDir}api/tinymce.ui/tinymce.ui.messagebox.html[tinymce.ui.MessageBox]

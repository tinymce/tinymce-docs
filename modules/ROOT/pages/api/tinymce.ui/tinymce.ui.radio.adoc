...
|checked |`+Boolean+` |True if the checkbox should be checked by default. |link:{baseurl}/api/tinymce.ui/tinymce.ui.checkbox.html[tinymce.ui.Checkbox]
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.checkbox.html[`+tinymce.ui.Checkbox+`] - True/false or checkbox if it's a set operation.

...
|checked |[.param-type]#Boolean# |True if the checkbox should be checked by default. |link:/docs-4x/api/tinymce.ui/tinymce.ui.checkbox[tinymce.ui.Checkbox]
...
|link:#checkbox[Checkbox()] |Constructs a new Checkbox instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.checkbox[tinymce.ui.Checkbox]
...
|link:#checked[checked()] |Getter/setter function for the checked state. |link:/docs-4x/api/tinymce.ui/tinymce.ui.checkbox[tinymce.ui.Checkbox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.checkbox[tinymce.ui.Checkbox]
...
|link:#value[value()] |Getter/setter function for the value state. |link:/docs-4x/api/tinymce.ui/tinymce.ui.checkbox[tinymce.ui.Checkbox]
...
* link:/docs-4x/api/tinymce.ui/tinymce.ui.checkbox[[.return-type]#tinymce.ui.Checkbox#] - True/false or checkbox if it's a set operation.

...
|options |[.param-type]#Array# |Array with options to add to the select box. |link:{baseurl}/api/tinymce.ui/tinymce.ui.selectbox.html[tinymce.ui.SelectBox]
...
|link:#selectbox[SelectBox()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.selectbox.html[tinymce.ui.SelectBox]
...
|link:#options[options()] |Getter/setter function for the options state. |link:{baseurl}/api/tinymce.ui/tinymce.ui.selectbox.html[tinymce.ui.SelectBox]
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.selectbox.html[[.return-type]#tinymce.ui.SelectBox#] - Array of string options.

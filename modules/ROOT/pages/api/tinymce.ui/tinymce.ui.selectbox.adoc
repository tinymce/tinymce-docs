...
|options |`+Array+` |Array with options to add to the select box. |link:{baseurl}/api/tinymce.ui/tinymce.ui.selectbox.html[tinymce.ui.SelectBox]
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.selectbox.html[`+tinymce.ui.SelectBox+`] - Array of string options.

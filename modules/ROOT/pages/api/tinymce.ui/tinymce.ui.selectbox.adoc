...
|options |[.param-type]#Array# |Array with options to add to the select box. |link:/docs-4x/api/tinymce.ui/tinymce.ui.selectbox[tinymce.ui.SelectBox]
...
|link:#selectbox[SelectBox()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.selectbox[tinymce.ui.SelectBox]
...
|link:#options[options()] |Getter/setter function for the options state. |link:/docs-4x/api/tinymce.ui/tinymce.ui.selectbox[tinymce.ui.SelectBox]
...
* [.param-name]#state# [.param-type]#(Array)# - State to be set.

==== Return value

* [.return-type]#Array# - Array of string options.
* link:/docs-4x/api/tinymce.ui/tinymce.ui.selectbox[[.return-type]#tinymce.ui.SelectBox#] - Array of string options.

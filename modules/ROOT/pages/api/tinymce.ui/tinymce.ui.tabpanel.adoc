...
|activeTab |`+Number+` |Active tab index. |link:{rootDir}api/tinymce.ui/tinymce.ui.tabpanel.html[tinymce.ui.TabPanel]
...
|===
|name |summary |defined by
|link:#activatetab[activateTab()] |Activates the specified tab by index. |link:{rootDir}api/tinymce.ui/tinymce.ui.tabpanel.html[tinymce.ui.TabPanel]
...
|link:#initlayoutrect[initLayoutRect()] |Initializes the current controls layout rect. This will be executed by the layout managers to determine the default minWidth/minHeight etc. |link:{rootDir}api/tinymce.ui/tinymce.ui.tabpanel.html[tinymce.ui.TabPanel]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{rootDir}api/tinymce.ui/tinymce.ui.tabpanel.html[tinymce.ui.TabPanel]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.tabpanel.html[tinymce.ui.TabPanel]

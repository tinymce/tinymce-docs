...
|maxLength |[.param-type]#Number# |Max length for the textbox. |link:/docs-4x/api/tinymce.ui/tinymce.ui.textbox[tinymce.ui.TextBox]
...
|multiline |[.param-type]#Boolean# |True if the textbox is a multiline control. |link:/docs-4x/api/tinymce.ui/tinymce.ui.textbox[tinymce.ui.TextBox]
...
|size |[.param-type]#Number# |Size of the textbox in characters. |link:/docs-4x/api/tinymce.ui/tinymce.ui.textbox[tinymce.ui.TextBox]
...
|link:#textbox[TextBox()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.textbox[tinymce.ui.TextBox]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:/docs-4x/api/tinymce.ui/tinymce.ui.textbox[tinymce.ui.TextBox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.textbox[tinymce.ui.TextBox]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:/docs-4x/api/tinymce.ui/tinymce.ui.textbox[tinymce.ui.TextBox]

...
|maxLength |`+Number+` |Max length for the textbox. |link:{rootDir}api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|multiline |`+Boolean+` |True if the textbox is a multiline control. |link:{rootDir}api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|size |`+Number+` |Size of the textbox in characters. |link:{rootDir}api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|link:#textbox[TextBox()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{rootDir}api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{rootDir}api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:{rootDir}api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]

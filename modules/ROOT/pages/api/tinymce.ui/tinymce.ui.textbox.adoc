...
|maxLength |`+Number+` |Max length for the textbox. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|multiline |`+Boolean+` |True if the textbox is a multiline control. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|size |`+Number+` |Size of the textbox in characters. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]

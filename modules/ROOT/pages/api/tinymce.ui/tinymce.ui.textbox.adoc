...
|maxLength |[.param-type]#Number# |Max length for the textbox. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|multiline |[.param-type]#Boolean# |True if the textbox is a multiline control. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|size |[.param-type]#Number# |Size of the textbox in characters. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|link:#textbox[TextBox()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:{baseurl}/api/tinymce.ui/tinymce.ui.textbox.html[tinymce.ui.TextBox]
...
public constructor function TextBox(settings:Object)

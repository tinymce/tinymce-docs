...
|link:#toolbar[Toolbar()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.toolbar.html[tinymce.ui.Toolbar]
|===
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{baseurl}/api/tinymce.ui/tinymce.ui.toolbar.html[tinymce.ui.Toolbar]

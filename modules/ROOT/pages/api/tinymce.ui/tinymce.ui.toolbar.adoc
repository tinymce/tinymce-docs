...
|link:#toolbar[Toolbar()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.toolbar[tinymce.ui.Toolbar]
|===
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:/docs-4x/api/tinymce.ui/tinymce.ui.toolbar[tinymce.ui.Toolbar]

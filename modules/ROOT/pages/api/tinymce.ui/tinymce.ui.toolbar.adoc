...
|link:#toolbar[Toolbar()] |Constructs a instance with the specified settings. |link:{rootDir}api/tinymce.ui/tinymce.ui.toolbar.html[tinymce.ui.Toolbar]
|===
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{rootDir}api/tinymce.ui/tinymce.ui.toolbar.html[tinymce.ui.Toolbar]
...
public constructor function Toolbar(settings:Object)

...
|link:#postrender[postRender()] |Post render method. Called after the control has been rendered to the target. |link:{baseurl}/api/tinymce.ui/tinymce.ui.control.html[tinymce.ui.Control]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.tooltip.html[tinymce.ui.ToolTip]
|link:#repaint[repaint()] |Repaints the control after a layout operation. |link:{baseurl}/api/tinymce.ui/tinymce.ui.tooltip.html[tinymce.ui.ToolTip]

...
|autohide |[.param-type]#Boolean# |Automatically hide the panel. |link:{baseurl}/api/tinymce.ui/tinymce.ui.floatpanel.html[tinymce.ui.FloatPanel]
...
|link:#window[Window()] |Constructs a instance with the specified settings. |link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[tinymce.ui.Window]
|===
...
|link:#fullscreen[fullscreen()] |Switches the window fullscreen mode. |link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[tinymce.ui.Window]
...
|link:#getcontentwindow[getContentWindow()] |Returns the contentWindow object of the iframe if it exists. |link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[tinymce.ui.Window]
...
|link:#hideall[hideAll()] |Hide all visible float panels with he autohide setting enabled. This is for manually hiding floating menus or panels. |link:{baseurl}/api/tinymce.ui/tinymce.ui.floatpanel.html[tinymce.ui.FloatPanel]
|link:#initlayoutrect[initLayoutRect()] |Initializes the current controls layout rect. This will be executed by the layout managers to determine the default minWidth/minHeight etc. |link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[tinymce.ui.Window]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[tinymce.ui.Window]
...
|link:#recalc[recalc()] |Recalculates the positions of the controls in the current container. This is invoked by the reflow method and shouldn't be called directly. |link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[tinymce.ui.Window]
...
|link:#remove[remove()] |Removes the current control from DOM and from UI collections. |link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[tinymce.ui.Window]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[tinymce.ui.Window]
...
|link:#submit[submit()] |Fires a submit event with the serialized form. |link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[tinymce.ui.Window]
...
* [.param-name]#state# [.param-type]#(Boolean)# - True/false state.

==== Return value

* link:{baseurl}/api/tinymce.ui/tinymce.ui.window.html[[.return-type]#tinymce.ui.Window#] - Current window instance.
...
* [.return-type]#Window# - window object or null.
...
* link:{baseurl}/api/tinymce.ui/tinymce.ui.floatpanel.html[[.return-type]#tinymce.ui.FloatPanel#] - Current floatpanel instance.
...
* [.return-type]#Object# - Event arguments object.

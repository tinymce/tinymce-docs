...
|link:#window[Window()] |Constructs a instance with the specified settings. |link:/docs-4x/api/tinymce.ui/tinymce.ui.window[tinymce.ui.Window]
|===
...
|link:#fullscreen[fullscreen()] |Switches the window fullscreen mode. |link:/docs-4x/api/tinymce.ui/tinymce.ui.window[tinymce.ui.Window]
...
|link:#getcontentwindow[getContentWindow()] |Returns the contentWindow object of the iframe if it exists. |link:/docs-4x/api/tinymce.ui/tinymce.ui.window[tinymce.ui.Window]
...
|link:#hideall[hideAll()] |Hide all visible float panels with he autohide setting enabled. This is for manually hiding floating menus or panels. |link:/docs-4x/api/tinymce.ui/tinymce.ui.floatpanel[tinymce.ui.FloatPanel]
|link:#initlayoutrect[initLayoutRect()] |Initializes the current controls layout rect. This will be executed by the layout managers to determine the default minWidth/minHeight etc. |link:/docs-4x/api/tinymce.ui/tinymce.ui.window[tinymce.ui.Window]
...
|link:#postrender[postRender()] |Called after the control has been rendered. |link:/docs-4x/api/tinymce.ui/tinymce.ui.window[tinymce.ui.Window]
...
|link:#recalc[recalc()] |Recalculates the positions of the controls in the current container. This is invoked by the reflow method and shouldn't be called directly. |link:/docs-4x/api/tinymce.ui/tinymce.ui.window[tinymce.ui.Window]
...
|link:#remove[remove()] |Removes the current control from DOM and from UI collections. |link:/docs-4x/api/tinymce.ui/tinymce.ui.window[tinymce.ui.Window]
...
|link:#renderhtml[renderHtml()] |Renders the control as a HTML string. |link:/docs-4x/api/tinymce.ui/tinymce.ui.window[tinymce.ui.Window]
...
|link:#submit[submit()] |Fires a submit event with the serialized form. |link:/docs-4x/api/tinymce.ui/tinymce.ui.window[tinymce.ui.Window]
...
* link:/docs-4x/api/tinymce.ui/tinymce.ui.window[[.return-type]#tinymce.ui.Window#] - Current window instance.
...
[#getcontentwindow .anchor]##

=== link:#getcontentwindow[getContentWindow]

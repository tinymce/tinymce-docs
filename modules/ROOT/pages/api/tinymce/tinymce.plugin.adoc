...
* `+addOn+` link:{baseurl}/api/tinymce/tinymce.theme.html[`+(tinymce.Theme)+`] - Theme or plugin to add.

[[return-value]]
==== Return value
anchor:returnvalue[historical anchor]

* link:{baseurl}/api/tinymce/tinymce.theme.html[`+tinymce.Theme+`] - The same theme or plugin instance that got passed in.
* link:{baseurl}/api/tinymce/tinymce.plugin.html[`+tinymce.Plugin+`] - The same theme or plugin instance that got passed in.
...
* link:{baseurl}/api/tinymce/tinymce.theme.html[`+tinymce.Theme+`] - Theme or plugin add-on instance or undefined.
* link:{baseurl}/api/tinymce/tinymce.plugin.html[`+tinymce.Plugin+`] - Theme or plugin add-on instance or undefined.

...
| Inheritance
| SplitButton xref:api/ui/class_tinymce.ui.Button.adoc[Button] [.last]#xref:api/ui/class_tinymce.ui.Control.adoc[Control]#

| Subclasses
| xref:api/ui/class_tinymce.ui.ColorSplitButton.adoc[ColorSplitButton]
|===

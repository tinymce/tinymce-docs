...
For information on basic usage of `init`, see: link:https://www.tiny.cloud/docs/tinymce/8/basic-setup/[Basic setup].|`xref:apis/tinymce.root.adoc[tinymce]`
...
For information on basic usage of `init`, see: link:https://www.tiny.cloud/docs/tinymce/8/basic-setup/[Basic setup].

...
* `config (Object)` - For information on the available options, see: link:https://www.tiny.cloud/docs/tinymce/8/dialog-configuration/#options[Dialog - Configuration options].
* `params (Object)` - (Optional) For information on the available options, see: link:https://www.tiny.cloud/docs/tinymce/8/dialog-configuration/#configuration-parameters[Dialog - Configuration parameters].
...
* `config (Object)` - For information on the available options, see: link:https://www.tiny.cloud/docs/tinymce/8/urldialog/#configuration[URL dialog - Configuration].

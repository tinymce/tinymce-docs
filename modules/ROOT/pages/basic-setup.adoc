...
Providing a {productname} editor with the default configuration, such as: liveDemo::default[ ]

The selector can target most block elements when the editor is used in link:use-tinymce-inline.html[inline editing mode]. Inline mode edits the content in place, instead of replacing the element with an `+iframe+`.
...
For information on the differences between the classic and inline editing modes, see: link:use-tinymce-inline.html[Setup inline editing mode].
...
For a full list of plugins and their options, see: link:/plugins-ref/[Add plugins to TinyMCE].
...
* For additional toolbar options, including disabling the toolbar and adding multiple toolbars, see: link:toolbar-configuration-options.html#toolbar[User interface options - toolbar].
* For a list of all available toolbar items, see: link:available-toolbar-buttons.html[Toolbar Buttons Available for {productname}].
...
* For information on the `+menu+` setting, see: link:menus-configuration-options.html#menu[User interface options - menu].
* For information on the `+menubar+` setting, see: link:menus-configuration-options.html#menubar[User interface options - menubar].
* For a list of all available menu items, see: link:available-menu-items.html[Menu Items Available for {productname}].
...
* For information on Plugins and their options, see: link:work-with-plugins.html[Add plugins to TinyMCE].
* For information on the CSS required to render some {productname} elements outside of the editor, see: link:editor-content-css.html[Boilerplate content CSS].

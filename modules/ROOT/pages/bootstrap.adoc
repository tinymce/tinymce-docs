...
The {productname} jQuery integration can be used with bootstrap. For information on using the jQuery integration, see: xref:jquery-pm.adoc[jQuery integration]

This procedure creates a basic Bootstrap integration containing a {productname} editor based on our xref:basic-example.adoc[Basic example].

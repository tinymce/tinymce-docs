...
[source,js]
----
import contentUiSkin from 'tinymce/skins/ui/example/content.css';
...
[source,js]
----
const contentUiSkin = require('tinymce/skins/ui/example/content.css');
require('tinymce/skins/ui/example/skin.css');
/* Only required for inline editors */
const contentUiInlineCss = require('tinymce/skins/ui/example/content.inline.css');
----

...
* The TinyMCE editor toolbar is now accessible for all screen widths; it no longer collapses into an inaccessible vertical line at any presented screen width.
...
* New `setText` and `setIcon` methods added to menu button and toolbar button API.

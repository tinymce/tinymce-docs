...
NOTE: From link:https://www.tiny.cloud/docs/tinymce/latest/7.6.0-release-notes/#overview[{productname} 7.6.0] onwards, the editor uses disabled mode instead of read-only mode.
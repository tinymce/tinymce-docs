...
NOTE: This feature requires the xref:comments_callback_mode.adoc#tinycomments_resolve[`tinycomments_resolve`] or xref:comments_embedded_mode.adoc#tinycomments_can_resolve[`tinycomments_can_resolve`] setting to be configured.

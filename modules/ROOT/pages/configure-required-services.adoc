...
The Enhanced Media Embed server-side component require additional configuration, which can be found on the link:/plugins-ref/premium/mediaembed/mediaembed-server-config/[Enhanced Media Embed page].

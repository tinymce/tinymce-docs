...
:title_nav: Create a skin :description_short: Introducing skin creation. :description: Introducing skin creation, less and icon modification. :keywords: create creator skin icon
...
. Update the \{\{site.productname}} init function with the link:{{site.baseurl}}/interface/editor-appearance/editor-skin/#skin[skin] option and/or the link:{{site.baseurl}}/content/add-css-options/#content_css[content_css] option.

For more information on how to specify the location of the skin file, see link:{{site.baseurl}}/interface/editor-appearance/editor-skin/#skin_url[this] section.

== Modifying the icons

For information on adding custom icons, see: link:{{site.baseurl}}/how-to-guides/customizing-the-editor-appearance/creating-an-icon-pack/[Create an icon pack for \{\{site.productname}}].

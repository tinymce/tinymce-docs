...
. Update the {productname} init function with the link:editor-skin.html#skin[skin] option and/or the link:add-css-options.html#content_css[content_css] option.

For more information on how to specify the location of the skin file, see link:editor-skin.html#skin_url[this] section.

== Modifying the icons

For information on adding custom icons, see: link:creating-an-icon-pack.html[Create an icon pack for {productname}].

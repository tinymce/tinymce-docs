...
____
Don't forget to explore our ready-to-use Premium Icon Packs such as 'Material' icons, and a smaller version of our default icons at link:{plugindirectory}/skins-and-icon-packs/[\{\{site.prem_skins_icons}}].
____
...
The icon pack name will be used with the link:{baseurl}/interface/editor-appearance/editor-icons/#icons[icons] option to apply the icons in \{\{site.productname}}.
...
For a list of the icon identifiers, see: link:{baseurl}/how-to-guides/creating-custom-ui-components/editor-icon-identifiers/[Available icons].

\{\{site.productname}} does not resize the SVGs provided, relying on the size defined in the SVG. This allows icons of different sizes to be used in the editor. The Toolbar button sizes are independent of the icon sizes. To change button sizes, a link:{baseurl}/how-to-guides/customizing-the-editor-appearance/creating-a-skin/[custom skin] is required.
...
include::partial$configuration/icons_url.adoc[] :customIconPack: false

...
The icon pack name will be used with the link:editor-icons.html#icons[icons] option to apply the icons in {productname}.
...
For a list of the icon identifiers, see: link:editor-icon-identifiers.html[Available icons].

{productname} does not resize the SVGs provided, relying on the size defined in the SVG. This allows icons of different sizes to be used in the editor. The Toolbar button sizes are independent of the icon sizes. To change button sizes, a link:creating-a-skin.html[custom skin] is required.

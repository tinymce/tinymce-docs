...
| `+name+` | The `+name+` parameter is a unique identifier for the new view. | `+String+`

| `+obj+` | The `+obj+` parameter is the view specification object. | `+View.ViewSpec+`
|===
...
| `+buttons+` | The `+buttons+` property specifies an array of buttons to be displayed in the top right corner of the view. | `+Array+`

| `+onShow+` | The `+onShow+` property specifies a function to be called when the view is displayed. It receives an API object. | `+Function+`

| `+onHide+` | The `+onHide+` property specifies a function to be called when the view is hidden. It receives an API object. | `+Function+`
|===

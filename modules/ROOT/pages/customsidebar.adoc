...
:title_nav: Sidebars :description_short: Introducing sidebar panel creation. :description: A short introduction to creating sidebars. :keywords: sidebar
...
The `+icon+` specifies an icon for the sidebar toggle button. The icon should be the name of an icon provided by the \{\{site.productname}} skin or a link:{{site.baseurl}}/apis/tinymce.editor.ui/tinymce.editor.ui.registry/#addicon/[custom icon].

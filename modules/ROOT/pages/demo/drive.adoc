...
This example shows you how to use Tiny Drive for your file and image management. For more information on the Tiny Drive plugin, see the link:{rootDir}plugins/drive.html[docs].
...
tinymce.init({
  ...
  tinydrive_demo_files_url: '{rootDir}demo/tiny-drive-demo/demo_files.json',

...
This example shows you how to setup {productname} to produce different results for its URLs in images and links. You can read more about these config options in the xref:general-configuration-guide/get-support.adoc[{productname} FAQ].

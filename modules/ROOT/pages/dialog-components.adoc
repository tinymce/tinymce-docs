...
A *tree* is a composite component that presents an expandable category tree expandable down one level. It can also include a search and filter field.
...
tinymce.init({
    ...
    setup: (ed) => {
      ...
      body : {
        ...
        items: [{
          ...
          items: [{type: 'directory', id: 'dir', title: 'Directory',
      menu: {
        icon: 'image-options',
          type: 'menubutton',
          fetch: (success) => success([
            {type: 'menuitem', text: 'Menu item', onAction: () => {store.add('menuitem');}}
          ])
      },
      children: [
        {type: 'leaf', title: 'Leaf 3', id: '3',},
        {type: 'leaf', title: 'Leaf 4', id: '4',
          menu: { icon: 'image-options', type: 'menubutton', fetch: (success) => success([
            {type: 'menuitem', text: 'Menu item', onAction: () => {store.add('menuitem');}
            }
          ])
        }
  ...
  {type: 'leaf', title: 'Leaf 5', id: '5',},
  {type: 'leaf', title: 'Leaf 6',id: '6',},
  ]
  }]
  }
  })

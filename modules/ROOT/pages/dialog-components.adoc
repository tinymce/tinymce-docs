...
*tree* items can also be set to `+fetch+` other {productname} menus.

For example: //restructure the example below to present the menus in a more structured fashion?

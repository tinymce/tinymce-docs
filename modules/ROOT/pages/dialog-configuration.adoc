...
=== Configure a dialog without a footer

include::partial$misc/admon-requires-6.6v.adoc[]

To configure a custom dialog so it does not render a footer section when displayed, set the `buttons` property to an empty array, `[]`, or to `undefined`.
...
include::partial$configuraton/dialog_align.adoc[]

include::partial$configuraton/dialog_border.adoc[]

include::partial$configuraton/dialog_button.adoc[]

include::partial$configuraton/dialog_persistent.adoc[]

include::partial$configuraton/dialog_streamContent.adoc[]

...
|mceInsertNewLine |Adds a new line at the current cursor or selection, such as splitting the current paragraph element. The behaviour of this setting can be controlled with the xref:content-behavior-options.adoc#newline_behavior[newline_behavior] option.

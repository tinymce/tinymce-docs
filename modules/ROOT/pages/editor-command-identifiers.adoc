...
The following tables show the existing editor commands. These commands are provided by `+tinymce+` and not by the browser's internal commands. These commands can be executed using the link:tinymce.editorcommands.html#execcommand[execCommand] function.
...
|Lang |Sets the language of the current selection. The value passed in should be a language spec described in link:content-localization.html#content_langs[Content appearance options - `+content_langs+`].
...
|FormatBlock |Toggles the format of the current selection. The value passed in should be the format name. If no format is specified, the paragraph (<`+p+`>) format will be toggled. For a list of options, see: link:content-formatting.html#built-informats[Content formatting options - Built-in formats].
...
|mceToggleFormat |Toggles a specified format by name. The value is the name of the format to toggle. For a list of options, see: link:content-formatting.html#built-informats[Content formatting options - Built-in formats].
...
|ToggleToolbarDrawer |Toggles the Toolbar Drawer. For information on toolbars, see: link:toolbar-configuration-options.html#toolbar[User interface options - Toolbar].
...
The following command requires the link:advcode.html[Advanced Code (`+advcode+`)] plugin.

include::partial$commands/code-cmds.adoc[]

==== Advanced Lists

The following commands require the link:advlist.html[Advanced Lists (`+advlist+`)] plugin.

include::partial$commands/advlist-cmds.adoc[]

==== Advanced Tables

The following commands require the link:advtable.html[Advanced Tables (`+advtable+`)] plugin.

include::partial$commands/advtable-cmds.adoc[]

==== Anchor

The following command requires the link:anchor.html[Anchor (`+anchor+`)] plugin.

include::partial$commands/anchor-cmds.adoc[]

==== Autoresize

The following command requires the link:autoresize.html[Autoresize (`+autoresize+`)] plugin.

include::partial$commands/autoresize-cmds.adoc[]

==== Case Change

The following commands require the link:casechange.html[Case Change (`+casechange+`)] plugin.

include::partial$commands/casechange-cmds.adoc[]

==== Character Map

The following command requires the link:charmap.html[Character Map (`+charmap+`)] plugin.

include::partial$commands/charmap-cmds.adoc[]

==== Code

The following command requires the link:code.html[Code (`+code+`)] plugin.

include::partial$commands/code-cmds.adoc[]

==== Code Sample

The following command requires the link:codesample.html[Code Sample (`+codesample+`)] plugin.

include::partial$commands/codesample-cmds.adoc[]

==== Comments

The following commands require the link:comments.html[Comments (`+tinycomments+`)] plugin.

include::partial$commands/comments-cmds.adoc[]

==== Directionality

The following commands require the link:directionality.html[Directionality (`+directionality+`)] plugin.

include::partial$commands/directionality-cmds.adoc[]

==== Emoticons

The following commands require the link:emoticons.html[Emoticons (`+emoticons+`)] plugin.

include::partial$commands/emoticons-cmds.adoc[]

==== Export

The following commands require the link:export.html[Export (`+export+`)] plugin.

include::partial$commands/export-cmds.adoc[]

==== Format Painter

The following commands require the link:formatpainter.html[Format Painter (`+formatpainter+`)] plugin.

include::partial$commands/formatpainter-cmds.adoc[]

==== Full Screen

The following command requires the link:fullscreen.html[Full Screen (`+fullscreen+`)] plugin.

include::partial$commands/fullscreen-cmds.adoc[]

==== Help

The following command requires the link:help.html[Help (`+help+`)] plugin.

include::partial$commands/help-cmds.adoc[]

==== Image

The following command requires the link:image.html[Image (`+image+`)] plugin.

include::partial$commands/image-cmds.adoc[]

==== Image Tools

The following commands require the link:imagetools.html[Image Tools (`+imagetools+`)] plugin.

include::partial$commands/imagetools-cmds.adoc[]

==== Insert Date/Time

The following commands require the link:insertdatetime.html[Insert Date/Time (`+insertdatetime+`)] plugin.

include::partial$commands/insertdatetime-cmds.adoc[]

==== Link

The following command requires the link:link.html[Link (`+link+`)] plugin.

include::partial$commands/link-cmds.adoc[]

==== Lists

The following commands require the link:lists.html[Lists (`+lists+`)] plugin.

include::partial$commands/lists-cmds.adoc[]

==== Media

The following command requires the link:media.html[Media (`+media+`)] plugin.

include::partial$commands/media-cmds.adoc[]

==== Nonbreaking Space

The following command requires the link:nonbreaking.html[Nonbreaking Space (`+nonbreaking+`)] plugin.

include::partial$commands/nbsp-cmds.adoc[]

==== Page Break

The following command requires the link:pagebreak.html[Page Break (`+pagebreak+`)] plugin.

include::partial$commands/pagebreak-cmds.adoc[]

==== Paste

The following commands require the link:paste.html[Paste (`+paste+`)] plugin.

include::partial$commands/paste-cmds.adoc[]

==== Permanent Pen

The following commands require the link:permanentpen.html[Permanent Pen (`+permanentpen+`)] plugin.

include::partial$commands/permanentpen-cmds.adoc[]

==== PowerPaste

The following command requires the link:powerpaste.html[PowerPaste (`+powerpaste+`)] plugin.

include::partial$commands/powerpaste-cmds.adoc[]

==== Preview

The following command requires the link:preview.html[Preview (`+preview+`)] plugin.

include::partial$commands/preview-cmds.adoc[]

==== Save

The following commands require the link:save.html[Save (`+save+`)] plugin.

include::partial$commands/save-cmds.adoc[]

==== Search and Replace

The following command requires the link:searchreplace.html[Search and Replace (`+searchreplace+`)] plugin.

include::partial$commands/searchreplace-cmds.adoc[]

==== Spell Checker Pro

The following commands require the link:tinymcespellchecker.html[Spell Checker Pro (`+tinymcespellchecker+`)] plugin.

include::partial$commands/tinymcespellchecker-cmds.adoc[]

==== Table

The following commands require the link:table.html[Table (`+table+`)] plugin.

include::partial$commands/table-cmds.adoc[]

==== Template

The following command requires the link:template.html[Template (`+template+`)] plugin.

include::partial$commands/template-cmds.adoc[]

==== Table of Contents

The following commands require the link:toc.html[Table of Contents (`+toc+`)] plugin.

include::partial$commands/toc-cmds.adoc[]

==== Visual Blocks

The following command requires the link:visualblocks.html[Visual Blocks (`+visualblocks+`)] plugin.

include::partial$commands/visualblocks-cmds.adoc[]

==== Visual Characters

The following command requires the link:visualchars.html[Visual Characters (`+visualchars+`)] plugin.

include::partial$commands/visualchars-cmds.adoc[]

==== Word Count

The following command requires the link:visualchars.html[Word Count (`+wordcount+`)] plugin.
...
|mceToggleEditor |Runs mceAddEditor if an editor is not detected for the specified ID, otherwise it runs either link:tinymce.editor.html#hide[hide] if the editor is visible or link:tinymce.editor.html#show[show] if it is not visible.
|===
...
The following command states can be queried using the link:tinymce.editorcommands.html#querycommandstate[queryCommandState] API.
...
The following command values can be queried using the link:tinymce.editorcommands.html#querycommandvalue[queryCommandValue] API.

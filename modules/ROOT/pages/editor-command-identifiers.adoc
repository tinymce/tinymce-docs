...
| Lang
| Sets the language of the current selection. The value passed in should be a language spec described in xref:content-localization.adoc#content_langs[Content appearance options - `content_langs`].
...
The following commands require the xref:editimage.adoc[Image Tools (`imagetools`)] plugin.
...
The following commands require the xref:tableofcontents.adoc[Table of Contents (`toc`)] plugin.

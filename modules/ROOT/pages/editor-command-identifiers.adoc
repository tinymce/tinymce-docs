...
The following tables show the existing editor commands. These commands are provided by `+tinymce+` and not by the browser's internal commands. These commands can be executed using the link:apis/tinymce.editorcommands.html#execcommand[execCommand] function.
...
include::partial$commands/imagetools-cmds.adoc[leveloffset=+3]
...
include::partial$commands/paste-cmds.adoc[leveloffset=+3]
...
include::partial$commands/toc-cmds.adoc[leveloffset=+3]
...
include::partial$commands/table-query-cmd-values.adoc[leveloffset=+3]

...
** xref:query-command-values-tables[Query command values for tables]
...
For additional commands that are provided by the core table functionality, see xref:core-commands-for-tables[Core Table Commands].

...
For information on customizing the context menu and adding custom context menu sections, see: link:contextmenu.html#availablecontextmenusections[Context menu].

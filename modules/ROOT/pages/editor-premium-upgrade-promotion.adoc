...
This promotion button redirects to a link:{companyurl}/tinymce-self-hosted-premium-features/?utm_source=TinyMCE&utm_medium=SPAP&utm_campaign=SPAP&utm_id=editorreferral[promotion page], arguing the benefits of Community mode users switching from self-hosted to the {productname} cloud.

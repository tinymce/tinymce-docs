...
This promotion button redirects to a link:{companyurl}/tinymce-self-hosted-premium-features/[promotion page], arguing the benefits of Community mode users switching from self-hosted to the {cloudname}.

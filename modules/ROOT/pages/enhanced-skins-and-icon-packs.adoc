...
Use the xref:editor-appearance.adoc#skin[skin] option, in combination with the xref:content-appearance.adoc#content_css[content_css] option and the values listed below.

Available values for xref:editor-appearance.adoc#skin[skins]:
...
Available values for xref:content-appearance.adoc#content_css[content_css]:
...
Use the xref:editor-appearance.adoc#icons[icons] option with any of the values listed below.

Available values for xref:editor-appearance.adoc#icons[icon] packs:
...
For information on using the `icons` option, see: xref:editor-appearance.adoc#icons[User interface options - `icons`].

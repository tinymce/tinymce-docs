...
link:{baseurl}/cloud-deployment-guide/editor-and-features.html[TinyMCE Cloud] makes setting up Enhanced Media Embed a breeze. Simply include the `mediaembed` parameter in your `tinymce.init` and have our Cloud services do the work for you.
...
You also need to link:{baseurl}/enterprise/embed-media/mediaembed-server-integration.html[integrate] and link:{baseurl}/enterprise/embed-media/mediaembed-server-config.html[configure] the Enhanced Media Embed server.

...
TinyMCE PowerPaste is a Premium Plugin from TinyMCE. We have flexible purchase options: as a https://about.tiny.cloud/products/powerpaste/[stand-alone plugin], to link:{pricingpage}[OEM and custom enterprise pricing].

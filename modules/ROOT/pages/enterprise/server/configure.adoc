...
* xref:enterprise/check-links.adoc#linkcheckersdkquicksetup[Link Checker]
...
Assuming you've saved your `logback.xml` file in `/etc/opt/tinymce`, follow xref:enterprise/server.adoc#step4passtheconfigurationfiletothejavaapplicationserver[step 4] and xref:enterprise/server.adoc#step5restartthejavaapplicationserver[step 5] on the _Install Server-side Components_ page to set the following JVM system property on your Java application server:

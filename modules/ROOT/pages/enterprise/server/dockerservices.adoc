...
* xref:containerizedservicesforself-hostedenterprisedeployments[Containerized services for Self-hosted Enterprise deployments]
* xref:containerizedservicesforindividuallylicensedpremiumplugins[Containerized services for individually licensed premium plugins]

[[containerizedservicesforself-hostedenterprisedeployments]]
...
* For the Enhanced Media Embed and Link Checker service, see: xref:deploythetinymcehyperlinkingserver-sidecomponentusingdockerself-hostedenterprisebundles[Deploy the TinyMCE hyperlinking server-side component using Docker (self-hosted enterprise bundles)].
* For the Image Tools plugin service, see: xref:deploythetinymceimageproxyserver-sidecomponentusingdockerself-hostedenterprisebundles[Deploy the TinyMCE image proxy server-side component using Docker (self-hosted enterprise bundles)].
* For the Spell Checker Pro service, see: xref:deploythetinymcespellingserviceserver-sidecomponentusingdockerself-hostedenterprisebundles[Deploy the TinyMCE spelling service server-side component using Docker (self-hosted enterprise bundles)].
...
[[containerizedservicesforindividuallylicensedpremiumplugins]]
...
* link:{plugindirectory}enhanced-media-embed[_Tiny Enhanced Media Embed_]
* link:{plugindirectory}link-checker[_Tiny Link Checker_]
* link:{plugindirectory}spell-checker-pro[_Tiny Spell Checker Pro_]

Select from the following:

* For the Tiny Enhanced Media Embed and Tiny Link Checker service, see: xref:deploythetinymcehyperlinkingserver-sidecomponentusingdockerindividuallylicensed[Deploy the TinyMCE hyperlinking server-side component using Docker (individually licensed)].
* For the Tiny Spell Checker Pro service, see: xref:deploythetinymcespellingserviceserver-sidecomponentusingdockerindividuallylicensed[Deploy the TinyMCE spelling service server-side component using Docker (individually licensed)].

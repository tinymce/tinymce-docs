...
| link:{baseurl}/enterprise/check-spelling/index.html[Spellchecking]
| ephox-spelling.war
| Spell checking service for TinyMCE Enterprise.

| link:{baseurl}/plugins/imagetools.html[Image Tools Proxy]
| ephox-image-proxy.war
| Image proxy service for the Image Tools plugin.

| link:{baseurl}/enterprise/embed-media/index.html[Enhanced Media Embed], link:{baseurl}/enterprise/check-links.html[Link Checker]
...
Refer to the link:{baseurl}/enterprise/server/configure.html[Configure] page for the details and come back here when you're done.

...
| link:{{site.baseurl}}/enterprise/check-spelling/[Spellchecking]
| ephox-spelling.war
| Spell checking service for {{site.productname}} Enterprise.

| link:{{site.baseurl}}/plugins/premium/export/[Export], link:{{site.baseurl}}/plugins/opensource/imagetools/[Image Tools Proxy]
| ephox-image-proxy.war
| Image proxy service for the Export and Image Tools plugins.

| link:{{site.baseurl}}/enterprise/embed-media/[Enhanced Media Embed], link:{{site.baseurl}}/enterprise/check-links/[Link Checker]
| ephox-hyperlinking.war
| Link Checker and Enhanced Media Embed service for {{site.productname}} Enterprise.
|===

...
| xref:enterprise/check-spelling/index.adoc[Spellchecking]
| ephox-spelling.war
| Spell checking service for {productname} Enterprise.

| xref:plugins/premium/export.adoc[Export], xref:plugins/opensource/imagetools.adoc[Image Tools Proxy]
| ephox-image-proxy.war
| Image proxy service for the Export and Image Tools plugins.

| xref:enterprise/embed-media/index.adoc[Enhanced Media Embed], xref:enterprise/check-links.adoc[Link Checker]
...
Refer to the xref:enterprise/server/configure.adoc[Configure] page for the details and come back here when you're done.
...
After you've completed the steps on this page to xref:enterprise/server/index.adoc#step2deployserver-sidecomponents[Deploy server-side components], xref:enterprise/server/index.adoc#step3createaconfigurationfile[Create a configuration file] and xref:enterprise/server/index.adoc#step4passtheconfigurationfiletothejavaapplicationserver[Pass the configuration file to the Java application server], the application server may need to be restarted to pick up all your changes. Turn it off and on again now, just to be safe.

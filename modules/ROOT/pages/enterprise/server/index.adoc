...
After you've completed the steps on this page to xref:enterprise/server.adoc#step2deployserver-sidecomponents[Deploy server-side components], xref:enterprise/server.adoc#step3createaconfigurationfile[Create a configuration file] and xref:enterprise/server.adoc#step4passtheconfigurationfiletothejavaapplicationserver[Pass the configuration file to the Java application server], the application server may need to be restarted to pick up all your changes. Turn it off and on again now, just to be safe.

...
* xref:advanced-tables-events[Advanced Tables events]
...
* xref:table-events[Table events]
...
For events applicable to the Advanced Tables plugin, see: xref:table-events[Table events].

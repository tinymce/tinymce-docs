...
|Dirty |N/A |Fired when the editor transitions from a "pristine" state to a "dirty" state. The editor is "dirty" when link:{baseurl}/apis/tinymce/tinymce.undomanager/[an undo level] has been _created_ since initialization or the last saved state. To check if the editor is "dirty", use the link:{baseurl}/apis/tinymce/tinymce.editor/#isdirty[`+editor.isDirty+` API].
...
|BeforeOpenNotification |`+{ notification: NotificationSpec }+` |Fired before a notification is displayed. For information on the Notifications Specification (`+NotificationSpec+`), see: link:{baseurl}/how-to-guides/creating-custom-ui-components/creating-custom-notifications/[Create custom notifications].
|OpenNotification |`+{ notification: NotificationApi }+` |Fired after a notification is displayed. For information on the Notifications API (`+NotificationApi+`), see: link:{baseurl}/how-to-guides/creating-custom-ui-components/creating-custom-notifications/[Create custom notifications].
|===
...
The following events are provided by the link:{baseurl}/plugins-ref/opensource/autosave/[Autosave plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/opensource/charmap/[Character Map plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/premium/comments/[Comments plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/premium/formatpainter/[Format Painter plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/opensource/fullscreen/[Fullscreen plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/opensource/importcss/[Import CSS plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/premium/linkchecker/[Link Checker plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/opensource/lists/[Lists plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/premium/mediaembed/[Media Embed plugin].
...
The following events are provided by the link:{baseurl}/plugins-ref/opensource/paste/[Paste plugin].
...
The following events are provided by the link:{baseurl}/plugins-ref/premium/permanentpen/[Permanent Pen plugin].
...
The following events are provided by the link:{baseurl}/plugins-ref/premium/powerpaste/[PowerPaste plugin].
...
The following events are provided by the link:{baseurl}/plugins-ref/opensource/spellchecker/[Spell Checker plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/opensource/visualblocks/[Visual Blocks plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/opensource/visualchars/[Visual Characters plugin].
...
The following event is provided by the link:{baseurl}/plugins-ref/opensource/wordcount/[Word Count plugin].

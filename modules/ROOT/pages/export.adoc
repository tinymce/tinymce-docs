...
* The link:checklist.html[Checklist plugin] icons will not render for Internet Explorer 11 users due to browser limitations.

The following plugins are not supported:

* link:bbcode.html[BBCode]
* link:comments.html[Comments]
* link:mediaembed.html[Enhanced Media Embed]
* link:fullpage.html[Fullpage]
* link:legacyoutput.html[Legacy Output]
* link:media.html[Media]
* link:pageembed.html[Page Embed]
* link:toc.html[Table of Contents]

...
* <<client-sidepdfclientpdf, Client-side PDF (`+clientpdf+`)>>
...
* The link:{baseurl}/plugins-ref/premium/checklist/[Checklist plugin] icons will not render for Internet Explorer 11 users due to browser limitations.

The following plugins are not supported:

* link:{baseurl}/plugins-ref/opensource/bbcode/[BBCode]
* link:{baseurl}/plugins-ref/premium/comments/[Comments]
* link:{baseurl}/plugins-ref/premium/mediaembed/[Enhanced Media Embed]
* link:{baseurl}/plugins-ref/opensource/fullpage/[Fullpage]
* link:{baseurl}/plugins-ref/opensource/legacyoutput/[Legacy Output]
* link:{baseurl}/plugins-ref/opensource/media/[Media]
* link:{baseurl}/plugins-ref/premium/pageembed/[Page Embed]
* link:{baseurl}/plugins-ref/opensource/toc/[Table of Contents]

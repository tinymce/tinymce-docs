...
:navtitle: Cloud deployment of plugins only
...
Extend the xref:basic-setup.adoc[{productname} configuration] to include any additional purchased plugins and associated toolbar and menu items. For the enablement guide for each plugin, refer to xref:plugins.adoc#premium-plugins[Premium plugins].

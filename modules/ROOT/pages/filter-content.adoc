...
\{\{site.productname}} contains built-in formats that can be overridden. More information about these default controls is in the link:{baseurl}/how-to-guides/learn-the-basics/basic-setup/[Basic setup] part of this guide.

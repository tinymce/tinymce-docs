...
:title_nav: Content filtering :description: Learn how to create clean, maintainable and readable content.
...
\{\{site.productname}} contains built-in formats that can be overridden. More information about these default controls is in the link:{{site.baseurl}}/how-to-guides/learn-the-basics/basic-setup/[Basic setup] part of this guide.

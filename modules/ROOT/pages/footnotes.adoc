...
Footnotes can be inserted using the _Insert footnote_ button, located on the toolbar, or by selecting the _Insert > Insert Footnote_ command from the menu bar, or by using the `+mceInsertFootnote+` command.

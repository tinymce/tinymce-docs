...
The format painter acts upon all [`+formats+`](\{\{ site.baseurl }}/content/content-formatting/#formats) registered in the editor. In addition to any standard formatting, it will treat *lists* as a block format whenever the link:{baseurl}/plugins-ref/opensource/lists/[`+lists plugin+`] is made available.

include::partial$configuration/formatpainter_formats.adoc[]

include::partial$configuration/formatpainter_blacklisted_formats.adoc[]

...
The format painter acts upon all link:content-formatting.html#formats[`+formats+`] registered in the editor. In addition to any standard formatting, it will treat *lists* as a block format whenever the link:lists.html[`+lists plugin+`] is made available.

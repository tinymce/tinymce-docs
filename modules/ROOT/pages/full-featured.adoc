...
* xref:paste.adoc[Paste] -- xref:powerpaste.adoc[*PowerPaste*] included instead.
* xref:spellchecker.adoc[Spellchecker] -- xref:tinymcespellchecker.adoc[*Spell Checker Pro*] included instead.

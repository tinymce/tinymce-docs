...
For a full list of plugins and their options, see: xref:plugins/index.adoc[Add plugins to TinyMCE].
...
* For a full list of configuration options, see: the xref:configure/index.adoc[Configuration options reference].
* For a full list of Plugins and their options, see: xref:plugins/index.adoc[Add plugins to TinyMCE].
* For information on the UI elements, see: xref:ui-components/index.adoc[User interface components].

...
* For a list of all available toolbar items, see: link:{{site.baseurl}}/advanced/available-toolbar-buttons/[Toolbar Buttons Available for \{\{site.productname}}].
...
* For a list of all available menu items, see: link:{{site.baseurl}}/advanced/available-menu-items/[Menu Items Available for \{\{site.productname}}].

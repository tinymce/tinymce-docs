...
Paid premium support is available as part of link:{pricingpage}[{enterpriseversion} and {cloudname} subscriptions]. {productname} Enterprise customers can xref:enterprise/support.adoc[submit a case support request].

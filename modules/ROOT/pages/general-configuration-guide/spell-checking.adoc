...
// TODO: the next line contains a broken link (check-spelling.adoc does not exist) as it needs an adoc file counterpart
Review the {productname} Premium Features xref:enterprise/check-spelling.adoc[documentation for Spelling]. Learn more about link:{pricingpage}[{productname} Premium Products here].

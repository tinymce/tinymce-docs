...
* Configuring a Quick Toolbar; including `quicklink`, `quickimage`, and `quicktable`; see: xref:plugins/opensource/quickbars.adoc[Quick Toolbar plugin].
...
* Disabling the {productname} menubar, see: xref:configure/editor-appearance.adoc#menubar[Menubar].
* The `inline` setting, see: xref:configure/editor-appearance.adoc#inline[inline].

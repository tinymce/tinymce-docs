...
Don't worry if you can't remember all these values. The xref:plugins/index.adoc[plugins section] goes into great detail explaining all the plugins options, toolbars, and menu controls.
...
As we noted at the start {productname} is an incredibly powerful, flexible, and customizable rich text editor. Once you have finished the Get Started guide, deep dive into the xref:plugins/index.adoc[plugins] and xref:configure/index.adoc[configuration options].

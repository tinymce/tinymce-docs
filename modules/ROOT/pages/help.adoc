...
|addTab |tabSpec: link:dialog-components.html#tabpanel[TabPanel] |Register a tab for the Help dialog
|===
...
For information on how to expose metadata from you custom plugin to add it to the Installed plugins list in the Help plugin, see the link:creating-a-plugin.html#exposingmetadata[Creating a Plugin page].

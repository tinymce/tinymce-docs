...
|addTab |tabSpec: link:{baseurl}/how-to-guides/creating-custom-ui-components/dialogs/dialog-components/#tabpanel[TabPanel] |Register a tab for the Help dialog
|===

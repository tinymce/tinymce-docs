...
Set the https://www.tiny.cloud/docs-3x/reference/configuration/entity_encoding/[entity_encoding] option to "raw".
...
Set the https://www.tiny.cloud/docs-3x/reference/configuration/verify_html/[verify_html] to false.
...
Disable the cleanup by setting https://www.tiny.cloud/docs-3x/reference/configuration/cleanup/[cleanup] option to false.

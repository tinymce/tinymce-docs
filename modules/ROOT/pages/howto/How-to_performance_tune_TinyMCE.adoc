...
Use and install the xref:compressor/about.adoc[TinyMCE Compressor].
...
Set the xref:reference/configuration/entity_encoding.adoc[entity_encoding] option to "raw".
...
Set the xref:reference/configuration/verify_html.adoc[verify_html] to false.
...
Disable the cleanup by setting xref:reference/configuration/cleanup.adoc[cleanup] option to false.

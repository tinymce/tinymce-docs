...
[NOTE]
This feature is currently **only available** for sales managed `self-hosted` customers. A cloud-based option for self-served customers will be available in 2024.
...
tinymce.init({
  ...
  importword_service_url: '<replace_with_service_url>'
});
----

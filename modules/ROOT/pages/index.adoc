...
|
[.lead]
xref:basic-setup.adoc[Introduction & getting started]

New to self-hosting {productname}? Start here.

|
[.lead]
xref:editor-and-features.adoc[Cloud deployment guide]

Start here for {cloudname}.

|
[.lead]
xref:basic-example.adoc[Examples]
...
|
[.lead]
xref:apis/tinymce.editor.adoc[API Reference]

...
*Spell Checker Pro* adds spell checking as-you-type capabilities to \{\{site.productname}}. For information on the supported languages, refer to link:{baseurl}/plugins-ref/premium/tinymcespellchecker/#spellchecker_language[this] section.
...
For information on installing the server-side component for spell checking, please see the link:{baseurl}/how-to-guides/premium-server-side-guide/[server-side component installation guide].

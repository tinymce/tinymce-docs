...
*Spell Checker Pro* adds spell checking as-you-type capabilities to {productname}. For information on the supported languages, refer to xref:introduction-to-tiny-spellchecker.adoc#spellchecker_language[this] section.

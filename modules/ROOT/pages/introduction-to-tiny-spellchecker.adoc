...
This event is fired when the editor content is checked for misspellings and suggestions, either by opening the dialog or by executing the `+mceSpellcheckUpdate+` command.

...
|Open the help dialog |Alt+0 |Option+0 |link:help.html[help]
|Insert link |Ctrl+K |Command+K |link:link.html[link]
|Toggle Fullscreen |Ctrl+Shift+F |Command+Shift+F |link:fullscreen.html[fullscreen]
|Save |Ctrl+S |Command+S |link:save.html[save]
|Find |Ctrl+F |Command+F |link:searchreplace.html[searchreplace]
|===

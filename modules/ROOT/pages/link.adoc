...
include::partial$configuration/link_default_target.adoc[]
...
include::partial$configuration/link_rel_list.adoc[]

include::partial$configuration/link_target_list.adoc[]

...
If you are using link:/how-to-guides/cloud-deployment-guide/editor-and-features/[{cloudname}], add `+"linkchecker"+` to your plugins list, and the service will be automatically configured.

...
The `+lists+` plugin allows you to add numbered and bulleted lists to \{\{site.productname}}. To enable advanced lists (e.g. alpha numbered lists, square bullets) you should also enable the link:{baseurl}/plugins-ref/opensource/advlist/[Advanced List] (`+advlist+`) plugin.

...
link:{gettiny}/language-packages/[Download the Chinese language] pack to test this functionality. Install a _local instance_ of {productname} from the link:{gettiny}[downloads page]. Follow the xref:advanced-install.adoc#self-hostedinstall[self-hosted install instructions].

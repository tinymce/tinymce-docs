...
[NOTE]
These syntax elements listed in the table below represent the current supported Markdown syntax for the initial release.
...
| Code | `++`code`++`
| Horizontal Rule | `+---+`
| Link | `+[title](https://www.tiny.cloud/tinymce)+`

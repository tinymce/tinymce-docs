...
It's possible to change the visual appearance of the Merge tags within the editor using a custom CSS file provided though the xref:add-css-options.adoc#content_css[content_css] option. Here is an example on how to style the various elements of the merge tag.

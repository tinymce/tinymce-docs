...
| The text color functionality is now part of the {productname} core. For information on using and customizing the text color settings, see: xref:configure/content-appearance.adoc#text_color[Content appearance options - Text color options].

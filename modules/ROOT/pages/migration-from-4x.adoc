...
| xref:menuitems.adoc#basicmenuitems[Menu item]
...
| xref:menuitems.adoc#nestedmenuitems[Nested menu item]
...
| xref:menuitems.adoc#togglemenuitems[Toggle menu item]
...
The API methods for adding xref:toolbarbuttons.adoc#howtocreatecustomtoolbarbuttons[Custom toolbar buttons] have changed for TinyMCE 5. The methods have been moved from link:{url}/docs-4x/api/tinymce/tinymce.editor/[`+editor.*+`] to xref:apis/tinymce.editor.ui.registry.adoc[`+editor.ui.registry.*+`]. The toolbar button type `listbox` has been removed and a toggle button type has been added. The button types available in TinyMCE 5 are:
...
The following methods for creating custom toolbar buttons have been moved for TinyMCE 5. For information on how to use the new methods, see: xref:toolbarbuttons.adoc[Toolbar buttons].
...
| xref:menuitems.adoc#togglemenuitems[Adds a custom toolbar toggle button].
...
For information on how to use these methods, see: xref:menuitems.adoc[Custom menu items].
...
| A callback that is called when switching tabs in a xref:dialogcomponents.adoc#tabpanel[TabPanel].
|===
...
For information about the new dialog configuration, see the xref:dialog.adoc[Dialog] and xref:dialogcomponents.adoc[Dialog components] documentation.

...
* xref:plugin-changes[Plugin Changes]
...
* xref:cloud-delivery[Cloud Delivery].
* xref:option-setting-changes[Option/setting changes].
* xref:plugin-changes[Plugin Changes]
...
The `+noneditable_editable_class+` and `+nonedtiable_noneditable_class+` options have been renamed, see: xref:renamed-options[Renamed Options].

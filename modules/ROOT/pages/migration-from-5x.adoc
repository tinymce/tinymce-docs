...
This default can be overridden as part of an initialization configuration. And setting `min_height` to `> 400` will increase the height of the intitial {productname} viewport. .

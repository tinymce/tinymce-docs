...
* xref:pluginchanges[Plugin Changes]
...
* xref:optionsettingchanges[Option/setting changes].
* xref:pluginchanges[Plugin Changes]
...
For information on specifying tab order, see: xref:accessibility.adoc#taborder[Tab order].

[[optionsettingchanges]]
...
The `+noneditable_editable_class+` and `+nonedtiable_noneditable_class+` options have been renamed, see: xref:renamedoptions[Renamed Options].

...
For additional details on {productname} {release-version} changes, see link:https://www.tiny.cloud/docs/tinymce/latest/7.0-release-notes/#overview[{productname} {release-version} release notes].

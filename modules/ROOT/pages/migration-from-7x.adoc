...
{productname}'s Java Swing integration was deprecated in {productname} 8.0 and reached end-of-life on December 31, 2025.

**Impact**: Customers using the Java Swing integration need to migrate to an alternative solution.

**Migration checklist:**


* [ ] Evaluate alternative integration options
* [ ] Plan the migration away from the Java Swing integration

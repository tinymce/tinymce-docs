...
For information on {productname} deployment types, see: xref:advanced-install.adoc[Installing {productname}].
...
* Installing {productname}, see: xref:advanced-install.adoc[Installing {productname}].

[[updatingthelistofplugins]]
== Updating the list of Plugins

Some _Froala core functionality_ is implemented by xref:plugins.adoc[plugins for {productname}]; and some _Froala plugin-provided functionality_ is {productname} core functionality.
...
To include a plugin for a {productname} editor, add a `plugins` option and provide a xref:integration-and-setup.adoc#plugins[space-delimited list of the plugins to include], as shown below. You should delete any Froala sourcing scripts and Froala links from the page.
...
* For information on enabling plugins for {productname}, see: xref:integration-and-setup.adoc#plugins[Integration and setup options: plugins].
* For a list of {productname} plugins, see: xref:plugins.adoc[Add plugins to {productname}].
...
* For information on customizing the {productname} Toolbar, see: xref:editor-appearance.adoc#toolbar[User interface options: Toolbar].
...
* xref:editor-appearance.adoc#menubar[Disabling the {productname} menubar].
...
* Disabling the {productname} menubar, see: xref:editor-appearance.adoc#menubar[User interface options: Menubar].
...
For information on getting started with the `addButton` option, see: xref:toolbarbuttons.adoc#howtocreatecustomtoolbarbuttons[Toolbar buttons].
...
* For an overview on creating custom toolbar buttons, see: xref:toolbarbuttons.adoc#howtocreatecustomtoolbarbuttons[Toolbar buttons].
* For information on the available types of toolbar buttons and examples of custom toolbar buttons, see: xref:typesoftoolbarbuttons.adoc[Types of toolbar buttons].
...
For information on getting started with the `addMenuButton` option, see: xref:toolbarbuttons.adoc#howtocreatecustomtoolbarbuttons[Toolbar buttons] and xref:typesoftoolbarbuttons.adoc#menubutton[Types of toolbar buttons: Menu button].
...
For information on creating drop-down buttons, see: xref:typesoftoolbarbuttons.adoc#menubutton[Types of toolbar buttons: Menu button].

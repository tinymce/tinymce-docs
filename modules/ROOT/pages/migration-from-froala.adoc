...
For information on getting started with the `addMenuButton` option, see: xref:custom-toolbarbuttons.adoc#howtocreatecustomtoolbarbuttons[Toolbar buttons] and xref:typesoftoolbarbuttons.adoc#menubutton[Types of toolbar buttons: Menu button].

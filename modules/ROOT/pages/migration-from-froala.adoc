...
:description: Upgrading your rich text editor from Froala Editor v3 to {productname} {productmajorversion}.
...
==== {productname} {productmajorversion} - A Basic Configuration
...
==== {productname} {productmajorversion} - Enabling Plugins
...
==== {productname} {productmajorversion} - Creating a Custom Toolbar Layout
...
==== {productname} {productmajorversion} - Configuring Inline Mode
...
==== {productname} {productmajorversion} - Creating a Custom Toolbar Button
...
==== {productname} {productmajorversion} - Creating a Custom Drop-down Button

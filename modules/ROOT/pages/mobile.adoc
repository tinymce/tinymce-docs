...
// TODO: the next line contains a brokenn link as it has no adoc counterpart
...
* xref:configure/editor-appearance.adoc#toolbar_mode[`toolbar_mode`] - defaults to `scrolling` on mobile devices. The toolbar will xref:sidescrollingtoolbarsonmobile[side-scroll by default].

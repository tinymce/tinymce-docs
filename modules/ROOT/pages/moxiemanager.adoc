...
include::partial$misc/admon_moxiemanager_not_on_cloud[]
...
MoxieManager is a paid addition to \{\{site.productname}}. It is included in link:{pricingpage}/[\{\{enterpriseversion}} subscriptions].

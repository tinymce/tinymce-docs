...
. The *InsertEdit Iframe* dialog box appears. image:{baseurl}/images/insert-iframes.png[InsertEdit Iframe]
...
include::partial$configuration/tiny_pageembed_classes.adoc[]

include::partial$configuration/tiny_pageembed_inline_styles.adoc[]
...
For more information on configuring CSS, refer to the link:{baseurl}/content/add-css-options/#content_css[content_css] section.

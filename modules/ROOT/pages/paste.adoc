...
TIP: Looking for more advanced Microsoft Word importing and pasting? Try the xref:introduction-to-powerpaste.adoc[PowerPaste] plugin.
...
include::partial$configuration/paste_enable_default_filters.adoc[leveloffset=+1]

include::partial$configuration/paste_filter_drop.adoc[leveloffset=+1]
...
include::partial$configuration/paste_word_valid_elements.adoc[leveloffset=+1]

include::partial$configuration/paste_webkit_styles.adoc[leveloffset=+1]

include::partial$configuration/paste_retain_style_properties.adoc[leveloffset=+1]
...
include::partial$configuration/paste_convert_word_fake_lists.adoc[leveloffset=+1]
...
The Paste plugin provides the following {productname} command.

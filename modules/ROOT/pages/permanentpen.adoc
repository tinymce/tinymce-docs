...
For more information on {productname} formats, refer to the link:content-formatting.html#formats[formats] section.
...
Add the Permanent pen properties option to the menu bar with the link:menus-configuration-options.html#menu[menu] configuration.

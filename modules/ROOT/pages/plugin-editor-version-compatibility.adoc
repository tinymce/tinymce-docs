...
Use the following matrix in conjunction with the optional parameters for specifying editor version and link:/how-to-guides/cloud-deployment-guide/editor-plugin-version/[plugin version] to ensure compatibility.
...
____
*Important*: Ensure the plugins are supported in your editor version when deploying premium plugins only using link:/how-to-guides/cloud-deployment-guide/features-only/[{cloudname}].
____

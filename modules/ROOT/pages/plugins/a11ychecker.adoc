...
Accessibility checker is part of the demo link:{product_homepage}[on the main page of TinyMCE site]. For more information about the accessibility checker link:{blogsite}tinymce-enterprise-update-benefits-accessibility-users-brings-atmentions/[see this blog post].

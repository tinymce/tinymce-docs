...
For more information on configuring menu items refer to the xref:configure/editor-appearance.adoc#toolbar[toolbar] and xref:configure/editor-appearance.adoc#menu[menu] sections.
...
For more information on TinyMCE formats, refer to the xref:configure/content-formatting.adoc#formats[formats] section.
...
Check out the xref:demo/comments.adoc#comments20demo[Comments demo] to try out this new feature.

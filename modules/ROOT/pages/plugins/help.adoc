...
For information on how to expose metadata from you custom plugin to add it to the Installed plugins list in the Help plugin, see the  link:{rootDir}advanced/creating-a-plugin/#exposingmetadata[Creating a Plugin page].

...
link:{pricingpage}[TinyMCE Enterprise] subscription also includes proxy service written in Java. Check link:{baseurl}/enterprise/server/index.html[Install Server-side Components] guide for details.

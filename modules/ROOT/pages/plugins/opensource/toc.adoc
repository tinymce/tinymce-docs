...
Internally plugin doesn't apply any inline styles. Basic formatting can be added via xref:general-configuration-guide/boilerplate-content-css.adoc[Boilerplate Content CSS], that can be customized to your needs.

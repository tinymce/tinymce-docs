...
. Add the path to the PowerPaste plugin folder to the link:{rootDir}configure/integration-and-setup/#external_plugins[external plugins] option in `tinymce.init()`.

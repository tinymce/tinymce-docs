...
include::partial$configuration/tinycomments_create.adoc[]

include::partial$configuration/tinycomments_reply.adoc[]

include::partial$configuration/tinycomments_edit_comment.adoc[]

include::partial$configuration/tinycomments_resolve.adoc[]

include::partial$configuration/tinycomments_delete_comment.adoc[]

include::partial$configuration/tinycomments_delete.adoc[]

include::partial$configuration/tinycomments_delete_all.adoc[]

include::partial$configuration/tinycomments_lookup.adoc[]

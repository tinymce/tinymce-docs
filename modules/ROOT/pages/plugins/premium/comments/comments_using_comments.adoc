...
image:{baseurl}/images/comments-delete-comment.png[delete comment]
...
image:{baseurl}/images/comments-delete-conversation.png[delete conversation]
...
____
*NOTE*: This feature requires the link:{baseurl}/plugins/premium/comments/comments_callback_mode/#tinycomments_resolve[`tinycomments_resolve`] or link:{baseurl}/plugins/premium/comments/comments_embedded_mode/#tinycomments_can_resolve[`tinycomments_can_resolve`] setting to be configured.
____
...
. The following decision dialog box will appear: +
image:{baseurl}/images/comments-resolve-conversation.png[resolve conversation]
...
. The following decision dialog box will appear: +
image:{baseurl}/images/comments-delete-conversations.png[Delete all conversations]

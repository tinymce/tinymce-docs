...
NOTE: This feature requires the xref:plugins/premium/comments/comments_callback_mode.adoc#tinycomments_resolve[`tinycomments_resolve`] or xref:plugins/premium/comments/comments_embedded_mode.adoc#tinycomments_can_resolve[`tinycomments_can_resolve`] setting to be configured.

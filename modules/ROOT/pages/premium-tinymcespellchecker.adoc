...
*Spell Checker Pro* adds spell checking as-you-type capabilities to {productname}. For information on the supported languages, refer to xref:premium-tinymcespellchecker.adoc#spellchecker_language[this] section.
...
For information on installing the server-side component for spell checking, please see the xref:server.adoc[server-side component installation guide].

...
// TODO: The link in the next line is broken and does not have a corresponding adoc file to be linked to
...
* Self-hosting {productname}, see: xref:general-configuration-guide/advanced-install.adoc[Installing {productname}].

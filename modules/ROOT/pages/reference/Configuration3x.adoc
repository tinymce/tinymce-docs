...
This document is the index/reference page for all available core configuration options in TinyMCE. There is also a list of old and xref:Deprecated_Configuration_Options.adoc[deprecated config options] for older versions of TinyMCE.
...
* [theme_advanced_container_+++<container>+++](\xref:reference/configuration/theme_advanced_container_container/)+++<.adoccontainer>+++
* [theme_advanced_container_+++<container>+++_class](\xref:reference/configuration/theme_advanced_container_container_class/)+++<.adoccontainer>+++
* [theme_advanced_container_+++<container>+++_align](\xref:reference/configuration/theme_advanced_container_container_align/)+++<.adoccontainer>+++

...
This option enables you to specify an id for the body of each editor instance. This id can then be used to do TinyMCE specific overrides in your https://www.tiny.cloud/docs-3x/reference/configuration/content_css/[content_css].

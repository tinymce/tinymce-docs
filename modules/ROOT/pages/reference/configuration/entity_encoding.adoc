...
| named
| Characters will be converted into named entities based on the https://www.tiny.cloud/docs-3x/api/configuration/entities/[entities] option. For example, a non-breaking space could be encoded as &nbsp;.

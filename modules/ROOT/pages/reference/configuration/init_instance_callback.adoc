...
Also see the the https://www.tiny.cloud/docs-3x/reference/configuration/setup/[setup callback option] it enabled you to bind events before the editor instance is initialized.

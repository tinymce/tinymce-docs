...
Each of these layout managers have different options and can be configured in different ways. This option is only available if the "advanced" https://www.tiny.cloud/docs-3x/reference/configuration/theme/[theme] is used.

...
| @
a| Rules with this name will be applied to all elements defined after this rule. So @[attr1\|attr2] will enable attr1 and attr2 for all elements, but element1,@[attr1\|attr2],element2,element3 will enable attr1 and attr2 only for element2 and element3.

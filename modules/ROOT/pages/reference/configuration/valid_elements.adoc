...
Also see https://www.tiny.cloud/docs-3x/reference/configuration/extended_valid_elements/[extended_valid_elements] and https://www.tiny.cloud/docs-3x/reference/configuration/invalid_elements/[invalid_elements] for more configuration options.

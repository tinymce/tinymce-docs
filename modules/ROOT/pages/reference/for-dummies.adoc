...
Further more comprehensive instructions can be found on https://www.tiny.cloud/docs-3x/Installation/[Installation], which you can move on to when you have mastered the Dummies version! If you are not a Dummy don't edit, as us Dummies like simple instructions!

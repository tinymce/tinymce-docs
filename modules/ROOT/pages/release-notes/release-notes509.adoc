...
For more information on the media plugin refer to the link:{baseurl}/plugins/opensource/media/[documentation].
...
For more information on *Legacy Output* refer to the link:{baseurl}/plugins/opensource/legacyoutput/[documentation].
...
For more information on *Enhanced Media Embed* refer to the link:{baseurl}/plugins/premium/mediaembed/[documentation].
...
For more information on *Link Checker* refer to the link:{baseurl}/plugins/premium/linkchecker/[documentation].
...
For information on *Tiny Comments*, refer to the link:{baseurl}/plugins/premium/comments/[*Tiny Comments* documentation].
...
For information on *PowerPaste*, refer to the link:{baseurl}/plugins/premium/powerpaste/[*PowerPaste* documentation].

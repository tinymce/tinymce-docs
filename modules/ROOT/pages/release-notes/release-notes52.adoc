...
For information on inlining page embed styles, see: xref:plugins/premium/pageembed.adoc#inlinestylesforpageembeds[Page Embed plugin - Inline styles for page embeds].

...
For information on the `editor.hasPlugin()` API, see: link:{baseurl}/api/tinymce/tinymce.editor/#hasplugin[tinymce.Editor APIs - `hasPlugin`].
...
For information on the `unload` and `unloadAll` APIs, see: link:{baseurl}/api/tinymce.dom/tinymce.dom.stylesheetloader/[tinymce.dom.StyleSheetLoader].
...
* The `editor.insertContent()` API, see: link:{baseurl}/api/tinymce/tinymce.editor/#insertcontent[tinymce.Editor APIs - `insertContent`].
* The `editor.selection.setContent()` API, see: link:{baseurl}/api/tinymce.dom/tinymce.dom.selection/#setcontent[tinymce.dom.Selection APIs - `setContent`].

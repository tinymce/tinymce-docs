...
* The {productname} `setProgress()` API, see link:{baseurl}/api/tinymce/tinymce.editor/#setprogressstate[Editor API - `setProgressState`].
...
For information on the `URI` API, see: link:{baseurl}/api/tinymce.util/tinymce.util.uri/[URI].

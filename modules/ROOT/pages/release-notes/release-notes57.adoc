...
* The {productname} `setProgress()` API, see xref:api/tinymce/tinymce.editor.adoc#setProgressState[Editor API - `setProgressState`].
...
For information on the `URI` API, see: xref:api/tinymce.util/tinymce.util.uri.adoc[URI].

...
For a list of bug fixes included in this release, see: xref:pages-changelog.adoc#version5014august192019[Changelog - Version 5.0.14]
...
For information on Enhanced Media Embed refer to the xref:mediaembed.adoc[documentation].

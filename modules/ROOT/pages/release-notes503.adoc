...
For more information on *Case Change* refer to the full xref:premium-casechange.adoc[documentation].
...
For more information on *TinyMCE for Swing* refer to the full xref:swing.adoc[documentation].

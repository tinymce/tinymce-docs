...
For more information on `image_uploadtab`, refer to the xref:image.adoc#image_uploadtab[documentation].
...
For more information on *PowerPaste* refer to the full xref:powerpaste.adoc[documentation].

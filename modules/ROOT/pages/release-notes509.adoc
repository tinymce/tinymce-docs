...
For more information on *Enhanced Media Embed* refer to the xref:introduction-to-mediaembed.adoc[documentation].
...
For information on *PowerPaste*, refer to the xref:introduction-to-powerpaste.adoc[*PowerPaste* documentation].

...
For more information on *Enhanced Media Embed* refer to the xref:premium-mediaembed.adoc[documentation].
...
For more information on *Link Checker* refer to the xref:premium-linkchecker.adoc[documentation].
...
For information on *PowerPaste*, refer to the xref:premium-powerpaste.adoc[*PowerPaste* documentation].

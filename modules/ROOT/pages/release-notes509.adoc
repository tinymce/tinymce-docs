...
For more information on multiple toolbars refer to the xref:editor-appearance.adoc#usingmultipletoolbars[documentation].
...
For more information on the new options refer to the xref:integration-and-setup.adoc#base_url[base_url] and xref:integration-and-setup.adoc#suffix[suffix] documentation.
...
For more information on the media plugin refer to the xref:media.adoc[documentation].

== Updates and enhancements

=== TinyMCE

The new TinyMCE 5.0.9 editor comes with numerous changes to the previous versions. A comprehensive list of the updates and fixed issues is available in the xref:pages-changelog.adoc#version509june262019[changelog].
...
For more information on *Legacy Output* refer to the xref:legacyoutput.adoc[documentation].
...
For more information on *Enhanced Media Embed* refer to the xref:mediaembed.adoc[documentation].
...
For more information on *Link Checker* refer to the xref:linkchecker.adoc[documentation].
...
For information on *Tiny Comments*, refer to the xref:comments.adoc[*Tiny Comments* documentation].
...
For information on *PowerPaste*, refer to the xref:powerpaste.adoc[*PowerPaste* documentation].

...
* The `SpellcheckerIgnoreAll` event now includes a `language` property. For details, see xref:introduction-to-tiny-spellchecker.adoc#spellcheckerignoreallevent[Spell Checker Pro - SpellcheckerIgnoreAll Event].

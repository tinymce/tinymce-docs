...
* xref:a11ychecker.adoc#a11y_advanced_options[The Accessibility Checker plugin - `a11y_advanced_options`].
...
For information on the `a11y_advanced_options` setting, see: xref:a11ychecker.adoc#a11y_advanced_options[Accessibility Checker plugin].
...
For information on the `linkchecker_preprocess` option, see: xref:linkchecker.adoc#linkchecker_preprocess[Link Checker plugin - `linkchecker_preprocess`].

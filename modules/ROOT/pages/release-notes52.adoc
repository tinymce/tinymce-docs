...
For a list of the available user interface languages, see: xref:content-localization.adoc#language[Localization options - `language`].
...
For information on the checklist plugin, see: xref:checklist.adoc[Checklist plugin].
...
For information on inlining page embed styles, see: xref:pageembed.adoc#tiny_pageembed_inline_styles[Page Embed plugin - Inline styles for page embeds].

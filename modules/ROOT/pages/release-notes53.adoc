...
* The PowerPaste plugin, see: xref:powerpaste.adoc[PowerPaste plugin].
* The PowerPaste `paste_preprocess` option, see: xref:powerpaste.adoc#paste_preprocess[PowerPaste plugin - `paste_preprocess`].
* The PowerPaste `paste_postprocess` option, see: xref:powerpaste.adoc#paste_postprocess[PowerPaste plugin - `paste_postprocess`].
...
For information on Spell Checker Pro plugin, see: xref:tinymcespellchecker.adoc[Spell Checker Pro plugin].

...
* xref:introduction-to-tiny-spellchecker.adoc[The Spellchecker Pro premium plugin].
...
For information on the `typeahead_urls` option, see: xref:content-behavior-options.adoc#typeahead_urls[Advanced editing behaviors - `typeahead_urls`].

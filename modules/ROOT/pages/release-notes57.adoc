...
For information on the Spell Checker Pro API, see: xref:introduction-to-tiny-spellchecker.adoc#apis[Spell Checker Pro - APIs].
...
For information on the Spell Checker Pro Commands, see: xref:introduction-to-tiny-spellchecker.adoc#commands[Spell Checker Pro - Commands].
...
For information on the Spell Checker Pro Events, see: xref:introduction-to-tiny-spellchecker.adoc#events[Spell Checker Pro - `Events`].
...
It is now possible to specify arrays of words for specific languages to be ignored by the Spell Checker Pro plugin using the `spellchecker_ignore_list` option, see: xref:introduction-to-tiny-spellchecker.adoc#spellchecker_ignore_list[Spell Checker Pro - `spellchecker_ignore_list`].
...
For information on the `spellchecker_ignore_list` option, see: xref:introduction-to-tiny-spellchecker.adoc#spellchecker_ignore_list[Spell Checker Pro - `spellchecker_ignore_list`].

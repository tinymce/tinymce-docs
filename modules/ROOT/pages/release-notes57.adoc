...
For information on the `font_css` option, see: xref:content-appearance.adoc#font-css[Content Appearance - `font_css`].
...
* The Notifications API, see xref:creating-custom-notifications.adoc[Create custom notifications].
...
For information on the `media_live_embeds` option, see: xref:media.adoc#media_live_embeds[Media plugin - `media_live_embeds`].
...
For information on the `TableModified` event, see: xref:table.adoc#events[Table plugin - Events].
...
For information on the Mentions plugin, see: xref:premium-mentions.adoc[Mentions plugin].
...
For information on the Spell Checker Pro API, see: xref:premium-tinymcespellchecker.adoc#apis[Spell Checker Pro - APIs].
...
For information on the Spell Checker Pro Commands, see: xref:premium-tinymcespellchecker.adoc#commands[Spell Checker Pro - Commands].
...
For information on the Spell Checker Pro Events, see: xref:premium-tinymcespellchecker.adoc#events[Spell Checker Pro - `Events`].
...
It is now possible to specify arrays of words for specific languages to be ignored by the Spell Checker Pro plugin using the `spellchecker_ignore_list` option, see: xref:premium-tinymcespellchecker.adoc#spellchecker_ignore_list[Spell Checker Pro - `spellchecker_ignore_list`].
...
For information on the Spell Checker Pro plugin, see: xref:premium-tinymcespellchecker.adoc[Spell Checker Pro].
...
For information on using premium skins and icon packs, see: xref:premium-skins-and-icon-packs.adoc[Premium Skins and Icon Packs].
...
For information on the `spellchecker_ignore_list` option, see: xref:premium-tinymcespellchecker.adoc#spellchecker_ignore_list[Spell Checker Pro - `spellchecker_ignore_list`].

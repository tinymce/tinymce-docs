...
* Improved the error messages shown in the developer console for the `SpellcheckError` event, see: xref:tinymcespellchecker.adoc#events[Spell Checker Pro - `Events`].
...
* For a list of supported Spell Checker Pro languages, see: xref:tinymcespellchecker.adoc#supportedlanguages[Spell Checker Pro plugin - Supported languages].
...
For information on the `content_langs` option, see: xref:tinymcespellchecker.adoc#content_langs[Spell Checker Pro - `content_langs`].

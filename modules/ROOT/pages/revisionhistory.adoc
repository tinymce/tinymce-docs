...
* `Restore this version`: Set the selected version's content to the editor and close the view. Note that this button is disabled for the `initial` and `draft` versions.

...
An alternative to this documentation is a series of https://youtube.com/watch?v=zvu-7w-94vI&list=PLE6i0Bfo_RjlVyzACyh7XnnXJLoXD7h20[8 videos on setting up Real-Time Collaboration with TinyMCE]:

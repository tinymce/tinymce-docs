...
For information on setting up an Encryption Provider endpoint, see: link:{baseurl}/plugins-ref/premium/rtc/encryption/[Real-Time Collaboration (RTC) Encryption Setup].
...
For information on setting up a JSON Web Token Provider endpoint, see: link:{baseurl}/plugins-ref/premium/rtc/jwt-authentication/[Real-Time Collaboration (RTC) JWT Authentication Setup].
...
For details on the available configuration options, see: link:{baseurl}/plugins-ref/premium/rtc/configuration/[Configuration Options].

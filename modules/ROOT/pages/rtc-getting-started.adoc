...
For information on setting up an Encryption Provider endpoint, see: link:encryption.html[Real-Time Collaboration (RTC) Encryption Setup].
...
For information on setting up a JSON Web Token Provider endpoint, see: link:jwt-authentication.html[Real-Time Collaboration (RTC) JWT Authentication Setup].
...
For details on the available configuration options, see: link:configuration.html[Configuration Options].

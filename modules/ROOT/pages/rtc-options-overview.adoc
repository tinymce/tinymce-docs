...
xref:rtc-options-optional.adoc#rtc_server_disconnected[`rtc_server_disconnected`]::
...
xref:rtc-options-optional.adoc#rtc_user_details_provider[`rtc_user_details_provider`]::
This option:
...
xref:rtc-options-optional.adoc#rtc_client_info[`rtc_client_info`]::

...
IMPORTANT: include::partial$misc/secure-context.adoc[]
...
For information on setting up an Encryption Provider endpoint, see: link:{baseurl}/rtc/encryption/[Real-time Collaboration (RTC) Encryption Setup].
...
For information on setting up a JSON Web Token Provider endpoint, see: link:{baseurl}/rtc/jwt-authentication/[Real-time Collaboration (RTC) JWT Authentication Setup].
...
For details on the available configuration options, see: link:{baseurl}/rtc/configuration/[Configuration Options].

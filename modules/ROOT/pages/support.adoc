...
Paid premium support is available as part of link:{pricingpage}/[\{\{site.enterpriseversion}} and \{\{site.cloudname}} subscriptions]. \{\{site.productname}} Enterprise customers can link:{supporturl}/[submit a case support request].
...
Visit link:{baseurl}/how-to-guides/tinymce-for-mobile/[\{\{site.productname}} mobile documentation] for information on \{\{site.productname}} mobile setup and configuration.

...
____
*Note*: The advanced tabs of the table, row, and cell properties dialogs use the `+colorpicker+` to allow for border and background colors to be applied. See docs to use and configure a custom link:{baseurl}/content/user-formatting-options/#textcoloroptions[colorpicker].
____

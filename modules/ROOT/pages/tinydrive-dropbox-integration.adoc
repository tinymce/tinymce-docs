...
. Select the file to upload/import from Dropbox by clicking on the checkbox next to it and click the *Choose* button to upload or *Cancel* to abort the operation.

...
For more information on other {cloudfilemanager} config options refer to the xref:tinydrive-configuration.adoc[configuration] section of this document.

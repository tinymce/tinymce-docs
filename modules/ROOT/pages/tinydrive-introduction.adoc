...
For documentation on using {cloudfilemanager} outside {productname}, visit: link:https://www.tiny.cloud/docs/tinydrive/[{cloudfilemanager} documentation].

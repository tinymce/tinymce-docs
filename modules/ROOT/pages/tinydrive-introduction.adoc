...
For documentation on using \{\{site.cloudfilemanager}} outside \{\{site.productname}}, visit: link:{baseurl}/tinydrive/[\{\{site.cloudfilemanager}} documentation].

____
*Note*: This plugin is only available for link:{pricingpage}/[\{\{site.cloudname}} users].
____
...
The storage and bandwidth quota varies based upon your link:{pricingpage}/[\{\{site.cloudname}} Plan].

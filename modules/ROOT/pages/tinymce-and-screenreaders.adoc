...
:title_nav: Accessibility Guide :description_short: Learn how TinyMCE works with screen readers and how screen readers work with TinyMCE. :description: Learn how TinyMCE works with screen readers and how screen readers work with TinyMCE. :keywords: accessibility wai aria jaws nvda
...
For additional navigation keyboard shortcuts and shortcuts for applying some commonly-used formats, see: link:{{site.baseurl}}/accessibility/keyboard-shortcuts/[Keyboard shortcuts].
...
\{\{site.productname}} has accessibility options that can be set when initializing the editor, see: link:{{site.baseurl}}/interface/accessibility/[Accessibility options].

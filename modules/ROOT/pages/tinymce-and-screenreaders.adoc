...
For additional navigation keyboard shortcuts and shortcuts for applying some commonly-used formats, see: link:{baseurl}/accessibility/keyboard-shortcuts/[Keyboard shortcuts].
...
\{\{site.productname}} has accessibility options that can be set when initializing the editor, see: link:{baseurl}/interface/accessibility/[Accessibility options].

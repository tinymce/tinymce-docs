...
For additional navigation keyboard shortcuts and shortcuts for applying some commonly-used formats, see: link:keyboard-shortcuts.html[Keyboard shortcuts].
...
{productname} has accessibility options that can be set when initializing the editor, see: link:accessibility.html[Accessibility options].

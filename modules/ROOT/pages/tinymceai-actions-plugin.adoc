...
Here's the full list of available actions. The identifiers below are used by the REST API. For the plugin UI, configure the Translate submenu via `tinymceai_languages`.

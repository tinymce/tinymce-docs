...
image::https://placehold.net/default.png[{pluginname} Chat interface showing the conversational AI assistant]
...
image::https://placehold.net/default.png[{pluginname} Chat available models dropdown]
...
image::https://placehold.net/default.png[{pluginname} Chat add context user interface]
...
image::https://placehold.net/default.png[{pluginname} Chat apply changes]
...
image::https://placehold.net/default.png[{pluginname} Chat apply all changes]
...
image::https://placehold.net/default.png[{pluginname} Chat reject button]

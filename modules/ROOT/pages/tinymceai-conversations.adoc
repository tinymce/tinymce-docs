...
Conversations allow exchanging multiple messages with AI that maintains them in its context. Conversations can be extended by external context sources like websites or files, and have the ability to refer to editor content and suggest modifications.
...
Before documents can be referenced in conversations, they need to be uploaded first:
...
See how to upload other resources, including web resources and files using https://tinymceai.api.tiny.cloud/docs#tag/Conversations[REST API documentation].
...
* xref:tinymceai-models.adoc[AI Models] – Choosing the right AI model for conversations.

...
{pluginname} applies limits on API requests, context and attachments, models, and files to ensure fair usage, optimal performance, and cost control. The sections below describe rate limits, context limits, model-specific constraints, and file restrictions.

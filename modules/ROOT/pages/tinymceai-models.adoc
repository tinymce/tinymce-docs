...
NOTE: Please observe, that model names such as `gpt-5`, `claude-4-sonnet`, etc. are examples. Actual available models depend on your service's compatibility version. Use the `/v1/models` endpoint to see current available models for your environment.

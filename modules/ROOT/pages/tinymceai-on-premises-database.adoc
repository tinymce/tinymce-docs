...
:description_short: Database, Redis, and file storage setup.
:keywords: AI, on-premises, database, MySQL, PostgreSQL, Redis, Docker, Podman, file storage, S3, Azure Blob, infrastructure
...
NOTE: This section applies to PostgreSQL deployments only. MySQL deployments can skip to <<Version pinning>>.

...
The S3 access key requires the following minimum IAM permissions on the target bucket:
...
For production, enable bucket versioning and server-side encryption (SSE-S3 or SSE-KMS).

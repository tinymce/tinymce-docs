...
NOTE: The following values are approximate baselines. Actual performance depends on hardware, network conditions, LLM provider latency, and prompt complexity.

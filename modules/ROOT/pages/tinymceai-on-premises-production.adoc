...
[.text-center]
image::tinymceai-on-premises/production-guide-fig-1.svg[alt="Production deployment topology with reverse proxy AI service replicas database and Redis behind TLS",width=100%]
...
.Detailed enterprise deployment topology
[%collapsible]
====
[.text-center]
image::tinymceai-on-premises/complete-guide-fig-1.svg[alt="Enterprise architecture showing browser with TinyMCE token endpoint multiple AI service replicas database Redis LLM providers and observability",width=100%]
====

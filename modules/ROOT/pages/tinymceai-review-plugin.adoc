...
[NOTE]
====
* A checkmark in the Editor UI column means that review type can appear in the Review sidebar when its command is listed in xref:tinymceai.adoc#tinymceai_reviews[`tinymceai_reviews`].

...
Internally plugin doesn't apply any inline styles. Basic formatting can be added via link:/how-to-guides/learn-the-basics/editor-content-css/[Boilerplate Content CSS], that can be customized to your needs.

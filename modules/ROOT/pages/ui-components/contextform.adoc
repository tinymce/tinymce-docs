...
Context forms are a generalization of the `Insert Link` form that existed in the original link:{url}/docs-4x/themes/inlite/#quicklink[inlite] theme from TinyMCE 4.

...
The `icon` specifies an icon for the sidebar toggle button. The icon should be the name of an icon provided by the {productname} skin or a xref:api/tinymce.editor.ui/tinymce.editor.ui.registry.adoc#addIcon[custom icon].

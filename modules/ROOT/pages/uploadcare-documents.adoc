...
:navtitle: Files and Documents feature of the Media Optimizer plugin
:description: The Files and Documents feature of the Media Optimizer plugin allows you to upload and link document files in your content.
:description_short: upload and link document files in your content.
:plugincode: uploadcare
:pluginname: Media Optimizer's Files and Documents feature

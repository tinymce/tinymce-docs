...
:navtitle: Image feature of the Media Optimizer plugin
...
:pluginname: Media Optimizer's Image feature
...
| Revert
|
| image:icons/revert-changes.svg[revert.svg]

...
____
*Note*: link:{baseurl}/how-to-guides/creating-custom-ui-components/dialogs/dialog/[Standard \{\{site.productname}} dialogs] should suffice for most use cases, and may be simpler to configure.
____
...
|buttons |FooterButton[] |optional |An array of <<footerbuttons, buttons>> to render in the footer of the dialog.
...
____
*Note*: Unlike link:{baseurl}/how-to-guides/creating-custom-ui-components/dialogs/dialog/[standard dialogs], URL dialogs do not have a *Submit* type footer button, and therefore do not have an `+onSubmit+` callback.
____

...
* For information on using editor customization options, see: link:customize-ui.html[Customizing the editor UI].
* For information on localizing {productname}, see: link:localize-your-language.html[Localize TinyMCE].

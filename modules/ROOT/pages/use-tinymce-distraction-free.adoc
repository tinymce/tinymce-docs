...
include::partial$misc/admon_not_on_mobile[]
...
* Configuring a Quick Toolbar; including `+quicklink+`, `+quickimage+`, and `+quicktable+`; see: link:{baseurl}/plugins-ref/opensource/quickbars/[Quick Toolbar plugin].
...
* Disabling the \{\{site.productname}} menubar, see: link:{baseurl}/interface/menus/menus-configuration-options/#menubar[Menubar].

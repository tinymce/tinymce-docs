...
For information on inline mode and the `+inline+` setting, see: link:{baseurl}/interface/editor-mode/inline-editor-options/#inline[User interface options - inline].

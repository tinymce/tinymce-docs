= Bundling TinyMCE in a Vue.js application
...
This guide shows how to bundle {productname} into a Vue.js application using link:https://github.com/tinymce/tinymce-vue[{productname} Vue.js component].
...
* For more examples of `tinymce-vue` wrapper, see: https://tinymce.github.io/tinymce-vue/[the tinymce-vue storybook].

...
:title_nav: ES6 and npm :description_short: Bundling an npm version of TinyMCE in a project using ES6 and Webpack :description: Bundling an npm version of TinyMCE in a project using ES6 and Webpack :keywords: webpack es6 es2015 npm modules tinymce

\{% assign installtype = "an npm" %} \{% assign bundler = "https://webpack.js.org/[Webpack]" %} \{% assign syntax = "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules[ES6+ syntax]" %} \{% include module-loading/bundling-procedure-intro.md %}
...
\{% assign is_zip_install = false %} \{% include module-loading/webpack-dev-dependencies.md %}

{pluginname} does not support symmetrical encryption algorithms, such as HS256. {companyname} recommends using the RS256 algorithm. The following algorithms are supported:

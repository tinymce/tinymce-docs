...
For an example of how choice menu items are used in split toolbar buttons, see: xref:custom-split-toolbar-button.adoc#splitbuttonexampleandexplanation[Split button example and explanation].

...
IMPORTANT: When `a11y_advanced_options` is set to `true`, xref:premium-a11ychecker.adoc#a11ychecker_allow_decorative_images[`a11ychecker_allow_decorative_images`] will default to `true`.

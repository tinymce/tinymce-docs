...
* The xref:uploadcare.adoc[Media Optimizer Powered by Uploadcare] plugin (`+uploadcare+`).
...
* Adds the *Decorative image* button to Media Optimizer's _Alt text_ context toolbar, allowing users to specify that an image is decorative and does not require alternative text for accessibility purposes.

...
Using `advcode` inside {productname} means users on mobile devices or narrow screens do not require a `ToggleView` button, as `advcode` forces the editor to open within the existing editor space in inline mode.

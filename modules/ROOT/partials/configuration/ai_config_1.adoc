...
// Replace all instances of ai_config_1 with the
...
To disable <feature>, set `ai_config_1` to `false`.
...
=== Limitation(s) of the `ai_config_1` option

The `ai_config_1` option has the following limitations.

...
// Replace all instances of ai_config_2 with the
...
To disable <feature>, set `ai_config_2` to `false`.
...
=== Limitation(s) of the `ai_config_2` option

The `ai_config_2` option has the following limitations.

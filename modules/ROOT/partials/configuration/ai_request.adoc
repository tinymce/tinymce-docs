...
The `+ai_request+` function provides the {pluginname} with  will resolve with the response as a string provided by the AI endpoint, or reject with an error or string. 

Any resolved response or rejected error is displayed in the AI dialog.

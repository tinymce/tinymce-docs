...
| String
| required
| The language tag, as defined in https://www.ietf.org/rfc/bcp/bcp47.txt[Tags for Identifying Languages (BCP47)], for this language. This language tag is placed in the `lang` attribute for elements formatted using this language.

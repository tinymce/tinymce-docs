...
The default configuration includes the context menu sections for the following plugins: `+link+`, `+linkchecker+` , `+image+`, `+editimage+`, `+permanentpen+`, `+table+`, and `+spellchecker+`.

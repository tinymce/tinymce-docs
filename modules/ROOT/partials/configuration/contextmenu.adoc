...
\{% if page.title != "Context menu" %} For information on configuring the `+contextmenu+` option and creating custom context menu items link:contextmenu.html[context menu examples].
\{% endif %}

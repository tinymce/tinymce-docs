...
For information on configuring the `contextmenu` option and creating custom context menu items xref:ui-components/contextmenu.adoc[context menu examples].

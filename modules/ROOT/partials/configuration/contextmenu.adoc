...
The default configuration includes the context menu sections for the following plugins: `+link+`, `+linkchecker+` , `+image+`, `+imagetools+`, `+permanentpen+`, `+table+`, and `+tinymcespellchecker+`.

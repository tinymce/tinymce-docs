...
\{% if page.title != "Context menu" %} For information on configuring the `+contextmenu+` option and creating custom context menu items link:{baseurl}/how-to-guides/creating-custom-ui-components/contextmenu/[context menu examples]. \{% endif %}

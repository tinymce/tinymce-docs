...
Setting `+streamContent+` to `+true+` switches the update mechanism to the `document.write()` method and constantly presents the incoming content at an end-of-the-current data position.

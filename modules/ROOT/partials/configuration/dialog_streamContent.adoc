...
Setting the `+srcdoc+` attribute causes the `+iframe+` to reload. This results in a flickering effect on most modern browsers, which is visually jarring especially when updating the content rapidly.

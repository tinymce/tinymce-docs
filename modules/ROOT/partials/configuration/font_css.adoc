...
____
*Note*: To allow users to apply the fonts added though `+font_css+`, update the fonts list using the link:{{site.baseurl}}/content/user-formatting-options/#font_formats[`+font_formats+` option].
____

...
[NOTE]
====
The `+fullscreen_native+` option requires the Fullscreen plugin.
====
endif::[]
...
To use the browser-native full screen mode for the {productname} editor, set `+fullscreen_native+` to `+true+`.

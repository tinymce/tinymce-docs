...
* Which image file formats are recognized and placed in an `+img+` element by the xref:paste.adoc[Paste] and link:powerpaste.html[PowerPaste] `+smart_paste+` functionality.

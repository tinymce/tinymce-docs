...
* Which image file formats are recognized and placed in an `img` element by the xref:paste.adoc[Paste] and xref:premium-powerpaste.adoc[PowerPaste] `smart_paste` functionality.

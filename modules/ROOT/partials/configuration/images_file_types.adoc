...
* Which image file formats are allowed to be uploaded in the link:{{site.baseurl}}/plugins-ref/opensource/image/[Image] dialog.
* Which image file formats are recognized and placed in an `+img+` element by the link:{{site.baseurl}}/plugins-ref/opensource/paste/[Paste] and link:{{site.baseurl}}/plugins-ref/premium/powerpaste/[PowerPaste] `+smart_paste+` functionality.

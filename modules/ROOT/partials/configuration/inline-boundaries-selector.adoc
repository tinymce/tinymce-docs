...
If you add new elements, you need to add CSS selectors for them in the content CSS. See the link:{baseurl}/advanced/boilerplate-content-css.html[Boilerplate Content CSS page] for details.

...
For more information on the differences between the editing modes, please see this page link:{baseurl}/general-configuration-guide/use-tinymce-inline.html[here].

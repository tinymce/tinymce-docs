...
If you add new elements, you need to add CSS selectors for them in the content CSS. See the xref:general-configuration-guide/boilerplate-content-css/[Boilerplate Content CSS page] for details.

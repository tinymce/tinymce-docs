...
* _Community_ language packs - Localizations provided by \{\{site.productname}} users through Transifex, which need to be downloaded prior to use, from link:{gettiny}/language-packages/[the \{\{site. companyname}} Downloads Page - Language Packages].

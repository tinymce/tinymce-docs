...
NOTE: This context toolbar is the same as the context toolbar mentioned in the xref:plugins/opensource/link.adoc#link_quicklink[`link_quicklink`] documentation below.

...
____
*Note*: This context toolbar is the same as the context toolbar mentioned in the link:{{site.baseurl}}/plugins-ref/opensource/link/#link_quicklink[Link plugin - `+link_quicklink+`] documentation.
____

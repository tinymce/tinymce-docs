...
*Type:* `+String+`, `+Function+`, or `+Array+` of `+Objects+`

.Example: using an array of link items
...
.Example: using a nested list of link items
...
.Example: using an external script that returns a JSON array of link items
...
.Example: using a custom asynchronous callback function

...
This option allows you to specify which menus should appear on {productname}'s menu bar and the xref:advanced/available-menu-items.adoc[items] that should appear within the menus themselves.

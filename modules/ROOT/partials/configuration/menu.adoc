...
This option allows you to specify which menus should appear on {productname}'s menu bar and the link:/interface/menus/available-menu-items/[items] that should appear within the menus themselves.

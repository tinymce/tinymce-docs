...
This option allows you to specify which menus should appear on TinyMCE's menu bar and the link:{rootDir}advanced/editor-control-identifiers/#menucontrols[items] that should appear within the menus themselves.

...
____
*Note*: This behavior is different from the link:{{site.baseurl}}/plugins-ref/opensource/autoresize/[`+autoresize+`] plugin, which controls the resizing of the editable area only, not the entire editor.
____

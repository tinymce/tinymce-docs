...
NOTE: This behavior is different from the link:{baseurl}/plugins/opensource/autoresize/[`autoresize`] plugin, which controls the resizing of the editable area only, not the entire editor.

...
NOTE: This behavior is different from the xref:plugins/opensource/autoresize.adoc[`autoresize`] plugin, which controls the resizing of the editable area only, not the entire editor.

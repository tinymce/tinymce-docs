...
This example shows how to setup a mobile section override some of the desktop settings with link:{rootDir}configure/editor-appearance/#mobile[mobile] specific settings.

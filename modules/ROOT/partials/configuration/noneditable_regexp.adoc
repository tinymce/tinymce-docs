...
____
*Note*: If elements are matched by the regular expression, the elements will be replaced with spans. Use link:#noneditable_class[`+noneditable_class+`] for elements.
____

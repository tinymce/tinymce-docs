...
NOTE: To access this feature, you need to set the value of xref:plugins/opensource/paste.adoc#paste_enable_default_filters[paste_enable_default_filters] to `"false"` in your configuration.

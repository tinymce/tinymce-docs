...
____
*Note:* To access this feature, you need to set the value of link:{baseurl}/plugins-ref/opensource/paste/#paste_enable_default_filters[paste_enable_default_filters] to `+"false"+` in your configuration.
____

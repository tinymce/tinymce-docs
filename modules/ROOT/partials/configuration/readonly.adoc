...
* Navigation behaves the same as in design mode, including:
  ...
  ** Using arrow keys, kbd:[Home], kbd:[End], kbd:[Page Up], or kbd:[Page Down]
...
* Formatting changes:
  ** Keyboard shortcuts for formatting (e.g. kbd:[Command/Ctrl+B])
  ** Auto-linking when pressing kbd:[Space] after URLs
* Element modifications:
  ** Toggling checklists (via click or kbd:[Command/Ctrl+Enter])
  ** Indenting lists
  ** Adding new table rows via kbd:[Tab] key

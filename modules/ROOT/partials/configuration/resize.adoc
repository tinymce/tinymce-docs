...
* Focusing the resize handle, and using the arrow keys. The kbd:[Up Arrow] and kbd:[Left Arrow] keys will make the editor smaller, and the kbd:[Down Arrow] and kbd:[Right Arrow] keys will make the editor larger.

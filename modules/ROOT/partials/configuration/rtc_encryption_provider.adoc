...
For information on encryption for RTC, including suggestions on how to generate a secure encryption key and use key rotation, see: link:{{site.baseurl}}/rtc/encryption/[Real-time Collaboration (RTC) Encryption Setup].

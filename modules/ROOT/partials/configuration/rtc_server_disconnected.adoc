...
If the RTC session fails to connect, or is disconnected due to an error, the user will be blocked from editing (using link:tinymce.editor.html#setprogressstate[setProgressState]) along with an error notification:

...
By default, a user's unique ID (`+userId+`, the `+sub+` field from their link:jwt-authentication.html#requiredjwtclaimsforreal-timecollaboration[JWT]) will be displayed as the username in remote caret tooltips.

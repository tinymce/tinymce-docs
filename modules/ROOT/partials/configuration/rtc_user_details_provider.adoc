...
By default, a user's unique ID (`userId`, the `sub` field from their link:{baseurl}/rtc/jwt-authentication/#requiredjwtclaimsforreal-timecollaboration[JWT]) will be displayed as the username in remote caret tooltips.

...
The *quickbars_selection_toolbar* option configures the Quick Selection toolbar provided by the link:{{site.baseurl}}/plugins-ref/opensource/quickbars/[quickbars plugin]. To change the buttons on the Quick Selection toolbar, provide a space-separated string of [toolbar button names](\{\{ site.baseurl }}/interface/toolbars/available-toolbar-buttons/). The Quick Selection toolbar is intended for buttons related to formatting content, but any [\{\{site.productname}} toolbar buttons](\{\{ site.baseurl }}/interface/toolbars/available-toolbar-buttons/) or [custom toolbar buttons](\{\{ site.baseurl }}/how-to-guides/creating-custom-ui-components/toolbar-buttons/custom-toolbarbuttons/) are allowed.

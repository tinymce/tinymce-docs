...
For more information on the differences between regular and inline editing modes please see this page xref:general-configuration-guide/use-tinymce-inline.adoc[here].

...
To disable the `+smart_paste+` functionality, set `+smart_paste+` to `+false+`. To configure which image file types are recognised, see link:file-image-upload.html#images_file_types[Image & file options - images_file_types].

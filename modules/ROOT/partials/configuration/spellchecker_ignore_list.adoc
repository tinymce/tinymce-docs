...
NOTE: Languages specified as keys in the `spellchecker_ignore_list` object must match the configured xref:tinymcespellchecker.adoc#spellchecker_languages[Spellchecker Languages].

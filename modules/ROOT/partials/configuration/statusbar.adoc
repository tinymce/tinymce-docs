...
The statusbar includes the link:#elementpath[`+elementpath+`], link:{{site.baseurl}}/plugins-ref/opensource/wordcount/[`+wordcount+`] and editor link:{{site.baseurl}}/initial-configuration/editor-size-options/#resize[`+resize+`].

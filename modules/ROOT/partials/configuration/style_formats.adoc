...
This option allows you to define custom items for the `+styles+` dropdown toolbar button and the `+formats+` menu item.
...
* Add some custom styles to the `+styles+` dropdown toolbar button and the `+formats+` menu item using the xref:user-formatting-options.adoc#style_formats[style_formats] configuration option.

...
____
*Note*: This option was deprecated with the release of \{\{site.productname}} 5.4. This option has been replaced by link:#table_sizing_mode[`+table_sizing_mode+`]. This option will be removed in \{\{site.productname}} 6.0.
____

...
When end-users add a further custom color to the background text color grid, that color is added to teh background text color grid and stored in the `color_map_background` palette.
...
When end-users add a further custom color to the foreground text color grid, that color is added to teh background text color grid and stored in the `color_map_foreground` palette.

NOTE: When a user adds a custom color to the `color_map_foreground` palette, the editor does not replicate the new color in the `color_map_background` palette.

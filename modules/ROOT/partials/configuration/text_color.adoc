...
When end-users add a further custom color to the background text color grid, that color is added to the background text color grid and stored in the `color_map_background` palette.
...
When end-users add a further custom color to the foreground text color grid, that color is added to the background text color grid and stored in the `color_map_foreground` palette.

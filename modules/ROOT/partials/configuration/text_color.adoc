...
By default, the number of rows and columns is dependent of the number of colors specified using link:#color_map[`+color_map+`]. The dimensions of the grid will be calculated by \{\{site.productname}} to keep the grid a square or a rectangle with a minimum of 5 columns.

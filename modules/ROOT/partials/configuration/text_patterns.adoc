...
[NOTE]
The default value for this option was changed with {productname} 7.0, see more link:https://www.tiny.cloud/docs/tinymce/latest/7.0-release-notes/#a-new-trigger-property-for-block-text-pattern-configurations-allowing-pattern-activation-with-either-space-or-enter-keys[changes].

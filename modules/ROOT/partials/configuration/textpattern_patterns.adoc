...
* Registering formats for \{\{site.productname}}, see: link:{{site.baseurl}}/content/content-formatting/#formats[Content formatting options - `+formats+`].
* Registering commands for \{\{site.productname}}, see: link:{{site.baseurl}}/apis/tinymce/tinymce.editorcommands/[\{\{site.productname}} APIs - EditorCommands].
____

...
* Registering formats for {{site.productname}}, see: link:{{site.baseurl}}/configure/content-formatting/#formats[Content formatting options - `formats`].
* Registering commands for {{site.productname}}, see: link:{{site.baseurl}}/api/tinymce/tinymce.editorcommands/[{{site.productname}} APIs - EditorCommands].
____

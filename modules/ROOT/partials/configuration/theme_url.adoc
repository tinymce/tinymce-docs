...
This option allows you to specify a custom location for the theme files. Use this option **only** when you need to load the theme files from a location that is not bundled with the core {productname} distribution. The current supported theme is called *Silver*.

...
For information on how to create these tokens, refer to the link:{{site.baseurl}}/plugins-ref/premium/tinydrive/jwt-authentication/[JWT authentication guide].

...
This option allows you to specify the link:{rootDir}advanced/editor-control-identifiers/#toolbarcontrols[buttons] and the order that they will appear on TinyMCE's toolbar.

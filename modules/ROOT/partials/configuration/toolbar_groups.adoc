...
This option accepts an object, mapping the button name to the group configuration. For details on configuring toolbar groups, see: link:custom-group-toolbar-button.html[`+group toolbar button configuration+`].

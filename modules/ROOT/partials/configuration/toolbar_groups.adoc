...
This option accepts an object, mapping the button name to the group configuration. For details on configuring toolbar groups, see: link:{baseurl}/ui-components/typesoftoolbarbuttons/#grouptoolbarbutton[`group toolbar button configuration`].

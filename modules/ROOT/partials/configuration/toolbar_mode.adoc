...
The toolbar modes are not available when using xref:toolbar-configuration-options.adoc#usingmultipletoolbars[multiple toolbars] or the xref:toolbar-configuration-options.adoc#toolbarn[toolbar(n)] option.

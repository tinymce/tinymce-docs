...
The toolbar modes are not available when using link:{baseurl}/interface/toolbars/toolbar-configuration-options/#usingmultipletoolbars[multiple toolbars] or the link:{baseurl}/interface/toolbars/toolbar-configuration-options/#toolbarn[toolbar(n)] option.
...
include::partial$misc/admon_different_default_for_mobile[]

...
The toolbar modes are not available when using xref:editor-appearance.adoc#usingmultipletoolbars[multiple toolbars] or the xref:editor-appearance.adoc#toolbarn[toolbar(n)] option.

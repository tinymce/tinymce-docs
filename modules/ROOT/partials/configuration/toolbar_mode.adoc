...
The toolbar modes are not available when using link:toolbar-configuration-options.html#usingmultipletoolbars[multiple toolbars] or the link:toolbar-configuration-options.html#toolbarn[toolbar(n)] option.

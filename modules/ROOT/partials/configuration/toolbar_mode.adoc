...
The toolbar modes are not available when using xref:configure/editor-appearance.adoc#usingmultipletoolbars[multiple toolbars] or the xref:configure/editor-appearance.adoc#toolbarn[toolbar(n)] option.

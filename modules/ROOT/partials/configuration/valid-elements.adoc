...
Use `*[*]` to include all elements and all attributes. This can be very useful when used with the link:{rootDir}configure/content-filtering/#invalid_elements[invalid_elements] option.

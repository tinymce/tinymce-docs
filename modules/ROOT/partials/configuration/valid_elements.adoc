...
Use `*[*]` to include all elements and all attributes. This can be very useful when used with the xref:configure/content-filtering.adoc#invalid_elements[invalid_elements] option.

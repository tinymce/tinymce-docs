...
----
+
For information on the `image-proxy` configuration setting, see: xref:configure-required-services.adoc#image-proxyoptional[Configure server-side components - `image-proxy`].

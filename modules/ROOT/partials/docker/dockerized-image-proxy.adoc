...
NOTE: This procedure assumes that a {productname} self-hosted enterprise bundle has been extracted as described in xref:bundle-intro-setup.adoc#downloadandextractthetinymceself-hostedbundle[Download and extract the {productname} Self-hosted Bundle].

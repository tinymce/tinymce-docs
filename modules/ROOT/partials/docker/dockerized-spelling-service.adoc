...
[[deploythetinymcespellingserviceserver-sidecomponentusingdockerindividuallylicensed]]
=== Deploy the TinyMCE spelling service server-side component using Docker (individually licensed)

endif::[]
ifeval::[{shbundledockerfiles} == true]

[[deploythetinymcespellingserviceserver-sidecomponentusingdockerself-hostedenterprisebundles]]
...
. _Optional_: Add a custom dictionary, as described in xref:custom.adoc[Adding custom dictionaries].

...
link:{baseurl}/enterprise/server/configure/[Configure server-side components].
. _Optional_: Add a custom dictionary, as described in link:{baseurl}/enterprise/check-spelling/custom/[Adding custom dictionaries].

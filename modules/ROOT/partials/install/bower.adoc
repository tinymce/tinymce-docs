...
____
If you have decided to use this package manager, move on to the next step https://www.tiny.cloud/docs-3x/api/work-with-plugins/[working with plugins], where you'll start customizing TinyMCE. If you'd like to learn about other install options please keep reading.
____

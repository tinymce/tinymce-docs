...
You may also want to select a specific version of the editor from TinyMCE Cloud and you should head on over to link:{baseurl}/cloud-deployment-guide/editor-plugin-version.html[Specify Editor & Plugin Versions] for details on that.

[NOTE]
====
If you have decided to use TinyMCE Cloud, please move on to the next step link:{baseurl}/general-configuration-guide/work-with-plugins/index.html[working with plugins] where you'll start customizing TinyMCE. If you'd like to learn about other install options please keep reading.
====

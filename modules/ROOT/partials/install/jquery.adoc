...
____
If you have decided the use the jQuery version, move on to the next step https://www.tiny.cloud/docs-3x/api/work-with-plugins/[Work with Plugins], where you'll start customizing TinyMCE. If you'd like to learn about other install options please keep reading.
____

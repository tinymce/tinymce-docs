...
[NOTE]
====
If you have decided to use this package manager, move on to the next step link:{baseurl}/general-configuration-guide/work-with-plugins/index.html[working with plugins], where you'll start customizing TinyMCE. If you'd like to learn about other install options please keep reading.
====

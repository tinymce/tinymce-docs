...
____
If you decided to use the Self-hosted package, move on to the next step xref:general-configuration-guide/work-with-plugins.adoc[working with plugins], where you'll start customizing {productname}. If you'd like to learn about other install options please keep reading.
____

...
[NOTE]
====
If you decided to use the Self-hosted package, move on to the next step link:{rootDir}general-configuration-guide/work-with-plugins/index.html[working with plugins], where you'll start customizing TinyMCE. If you'd like to learn about other install options please keep reading.
====

...
* For examples of the {productname} integration, see: link:https://tinymce.github.io/tinymce-angular/[the tinymce-angular storybook^].
...
** The Angular application, see: link:https://angular.dev[the Angular documentation^].
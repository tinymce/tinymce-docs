...
This procedure creates a https://angular.io/guide/setup-local[basic Angular application] containing a {productname} editor based on our xref:demo/basic-example.adoc[Basic {productname} example].

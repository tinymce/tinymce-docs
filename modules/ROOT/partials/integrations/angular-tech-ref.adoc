...
* xref:installing-the-tinymce-angular-integration-using-npm[Installing the {productname} Angular integration using NPM]
* xref:using-the-tinymce-angular-integration[Using the {productname} Angular integration]
...
* xref:angular-modules[`+Angular module+`]

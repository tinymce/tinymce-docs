...
Specifies the \{\{site.cloudname}} channel to use. For information on \{\{site.productname}} development channels, see: link:{baseurl}/how-to-guides/cloud-deployment-guide/editor-plugin-version/[Specifying the \{\{site.productname}} editor version deployed from Cloud].

...
To load a {productname} editor similar to the xref:basic-example.adoc[Basic example], add the following code to an empty HTML file.
ifeval::["{productSource}" == "package-manager"]
[source,html,subs="attributes+"]
----
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <script src="/public/jquery/jquery.min.js"></script>
    <script src="/public/tinymce/tinymce.min.js" referrerpolicy="origin" crossorigin="anonymous"></script>
    <script src="/public/tinymce-jquery/tinymce-jquery.min.js"></script>
  </head>
  <body>
    <div>
...
== {productname} in a jQuery UI Dialog

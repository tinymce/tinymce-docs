...
fse.copySync(path.join(nodeModulesDir, 'jquery'), path.join(publicDir, 'jquery'), { overwrite: true });
fse.copySync(path.join(nodeModulesDir, 'tinymce'), path.join(publicDir, 'tinymce'), { overwrite: true });
fse.copySync(path.join(nodeModulesDir, '@tinymce', 'tinymce-jquery'), path.join(publicDir, 'tinymce-jquery'), { overwrite: true });
----
+
.package.json
[source,json]

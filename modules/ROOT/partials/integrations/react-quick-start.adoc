...
. Use link:https://github.com/vitejs/vite[Vite^] and link:https://github.com/vitejs/vite-plugin-react/tree/main/packages/plugin-react-swc[React SWC^] to create a new React project named `+tinymce-react-demo+`.
+
[source,sh]
----

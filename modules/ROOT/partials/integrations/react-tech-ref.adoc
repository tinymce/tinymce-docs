...
For information {productname} development channels, see: link:{baseurl}/cloud-deployment-guide/editor-plugin-version/#55-testingand5-devreleasechannels[Specifying the {productname} editor version deployed from Cloud - dev, testing, and stable releases].
...
For information on adding plugins to {productname}, see: link:{baseurl}/plugins/[Add plugins to {productname}].

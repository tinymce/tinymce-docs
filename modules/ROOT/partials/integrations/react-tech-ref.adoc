...
For information on the {productname} `+tinymce.init({...})+` method, see: link:{baseurl}/general-configuration-guide/basic-setup/[Basic setup].
...
For information on inline mode, see: link:{baseurl}/configure/editor-appearance/#inline[User interface options - `inline`] and link:{baseurl}/general-configuration-guide/use-tinymce-inline/[Setup inline editing mode].
...
For information setting the toolbar for {productname}, see: link:{baseurl}/configure/editor-appearance/#toolbar[User interface options - toolbar].

*Possible values:*  See link:{baseurl}/advanced/available-toolbar-buttons/[Toolbar Buttons Available for {productname}].

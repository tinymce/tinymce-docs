...
For information {productname} development channels, see: link:editor-plugin-version.html#{productmajorversion}{productmajorversion}-testingand{productmajorversion}-devreleasechannels[Specifying the {productname} editor version deployed from Cloud - dev, testing, and stable releases].
...
For information on the {productname} `+tinymce.init({...})+` method, see: link:basic-setup.html[Basic setup].
...
For information on inline mode, see: link:inline-editor-options.html#inline[User interface options - `+inline+`] and link:use-tinymce-inline.html[Setup inline editing mode].
...
For information on adding plugins to {productname}, see: link:work-with-plugins.html[Add plugins to {productname}].
...
For information setting the toolbar for {productname}, see: link:toolbar-configuration-options.html#toolbar[User interface options - toolbar].

Possible values : See link:available-toolbar-buttons.html[Toolbar Buttons Available for {productname}].

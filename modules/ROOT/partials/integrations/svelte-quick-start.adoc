...
* An `+import+` statement for the \{\{site.productname}} component.
* The `+<Editor />+` as a placeholder for the editor.
* The link:{{site.baseurl}}/how-to-guides/environment-setup/svelte/svelte-ref/#scriptsrc[`+scriptSrc+`] property for the `+Editor+` placeholder.
+
For example:
+
_File:_ `+src/App.svelte+`
...
** link:{{site.baseurl}}/how-to-guides/environment-setup/svelte/svelte-ref/[The \{\{site.productname}} Svelte integration technical reference].

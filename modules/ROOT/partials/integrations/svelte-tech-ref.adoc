...
* link:#configuringthetinymcesvelteintegration[Configuring the TinyMCE Svelte integration]
...
Specifies the \{\{site.cloudname}} channel to use. For information on \{\{site.cloudname}} deployment channels, see: link:{{site.baseurl}}/how-to-guides/cloud-deployment-guide/editor-plugin-version/[Specifying the \{\{site.productname}} editor version deployed from Cloud].

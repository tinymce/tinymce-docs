...
----
* Cloud deployments pull {productname} from the {cloudname}. Use this option by passing your API key and link:editor-plugin-version.html#specifyingthetinymceeditorversiondeployedfromcloud[specifying the {cloudname} version].
+
[source,java]
----

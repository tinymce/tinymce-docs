...
For information on the {productname} selector (`+tinymce.init+`), see: link:basic-setup.html[Basic setup].
...
For a list of available {productname} events, see: link:events.html#editorcoreevents[Available Events - Editor events].

...
For information on the {productname} selector (`tinymce.init`), see: link:{baseurl}/general-configuration-guide/basic-setup/[Basic setup].
...
For a list of available {productname} events, see: link:{baseurl}/advanced/events/#editorcoreevents[Available Events - Editor events].

...
For a list of available plugins, see: xref:plugins.adoc[Add plugins to {productname}].
...
For information on the available toolbar modes, see: xref:editor-appearance.adoc#toolbar_mode[User interface options - `toolbar_mode`].
...
* The `menubar` configuration option, see: xref:editor-appearance.adoc#menubar[User interface options - `menubar`].
* The `menu` configuration option, see: xref:editor-appearance.adoc#menu[User interface options - `menu`].
...
For a list of available context menu sections, see: xref:editor-context-menu-identifiers.adoc[Available context menu sections].
For information on context menus, see: xref:editor-appearance.adoc#contextmenu[User interface options - `contextmenu`].
...
For information on the `content_css` option, see: xref:content-appearance.adoc#content_css[Content appearance options - `content_css`].
...
For information on the `content_style` option, see: xref:content-appearance.adoc#content_style[Content appearance options - `content_style`].
...
For information on the `powerpaste_word_import` option, including supported values, see: xref:introduction-to-powerpaste.adoc#powerpaste_word_import[The PowerPaste plugin - `powerpaste_word_import`].
...
For information on the `powerpaste_html_import` option, including supported values, see: xref:introduction-to-powerpaste.adoc#powerpaste_html_import[The PowerPaste plugin - `powerpaste_html_import`].
...
For information on the `powerpaste_allow_local_images` option, including supported values, see: xref:introduction-to-powerpaste.adoc#powerpaste_allow_local_images[The PowerPaste plugin - `powerpaste_allow_local_images`].
...
For information on the `resize` option, see: xref:editor-appearance.adoc#resize[User interface options - `resize`].
...
For information on the `setup` option, see: xref:integration-and-setup.adoc#setup[Integration and setup options - `setup`].
...
* Using the `skin` option, see: xref:editor-appearance.adoc#skin[User interface options - `skin`].
* {companyname} premium skins, see: xref:enhanced-skins-and-icon-packs.adoc[Tiny Skins and Icon Packs].
...
* Using the `icons` option, see: xref:editor-appearance.adoc#icons[User interface options - `icons`].
* {companyname} premium icon packs, see: xref:enhanced-skins-and-icon-packs.adoc[Tiny Skins and Icon Packs].
...
* Using the `icons_url` option, see: xref:editor-appearance.adoc#icons_url[User interface options - `icons_url`].
* {companyname} premium icon packs, see: xref:enhanced-skins-and-icon-packs.adoc[Tiny Skins and Icon Packs].
* Creating a custom icon pack for {productname}, see: xref:creating-an-icon-pack.adoc[Create an icon pack for {productname}].

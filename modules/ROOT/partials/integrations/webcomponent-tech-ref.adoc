...
To use \{\{site.productname}} from the \{\{site.cloudname}}, add the `+api-key+` attribute to the `+tinymce-editor+` element with an API from link:{accountpageurl}/[\{\{site.accountpage}}].
...
For a list of available plugins, see: link:{baseurl}/plugins-ref/[Add plugins to \{\{site.productname}}].
...
The `+toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: link:{baseurl}/interface/toolbars/available-toolbar-buttons/[Toolbar Buttons Available for TinyMCE].
...
For information on the available toolbar modes, see: link:{baseurl}/interface/toolbars/toolbar-configuration-options/#toolbar_mode[User interface options - `+toolbar_mode+`].
...
* The `+menubar+` configuration option, see: link:{baseurl}/interface/menus/menus-configuration-options/#menubar[User interface options - `+menubar+`].
* The `+menu+` configuration option, see: link:{baseurl}/interface/menus/menus-configuration-options/#menu[User interface options - `+menu+`].
...
For a list of available context menu sections, see: link:{baseurl}/interface/menus/editor-context-menu-identifiers/[Available context menu sections]. For information on context menus, see: link:{baseurl}/interface/menus/menus-configuration-options/#contextmenu[User interface options - `+contextmenu+`].
...
The `+quickbars_insert_toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: link:{baseurl}/interface/toolbars/available-toolbar-buttons/[Toolbar Buttons Available for TinyMCE].
...
The `+quickbars_selection_toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: link:{baseurl}/interface/toolbars/available-toolbar-buttons/[Toolbar Buttons Available for TinyMCE].
...
For information on the `+content_css+` option, see: link:{baseurl}/content/add-css-options/#content_css[Content appearance options - `+content_css+`].
...
For information on the `+content_style+` option, see: link:{baseurl}/content/add-css-options/#content_style[Content appearance options - `+content_style+`].
...
For information on the `+powerpaste_word_import+` option, including supported values, see: link:{baseurl}/plugins-ref/premium/powerpaste/#powerpaste_word_import[The PowerPaste plugin - `+powerpaste_word_import+`].
...
For information on the `+powerpaste_html_import+` option, including supported values, see: link:{baseurl}/plugins-ref/premium/powerpaste/#powerpaste_html_import[The PowerPaste plugin - `+powerpaste_html_import+`].
...
For information on the `+powerpaste_allow_local_images+` option, including supported values, see: link:{baseurl}/plugins-ref/premium/powerpaste/#powerpaste_allow_local_images[The PowerPaste plugin - `+powerpaste_allow_local_images+`].
...
For information on the `+resize+` option, see: link:{baseurl}/initial-configuration/editor-size-options/#resize[User interface options - `+resize+`].
...
For information on the `+setup+` option, see: link:{baseurl}/initial-configuration/editor-important-options/#setup[Integration and setup options - `+setup+`].
...
* Using the `+skin+` option, see: link:{baseurl}/interface/editor-appearance/editor-skin/#skin[User interface options - `+skin+`].
* \{\{site.companyname}} premium skins, see: link:{baseurl}/interface/editor-appearance/premium-skins-and-icons/[Tiny Skins and Icon Packs].
...
For information on using the `+images_upload_url+`, see: link:{baseurl}/content/file-image-upload/#images_upload_url[Image & file options - `+images_upload_url+`].
...
For information on using the `+images_upload_handler+` option, see: link:{baseurl}/content/file-image-upload/#images_upload_handler[Image & file options - `+images_upload_handler+`].
...
For information on using the `+images_upload_base_path+` option, see: link:{baseurl}/content/file-image-upload/#images_upload_base_path[Image & file options - `+images_upload_base_path+`].
...
For information on using the `+images_upload_credentials+` option, see: link:{baseurl}/content/file-image-upload/#images_upload_credentials[Image & file options - `+images_upload_credentials+`].
...
For information on using the `+images_reuse_filename+` option, see: link:{baseurl}/content/file-image-upload/#images_reuse_filename[Image & file options - `+images_reuse_filename+`].
...
* Using the `+icons+` option, see: link:{baseurl}/interface/editor-appearance/editor-icons/#icons[User interface options - `+icons+`].
* \{\{site.companyname}} premium icon packs, see: link:{baseurl}/interface/editor-appearance/premium-skins-and-icons/[Tiny Skins and Icon Packs].
...
* Using the `+icons_url+` option, see: link:{baseurl}/interface/editor-appearance/editor-icons/#icons_url[User interface options - `+icons_url+`].
* \{\{site.companyname}} premium icon packs, see: link:{baseurl}/interface/editor-appearance/premium-skins-and-icons/[Tiny Skins and Icon Packs].
* Creating a custom icon pack for \{\{site.productname}}, see: link:{baseurl}/how-to-guides/customizing-the-editor-appearance/creating-an-icon-pack/[Create an icon pack for \{\{site.productname}}].

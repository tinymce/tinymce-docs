...
For information on the `powerpaste_word_import` option, including supported values, see: xref:premium-powerpaste.adoc#powerpaste_word_import[The PowerPaste plugin - `powerpaste_word_import`].
...
For information on the `powerpaste_html_import` option, including supported values, see: xref:premium-powerpaste.adoc#powerpaste_html_import[The PowerPaste plugin - `powerpaste_html_import`].
...
For information on the `powerpaste_allow_local_images` option, including supported values, see: xref:premium-powerpaste.adoc#powerpaste_allow_local_images[The PowerPaste plugin - `powerpaste_allow_local_images`].
...
* {companyname} premium skins, see: xref:premium-skins-and-icon-packs.adoc[Tiny Skins and Icon Packs].
...
* {companyname} premium icon packs, see: xref:premium-skins-and-icon-packs.adoc[Tiny Skins and Icon Packs].

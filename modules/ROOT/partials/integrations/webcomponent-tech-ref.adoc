...
For information on plugins, see: link:work-with-plugins.html[Add plugins to {productname}].
...
The `+toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: link:available-toolbar-buttons.html[Toolbar Buttons Available for TinyMCE].
...
For information on the available toolbar modes, see: link:toolbar-configuration-options.html#toolbar_mode[User interface options - `+toolbar_mode+`].
...
* The `+menubar+` configuration option, see: link:menus-configuration-options.html#menubar[User interface options - `+menubar+`].
* The `+menu+` configuration option, see: link:menus-configuration-options.html#menu[User interface options - `+menu+`].
...
For a list of available context menu sections, see: link:editor-context-menu-identifiers.html[Available context menu sections]. For information on context menus, see: link:menus-configuration-options.html#contextmenu[User interface options - `+contextmenu+`].
...
The `+quickbars_insert_toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: link:available-toolbar-buttons.html[Toolbar Buttons Available for TinyMCE].
...
The `+quickbars_selection_toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: link:available-toolbar-buttons.html[Toolbar Buttons Available for TinyMCE].
...
For information on the `+content_css+` option, see: link:add-css-options.html#content_css[Content appearance options - `+content_css+`].
...
For information on the `+content_style+` option, see: link:add-css-options.html#content_style[Content appearance options - `+content_style+`].
...
For information on the `+powerpaste_word_import+` option, including supported values, see: link:powerpaste.html#powerpaste_word_import[The PowerPaste plugin - `+powerpaste_word_import+`].
...
For information on the `+powerpaste_html_import+` option, including supported values, see: link:powerpaste.html#powerpaste_html_import[The PowerPaste plugin - `+powerpaste_html_import+`].
...
For information on the `+powerpaste_allow_local_images+` option, including supported values, see: link:powerpaste.html#powerpaste_allow_local_images[The PowerPaste plugin - `+powerpaste_allow_local_images+`].
...
For information on the `+resize+` option, see: link:editor-size-options.html#resize[User interface options - `+resize+`].
...
For information on the `+setup+` option, see: link:editor-important-options.html#setup[Integration and setup options - `+setup+`].
...
* Using the `+skin+` option, see: link:editor-skin.html#skin[User interface options - `+skin+`].
* {companyname} premium skins, see: link:premium-skins-and-icons.html[Tiny Skins and Icon Packs].
...
For information on using the `+images_upload_url+`, see: link:file-image-upload.html#images_upload_url[Image & file options - `+images_upload_url+`].
...
For information on using the `+images_upload_handler+` option, see: link:file-image-upload.html#images_upload_handler[Image & file options - `+images_upload_handler+`].
...
For information on using the `+images_upload_base_path+` option, see: link:file-image-upload.html#images_upload_base_path[Image & file options - `+images_upload_base_path+`].
...
For information on using the `+images_upload_credentials+` option, see: link:file-image-upload.html#images_upload_credentials[Image & file options - `+images_upload_credentials+`].
...
For information on using the `+images_reuse_filename+` option, see: link:file-image-upload.html#images_reuse_filename[Image & file options - `+images_reuse_filename+`].
...
* Using the `+icons+` option, see: link:editor-icons.html#icons[User interface options - `+icons+`].
* {companyname} premium icon packs, see: link:premium-skins-and-icons.html[Tiny Skins and Icon Packs].
...
* Using the `+icons_url+` option, see: link:editor-icons.html#icons_url[User interface options - `+icons_url+`].
* {companyname} premium icon packs, see: link:premium-skins-and-icons.html[Tiny Skins and Icon Packs].
* Creating a custom icon pack for {productname}, see: link:creating-an-icon-pack.html[Create an icon pack for {productname}].

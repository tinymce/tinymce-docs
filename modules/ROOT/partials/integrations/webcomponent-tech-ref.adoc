...
** xref:supported-tinymce-events[Supported {productname} events]

[[use-a-cloud-version-of-the-tinymce-web-component-integration]]
== Use a cloud version of the {productname} Web Component integration
...
== Installing the {productname} Web Component integration
...
The `+toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: xref:available-toolbar-buttons.adoc[Toolbar Buttons Available for {productname}].
...
The `+quickbars_insert_toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: xref:available-toolbar-buttons.adoc[Toolbar Buttons Available for {productname}].
...
The `+quickbars_selection_toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: xref:available-toolbar-buttons.adoc[Toolbar Buttons Available for {productname}].
...
There are two methods to bind events for the {productname} Web Component.
...
----
+
If these attributes are later removed, the event will be automatically unbound. For the full list of supported `+on-+` attributes, see: xref:supported-browser-events[Supported browser events] and xref:supported-tinymce-events[Supported {productname} events].

...
|`+language+` |Format |Dropdown list with languages to apply to the selection. This item requires the link:{{site.baseurl}}/content/content-localization/#content_langs[`+content_langs+` option].

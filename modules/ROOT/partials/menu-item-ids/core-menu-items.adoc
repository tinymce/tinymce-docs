...
|`+language+` |Format |Dropdown list with languages to apply to the selection. This item requires the link:content-localization.html#content_langs[`+content_langs+` option].

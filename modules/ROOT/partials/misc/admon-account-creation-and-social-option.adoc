...
<div class="signup-promo">
  ...
  <div>
    <a href="https://www.tiny.cloud/auth/signup/?utm_campaign=docs_signups&utm_source=docs&utm_medium=referral&utm_term=signups" class="account-creation-button" target="_blank" title="Sign up with Google">
      Sign up

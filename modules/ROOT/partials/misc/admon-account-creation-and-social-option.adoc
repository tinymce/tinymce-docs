...
<div class="signup-promo">
  ...
  <div>
    <a href="https://tiny.cloud/signup?_gl=1*1m4fqt3*_ga*NDE5MTIxMjQwLjE3MzIxOTkwODE.*_ga_GQ50XYHWQZ*MTczMjI2OTAwMi4yLjEuMTczMjI2OTQwNy40LjAuMA..*_gcl_au*NTYyNTc2NTQyLjE3MzIxOTkwODE.&utm_campaign=docs_signups&utm_source=docs&utm_medium=referral&utm_term=signups" class="account-creation-button" target="_blank" title="Sign up with Google">
      Sign up

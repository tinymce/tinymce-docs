...
| spellchecker
| link:{{site.baseurl}}/plugins/opensource/spellchecker/[Spell Checker]
...
For a list of available menu items that can be added to the context menu, see: link:{{site.baseurl}}/advanced/available-menu-items/[Menu Items Available for {{site.productname}}].

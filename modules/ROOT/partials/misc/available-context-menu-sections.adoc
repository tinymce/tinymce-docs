...
For a list of available menu items that can be added to the context menu, see: xref:advanced/available-menu-items.adoc[Menu Items Available for {productname}].

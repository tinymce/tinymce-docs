...
* The directory containing the Hunspell dictionaries must conform to the file structure defined in link:{{site.baseurl}}/how-to-guides/premium-server-side-guide/self-hosting-hunspell/#hunspelldictionarystorageforspellcheckerpro[Hunspell dictionary storage for Spell Checker Pro].

...
ifeval::["{extensionType}" == "Packs"]
* Enabling premium skins, see: xref:editor-appearance.adoc#skin[The `skin` setting].
* Enabling premium icon packs, see: xref:editor-appearance.adoc#icons[The `icons` setting].
endif::[]
ifeval::["{extensionType}" != "Packs"]

ifeval::["{pluginname}" == "Comments"]
* Configuring the *{pluginname} {extensionType}*, see: xref:{plugindocspage}[The {pluginname} {extensionType} documentation].
endif::[]
ifeval::["{pluginname}" != "Comments"]
* Configuring the *{pluginname} {extensionType}*, see: xref:premium-{plugindocspage}[The {pluginname} {extensionType} documentation].
endif::[]

...
* Setting the license, see: xref:license-key.adoc#setting-the-license[Setting the license].
endif::[]
...
* Adding {productname} plugins, see: xref:work-with-plugins.adoc[Work with plugins to extend {productname}].

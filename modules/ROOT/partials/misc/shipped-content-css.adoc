...
These content CSS files can be enabled in the editor using the xref:configure/content-appearance.adoc#content_css[`content_css` configuration option].
...
xref:enterprise/premium-skins-and-icon-packs/index.adoc[{prem_skins_icons}].

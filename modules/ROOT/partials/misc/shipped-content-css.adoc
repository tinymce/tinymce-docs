{productname} comes with four content CSS files:
...
These content CSS files can be enabled in the editor using the link:add-css-options.html#content_css[`+content_css+` configuration option].
...
{companyname} also provides content CSS files with the premium skins, for a list of premium content CSS files, see: link:premium-skins-and-icons.html[{prem_skins_icons}].

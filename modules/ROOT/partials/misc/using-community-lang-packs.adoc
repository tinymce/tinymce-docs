...
[arabic]
. Download the language pack from link:{{site.gettiny}}/language-packages/[the \{\{site. companyname}} Community Language Packages download page]. \{% if forModuleLoaders == true %}

 ...
 ** xref:bbcodebbcode[BBCode (bbcode)]
 ...
 ** xref:fullpagefullpage[Full Page (fullpage)]
 ** xref:fullscreenfullscreen[Full Screen (fullscreen)]
 ** xref:helphelp[Help (help)]
 ** xref:horizontalrulehr[Horizontal Rule (hr)]
 ...
 ** xref:legacyoutputlegacyoutput[Legacy Output (legacyoutput)]
 ...
 ** xref:spellcheckerspellchecker[Spell Checker (spellchecker)]
 ** xref:tabfocustabfocus[Tab Focus (tabfocus)]

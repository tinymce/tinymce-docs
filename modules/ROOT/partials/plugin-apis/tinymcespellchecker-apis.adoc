...
| setLanguage
| language: `string`
| Set the current language for spellchecking. This must be a supported language code (case-sensitive). For a list of supported languages, see: xref:tinymcespellchecker.adoc#supportedlanguages[Spell Checker Pro - `Supported languages`].
|===

...
Refer to the link:creating-a-skin.html#creatingaskin[documentation] for building a skin using this repo.

For more information on configuring {productname} formats, refer to the link:content-formatting.html#formats[formats] section.

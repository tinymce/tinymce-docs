...
* Either the `code` property is one of the xref:supportedlanguages[Supported Languages] or the `customCode` override property is defined.
* The `customCode` property is one of the xref:supportedlanguages[Supported Languages] if it is defined.

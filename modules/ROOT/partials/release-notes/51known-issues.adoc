...
* link:{{site.baseurl}}/plugins/opensource/emoticons/[Emoticons].
* link:{{site.baseurl}}/plugins/opensource/charmap/[Character Map].
...
NOTE: This issue affects the link:{{site.baseurl}}/plugins/premium/comments/[Comments plugin].

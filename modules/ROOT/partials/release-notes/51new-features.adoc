...
For information on using `inputMode`, see: xref:dialogcomponents.adoc#inputmode[Dialog components - `inputMode`].
...
* xref:advanced-editing-behavior.adoc#object_resizing[`object_resizing`] - Object resizing is not supported on mobile devices and defaults to `false`.
...
* xref:advanced-editing-behavior.adoc#object_resizing[`object_resizing`].

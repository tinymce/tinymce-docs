...
* xref:advtable.adoc[The Advanced Tables Premium features page (including demo)].
* xref:advtable.adoc[The Advanced Tables plugin documentation page].
...
*Mentions* 2.1.0 has been updated to allow for the inclusion of "extra" menu items, such as additional results or search items. For details, see: xref:mentions.adoc#mentions_fetch[Mentions - `mentions_fetch`].
...
For information on `powerpaste_clean_filtered_inline_elements`, see: xref:introduction-to-powerpaste.adoc#powerpaste_clean_filtered_inline_elements[PowerPaste - `powerpaste_clean_filtered_inline_elements`].
...
For information on using the Pre-filtering and Post-filtering callbacks, see: xref:introduction-to-powerpaste.adoc#pre-filtering-and-post-filtering-callbacks[PowerPaste Plugin - Pre-filtering and post-filtering callbacks]

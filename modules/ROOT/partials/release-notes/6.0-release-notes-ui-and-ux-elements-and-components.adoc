...
[[style-field]]
=== style field in the Advanced tab of the Insert/Enhanced Image Editing dialog box

The _Style_ field, previously presented in the _Advanced_ tab of the _Insert/Enhanced Image Editing_ dialog has been removed.

When the _Advanced_ tab in the _Insert/Enhanced Image Editing_ dialog was selected, a _Style_ text-entry field (auto-populated with the selected image’s properties and associated values) was one of the fields presented.

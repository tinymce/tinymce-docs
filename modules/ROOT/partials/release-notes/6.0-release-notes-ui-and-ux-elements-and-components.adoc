...
In {productname} 5.x, editors without a specified `height` value defaulted to 200px high.

In {productname} 6.0, editors without a specified `height` value default to 400px high.

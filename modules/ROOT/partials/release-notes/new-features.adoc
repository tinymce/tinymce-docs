...
The xref:introduction-to-tiny-comments.adoc[Comments 2.0] is a premium plugin built on the xref:annotations.adoc[Annotations API] to create comment threads (conversations). Comments 2.0 provides the ability to start or join a conversation by adding comments to the content within the TinyMCE editor.
...
The Format Painter may be used through keyboard shortcuts or a toolbar button. Refer to the xref:formatpainter.adoc[Format Painter] documentation, for more information.
...
Mentions is available for download through xref:editor-and-features.adoc[TinyMCE Cloud]. Include the mentions parameter in the tinymce.init script. Refer to the xref:mentions.adoc[Mentions] documentation, for more information on setup and configuration.
...
Refer to the xref:pageembed.adoc[Page Embed] documentation, for more information.
...
Refer to the xref:permanentpen.adoc[Permanent Pen] documentation, for more information.
...
Refer to the xref:custom-toolbarbuttons.adoc[Toolbar buttons] documentation, for more information.

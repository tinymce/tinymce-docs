...
|`+language+` |Dropdown list with languages to apply to the selection. This button requires the link:content-localization.html#content_langs[`+content_langs+` option].

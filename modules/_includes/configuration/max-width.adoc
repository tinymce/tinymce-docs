...
NOTE: This behavior is different than the link:{modulesDir}/plugins/autoresize/[`autoresize`] plugin, which controls the resizing of the editable area only, not the entire editor.

...
For more information on the differences between regular and inline editing modes please see this page link:{modulesDir}/general-configuration-guide/use-tinymce-inline/[here].

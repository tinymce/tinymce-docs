...
This procedure creates a https://angular.io/guide/setup-local[basic Angular application] containing a {productname} editor based on our link:{modulesDir}/demo/basic-example/[Basic {productname} example].

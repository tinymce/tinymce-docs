...
This example shows you how to override the built in link:{modulesDir}/configure/content-formatting/#formats[formats] and add some custom styles to the `styleselect` dropdown toolbar button and the `formats` menu item using the link:{modulesDir}/configure/editor-appearance/#style_formats[style_formats] configuration option.

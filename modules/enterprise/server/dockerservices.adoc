...
include::{includeDir}/configuration/dockerized-hyperlinking-service.adoc[]

include::{includeDir}/configuration/dockerized-image-proxy.adoc[]

include::{includeDir}/configuration/dockerized-spelling-service.adoc[]

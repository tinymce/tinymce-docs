...
image::{modulesDir}/images/tinymce5-homepage-demo.png[Screenshot of homepage {productname} demo including product attribution in the bottom, right-hand corner]

...
This procedure creates a basic jQuery integration containing a {productname} editor based on our link:{modulesDir}/demo/basic-example/[Basic example].
...
To load a TinyMCE editor similar to the link:{modulesDir}/demo/basic-example/[Basic example], add the following code to an empty HTML file.

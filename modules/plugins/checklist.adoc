...
*Checklist* is a premium plugin from {companyname}. Please see the link:{modulesDir}/enterprise/tiny-comments/[Premium features] section for all the buying options.
...
Use the following script to add the *Checklist* link:{modulesDir}/ui-components/toolbarbuttons/[toolbar button]:
...
NOTE: The *Checklist* plugin has to be used together with the link:{modulesDir}/plugins/lists/[Lists] plugin to work.

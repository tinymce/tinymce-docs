...
include::{includeDir}/configuration/selection-toolbar.adoc[]

include::{includeDir}/configuration/insert-toolbar.adoc[]

include::{includeDir}/configuration/image_toolbar.adoc[]

...
image:{imagesDir}icons/warning.svg[warning icon]*This domain is not registered with {cloudname}. Please see the quick start guide or create an account.*
...
Signing up for a {cloudname} API key will also provide a trial of the link:{modulesDir}/enterprise/[Premium Plugins].
...
* Customizing {productname}, see: link:{modulesDir}/general-configuration-guide/basic-setup/[Basic Setup].
* The three editor modes:
 ** link:{modulesDir}/general-configuration-guide/use-tinymce-classic/[{productname} classic editing mode].
 ** link:{modulesDir}/general-configuration-guide/use-tinymce-inline/[{productname} inline editing mode].
 ** link:{modulesDir}/general-configuration-guide/use-tinymce-distraction-free/[{productname} distraction-free editing mode].
* Adding {productname} plugins, see: link:{modulesDir}/general-configuration-guide/work-with-plugins/[Work with plugins to extend TinyMCE].
* Localizing the {productname} editor, see: link:{modulesDir}/general-configuration-guide/localize-your-language/[Localize {productname}].
* Self-hosting {productname}, see: link:{modulesDir}/general-configuration-guide/advanced-install/[Installing {productname}].

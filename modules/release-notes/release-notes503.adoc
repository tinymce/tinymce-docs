...
For more information on *Case Change* refer to the full link:{modulesDir}/plugins/casechange/[documentation].

There is also a demo provided to explore the *Case Change* capabilities link:{modulesDir}/demo/casechange/[here].
...
For more information on *TinyMCE for Swing* refer to the full link:{modulesDir}/integrations/swing/[documentation].

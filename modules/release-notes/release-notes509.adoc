...
image::{modulesDir}/images/multiple-toolbars.png[Multiple toolbars]

For more information on multiple toolbars refer to the link:{modulesDir}/configure/editor-appearance/#usingmultipletoolbars[documentation].
...
For more information on the new options refer to the link:{modulesDir}/configure/integration-and-setup/#base_url[base_url] and link:{modulesDir}/configure/integration-and-setup/#suffix[suffix] documentation.
...
For more information on the media plugin refer to the link:{modulesDir}/plugins/media/[documentation].
...
The new TinyMCE 5.0.9 editor comes with numerous changes to the previous versions. A comprehensive list of the updates and fixed issues is available in the link:{modulesDir}/changelog/#version509june262019[changelog].
...
For more information on *Legacy Output* refer to the link:{modulesDir}/plugins/legacyoutput/[documentation].
...
For more information on *Enhanced Media Embed* refer to the link:{modulesDir}/plugins/mediaembed/[documentation].
...
For more information on *Link Checker* refer to the link:{modulesDir}/plugins/linkchecker/[documentation].
...
For information on *Tiny Comments*, refer to the link:{modulesDir}/plugins/comments/[*Tiny Comments* documentation].
...
For information on *PowerPaste*, refer to the link:{modulesDir}/plugins/powerpaste/[*PowerPaste* documentation].

...
Once you have the [server-side component]({{ site.baseurl }}/how-to-guides/premium-server-side-guide/) installed, additional configuration to your `application.conf` file is required. (Don't forget to restart the Java application server after updating the configuration.)

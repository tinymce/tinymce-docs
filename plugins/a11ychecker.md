...
Conducts accessibility audit and reports the results without triggering the dialog. The report produced is an array of objects, where each object represents an issue and contains the following details:

...
*Case Change* is a premium plugin from {companyname}. Please see the link:{baseurl}/enterprise/casechange/[Premium features] section for all the buying options.
...
Use the following script to configure the *Case Change* link:{baseurl}/ui-components/typesoftoolbarbuttons/#splitbutton[split toolbar button]:
...
Use the following script to configure the *Case Change* link:{baseurl}/ui-components/menuitems/[menu item]:
...
. Click on the image:{baseurl}/images/casechangeicon.png[**Case Change**] icon in the toolbar.

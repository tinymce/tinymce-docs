...
____
Looking for more advanced Microsoft Word importing and pasting? Try the link:{{site.baseurl}}/plugins/powerpaste/[PowerPaste] plugin.
____
...
NOTE: To access this feature, you need to set the value of link:{{site.baseurl}}/plugins/paste/#paste_enable_default_filters[paste_enable_default_filters] to `"false"` in your configuration.

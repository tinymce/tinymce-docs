...
include::_includes/configuration/paste-merge-formats.adoc[]
...
[NOTE]
====
If you configure *_PowerPaste_* to allow local images, you can have {productname} automatically upload Base64 encoded images for conversion back to a standard image as described on the link:{baseurl}/advanced/handle-async-image-uploads/[image upload documentation].
====

include::_includes/configuration/paste-block-drop.adoc[]
...
include::_includes/configuration/smart-paste.adoc[]

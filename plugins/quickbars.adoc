...
NOTE: To enable automatic upload of images on insertion, link:{baseurl}/advanced/handle-async-image-uploads/[image upload] must be configured.
...
include::_includes/configuration/selection-toolbar.adoc[]

include::_includes/configuration/insert-toolbar.adoc[]

include::_includes/configuration/image_toolbar.adoc[]

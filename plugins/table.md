...
| tablemodified | `structure: bool; style: bool` | Fired whenever a table is modified in any way. The `style` and `structure` parameters describe whether the table style, structure, or both were modified. |

...
*Spell Checker Pro* adds spell checking as-you-type capabilities to {productname}. For information on the supported languages, refer to link:{baseurl}/plugins/tinymcespellchecker/#spellchecker_language[this] section.
...
include::_includes/configuration/languages.adoc[]
...
For more information about customizing the toolbar, see: link:{baseurl}/configure/editor-appearance/#toolbar[User interface options -- Toolbar].
...
|===
| Control | link:{baseurl}/configure/editor-appearance/#examplethetinymcedefaultmenuitems[Default Menu Location] | Description
...
For more information about customizing the toolbar, see: link:{baseurl}/configure/editor-appearance/#menu[User interface options -- Menu].

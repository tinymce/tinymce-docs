...
BBCode (`bbcode`)
: The BBCode plugin (`bbcode`) was deprecated with the release of {{site.productname}} 5.9. For details, see [the BBCode plugin deprecation notice]({{site.baseurl}}/release-information/release-notes/release-notes59/#thebbcodebbcodeplugin). The BBCode plugin will be removed in {{site.productname}} 6.0.

Full Page (`fullpage`)
: The Full Page plugin (`fullpage`) was deprecated with the release of {{site.productname}} 5.9. For details, see [the Full Page plugin deprecation notice]({{site.baseurl}}/release-information/release-notes/release-notes59/#thefullpagefullpageplugin). The Full Page plugin will be removed in {{site.productname}} 6.0.
...
: The Legacy Output plugin (`legacyoutput`) was deprecated with the release of {{site.productname}} 5.9. For details, see [the Legacy Output plugin deprecation notice]({{site.baseurl}}/release-information/release-notes/release-notes59/#thelegacyoutputlegacyoutputplugin). The Legacy Output plugin will be removed in {{site.productname}} 6.0.

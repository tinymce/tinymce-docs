...
> **Note:** {{site.companyname}} recommends to switch to the newer option or API where possible, instead of just disabling this warning. This will ease the migration to {{site.productname}} 6.0.

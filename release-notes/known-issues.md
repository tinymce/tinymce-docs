...
||Issue key| Summary|
||AP-348| Update premium plugins to use tinymce not tinymce-alloy|
...
|AP-311 Put CloudFront in front of temporary apollo editor bucket|
...
|AP-200 Fixed Sliding behaviour responding to nested transitionend events and incorrect type definition for grow|
...
|AP-145 Make a Jenkins build that publishes to nexus|
|AP-135 Add onCancel|
...
|AP-53	SPIKE: Figure out basic simple parts of the strict API|
...
|AP-196 Add Log.chainAsStep to agar|
...
|AP-56	[dialog H] insert media dialog
|AP-55	[dialog M] Insert Link
|AP-50	[dialog L] Document Properties (Fullpage)
...
|AP-59	Discuss scope of tables in v1.
...
|AP-354 DO NOT MERGE - branch to disable tests on premium plugins so they can be built for a connections demo
|AP-69	TODO: jira workflow
|AP-10	Plan Testing
|AP-9 Plan Project Plan
|AP-8 Plan documentation
|AP-7 Plan Development
|AP-6 Plan communications
|AP-5 Plan Sprint open/close, milestone review postmortem
|AP-4 Plan - delivery plan
|AP-3 Plan for blockers
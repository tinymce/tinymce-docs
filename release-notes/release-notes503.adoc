...
To try out *Case Change* start with this link:{{site.productpages}}/case-change/[dedicated product page] to see all the flexible pricing options.

For more information on *Case Change* refer to the full link:{{site.baseurl}}/plugins/casechange/[documentation].

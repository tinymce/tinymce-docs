...
For more information on `image_uploadtab`, refer to the link:{{site.baseurl}}/plugins/image/#image_uploadtab[documentation].
...
For more information on the new API, refer to the link:{{site.baseurl}}/plugins/wordcount/#api[documentation].
...
For more information on *PowerPaste* refer to the full link:{{site.baseurl}}/plugins/powerpaste/[documentation].

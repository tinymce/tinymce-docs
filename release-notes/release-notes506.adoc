...
For more information on `image_uploadtab`, refer to the link:{baseurl}/plugins/image/#image_uploadtab[documentation].
...
For more information on the new API, refer to the link:{baseurl}/plugins/wordcount/#api[documentation].
...
For more information on *PowerPaste* refer to the full link:{baseurl}/plugins/powerpaste/[documentation].

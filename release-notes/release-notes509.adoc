...
For more information on the media plugin refer to the link:{{site.baseurl}}/plugins/media/[documentation].
...
For more information on *Legacy Output* refer to the link:{{site.baseurl}}/plugins/legacyoutput/[documentation].
...
For more information on *Enhanced Media Embed* refer to the link:{{site.baseurl}}/plugins/mediaembed/[documentation].
...
For more information on *Link Checker* refer to the link:{{site.baseurl}}/plugins/linkchecker/[documentation].
...
For information on *Tiny Comments*, refer to the link:{{site.baseurl}}/plugins/comments/[*Tiny Comments* documentation].
...
For information on *PowerPaste*, refer to the link:{{site.baseurl}}/plugins/powerpaste/[*PowerPaste* documentation].

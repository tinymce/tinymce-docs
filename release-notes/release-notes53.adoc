...
For information on enabling the Find and Replace dialog, see: link:{baseurl}/plugins/searchreplace/[the Search and Replace plugin].
...
* The Quick Toolbars plugin, see: link:{baseurl}/plugins/quickbars/[The Quick Toolbars plugin].
...
For information on the Accessibility Checker plugin, see: link:{baseurl}/plugins/a11ychecker/[Accessibility Checker plugin].
...
For information on the Comments plugin, see: link:{baseurl}/plugins/comments/[Comments plugin].

For a list of valid menu items, see: link:{baseurl}/advanced/editor-control-identifiers/#menucontrols[Editor control identifiers - Menu controls].
...
* The PowerPaste plugin, see: link:{baseurl}/plugins/powerpaste/[PowerPaste plugin].
* The PowerPaste `paste_preprocess` option, see: link:{baseurl}/plugins/powerpaste/#paste_preprocess[PowerPaste plugin - `paste_preprocess`].
* The PowerPaste `paste_postprocess` option, see: link:{baseurl}/plugins/powerpaste/#paste_postprocess[PowerPaste plugin - `paste_postprocess`].
...
For information on Spell Checker Pro plugin, see: link:{baseurl}/plugins/tinymcespellchecker/[Spell Checker Pro plugin].
...
* The Spell Checker Pro plugin, see: link:{baseurl}/plugins/tinymcespellchecker/[Spell Checker Pro plugin].
* The Link Checker plugin, see: link:{baseurl}/plugins/linkchecker/[Link Checker plugin].
* The Image Tools plugin, see: link:{baseurl}/plugins/imagetools/[Image Tools plugin].
* The Enhanced Media Embed plugin, see: link:{baseurl}/plugins/mediaembed/[Enhanced Media Embed plugin].
...
* The `images_dataimg_filter` option, see: link:{baseurl}/configure/file-image-upload/#images_dataimg_filter[Image & file upload options - images_dataimg_filter].

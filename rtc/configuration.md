...
| `sessionId` | integer | Session ID generated by the server (0 ≤ sessionId < 2<sup>31</sup>). |
...
| Field | Type | Description |
|-------|:----:|-------------|
| `sessionId` | integer | Session identifier generated by the server (0 ≤ sessionId < 2<sup>31</sup>). |
| `version` | integer | 31 bit number (0 ≤ version < 2<sup>31</sup>) with an increasing version number. |

...
The `rtc_unsupported_content_notification` option can be used to disable the notification about unsupported content inside the editor. Existing documents that has content generated by plugins that are unsupported by rtc could potentially break.

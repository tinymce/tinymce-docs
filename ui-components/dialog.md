...
| ---- | ---- | ----------- | ----------- |
| type | `'submit'` or `'cancel'` or `'custom'` | required | Must be `'submit'` or `'cancel'` or `'custom'` based on the type of callback function that should be invoked when the button is clicked. |
